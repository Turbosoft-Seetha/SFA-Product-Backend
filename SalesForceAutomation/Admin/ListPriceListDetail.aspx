<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="ListPriceListDetail.aspx.cs" Inherits="SalesForceAutomation.Admin.ListPriceListDetail" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 8px; padding-bottom: 8px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Special Price Detail</h3>
                        ...
                        <div class="kt-subheader__breadcrumbs" style="padding-left:20px;">
                          ...
                          <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a class="kt-subheader__breadcrumbs-link">Special Price Detail </a>
                       <!--     <span class="kt-subheader__breadcrumbs-separator">></span>
                           ...
                           <%-- breadcrumbs --%>
                            ...
                            <div class="kt-portlet__head-actions">
                                 <asp:LinkButton ID="lnkSubCat" runat="server" CssClass="btn btn-brand btn-elevate btn-icon-sm" Text="Add" OnClick="lnkSubCat_Click1" Style="padding-top:14px;"></asp:LinkButton>
