        ...
        public void ListData()
        {
            try
            {
                ...
                if (Mode == 1)
                {
                    ...
                    lstUser = ObjclsFrms.loadList("SelectAssetMasterFromDashboard", "sp_Merch_Dashboard", fromdate, arr);
                }
                else
                {
            ...
            catch(Exception ex)
            {
                ...
                ObjclsFrms.LogMessageToFile(UICommon.GetLogFileName(), "ListAssetMaster.aspx ListData()", "Error : " + ex.Message.ToString() + " - " + innerMessage);
            }
