<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="ListQualificationDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.ListQualificationDetail" %>
                  ...
                  <%-- 
                    <div class="kt-portlet__head">
                      ...
                      <div class="kt-portlet__body">
                         <div> <h3 class="kt-portlet__head-title">رأس التأهيل </h3> </div> <br />
                     ...
                     <div class="kt-portlet__body" style="margin-top:20px;">
                         <div><b> أضف المنتجات</b></div> <br />
                          ...
                          <%--  <div class="col-lg-4 form-group">
                            ...
                            <telerik:RadAjaxPanel ID="RadAjaxPanel5" runat="server" LoadingPanelID="RadAjaxLoadingPanel4">
                                <asp:LinkButton ID="BtnAdd" runat="server" ValidationGroup="frm" OnClick="BtnAdd_Click" UseSubmitBehavior="false" Text='<i class="icon-ok"></i> منتج'
                      ...
                      <div class="kt-portlet__body">
                           <div class="col-lg-12 row"  style="padding-top: 20px; padding-bottom: 20px;">
                                     <div class="col-lg-10">
                                        <h3 class="kt-portlet__head-title">تفاصيل التأهيل
                                        </h3>
                                    </div>
                                    <div class="col-lg-2" style="text-align:end">
                                        <telerik:RadAjaxPanel ID="RadAjaxPanel6" runat="server" LoadingPanelID="RadAjaxLoadingPanel8">
                                             <asp:LinkButton ID="BtnDelete" runat="server"  UseSubmitBehavior="false" OnClick="BtnDelete_Click"  Text='<i class="icon-ok"></i> إزالة المنتج'
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                   ...
                   <button type="button" class="btn btn-sm fw-bold btn-secondary" onclick="cancelModal();">يلغي</button>
                </div>
            </div>
        </div>
    </div>
