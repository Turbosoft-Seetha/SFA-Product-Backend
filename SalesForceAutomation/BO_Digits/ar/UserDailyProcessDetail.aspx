<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="UserDailyProcessDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.UserDailyProcessDetail" %>
                        ...
                        <div class="kt-portlet__head" style="border-bottom-style: ridge; border-bottom-width: thin;">
                            ...
                            <div class="kt-portlet__head-actions col-lg-12 row">
                                ...
                                <div class="col-lg-6 row" style="display: flex; justify-content: flex-end;">
                                        ...
                                        <asp:PlaceHolder ID="pnlEndorsement" runat="server" >
                                                <asp:ImageButton ID="Endorsement" Visible="true" ToolTip="تَأيِيد" AlternateText="Endorsement" Height="30" runat="server" OnClick="Endorsement_Click"
                                                    ImageUrl="../assets/media/UDP/endorsement@2X.png"></asp:ImageButton>
                                              </asp:PlaceHolder>
                                    ...
                                    <asp:PlaceHolder ID="van" runat="server">
                                        <div class="col-sm-1">
                                            <asp:ImageButton ID="VanStock" Visible="true" ToolTip="فانستوك الحالي" AlternateText="VanStock" Height="25" runat="server" OnClick="VanStock_Click"
                                                ImageUrl="../assets/media/svg/general/vanstock.png"></asp:ImageButton>

                                        </div>
                                    </asp:PlaceHolder>
                                    <div class="col-sm-1">
                                        <asp:ImageButton ID="LastRouteCom" Visible="true" ToolTip="آخر طريق اتصال" AlternateText="LastRouteCommunication" Height="20" runat="server" OnClick="LastRouteCom_Click"
                                            ImageUrl="../assets/media/UDP/lastupdate.png"></asp:ImageButton>

                                    </div>
                                    <div class="col-sm-1">
                                        <asp:ImageButton ID="map" Visible="true" ToolTip="خريطة" AlternateText="Map" runat="server" Height="20" OnClick="map_Click"
                                            ImageUrl="../assets/media/UDP/tracking.png"></asp:ImageButton>
                                    </div>
                                    <div class="col-sm-1">
                                        <asp:ImageButton ID="Settlement" Visible="true" ToolTip="جدول" AlternateText="Chart" Height="20" runat="server" OnClick="Settlement_Click"
                                            ImageUrl="../assets/media/UDP/kpi.png"></asp:ImageButton>
                                    </div>
                                    <asp:PlaceHolder ID="pnlSettlement" runat="server" Visible="true">
                                        <div class="col-sm-1">
                                            <asp:ImageButton ID="Imgsettlement" runat="server" ImageUrl="../assets/media/UDP/settlement.png" Height="20" ToolTip="مستعمرة" OnClick="Imgsettlement_Click" AlternateText="Xlsx" />
                                        </div>
                                    </asp:PlaceHolder>
                                    <div class="col-sm-1">
                                        <asp:ImageButton ID="Imgexcel" runat="server" ImageUrl="../assets/media/UDP/excel.png" Height="20" ToolTip="تحميل" OnClick="Imgexcel_Click" AlternateText="Xlsx" />
                                    </div>
                                    <asp:LinkButton ID="lnkCancel" runat="server" CssClass="btn" BackColor="#E2E5EE" OnClick="lnkCancel_Click" Visible="false">يلغي</asp:LinkButton>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <ContentTemplate>
                                                    <div class="col-lg-12 row mb-2 pt-4">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <label class="col-lg-2 col-form-label" style="display: contents;">المستعمل:</label>
                                                        ...
                                                        <div class="col-lg-12 mb-4">
                                                            <div class="card-body d-flex flex-column">
                                                                ...
                                                                <div class="row g-0">
                                                                    ...
                                                                    <div class="col-4" style="border-bottom-style: dashed; border-bottom-width: thin; border-right-style: dashed; border-right-width: thin; border-color: antiquewhite;">
                                                                        <div class="d-flex align-items-center mb-9 me-2">
                                                                            ...
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class="fs-7 fw-bold" style="color: black; margin-right: 40px;">الفواتير</div>
                                                                            ...
                                                                            <div class="col-4">
                                                                                <asp:LinkButton ID="lnkInvoices" runat="server" OnClick="lnkInvoices_Click">
                                                                                    <div class="symbol symbol-40px me-3" style="background-color: white; display: flex; justify-content: flex-end;">
                                                                    ...
                                                                    <div class="col-4" style="border-bottom-style: dashed; border-bottom-width: thin;  border-right-style: dashed; border-right-width: thin; border-color: antiquewhite;">
                                                                        <div class="d-flex align-items-center mb-9 ms-2">
                                                                            ...
                                                                            <div class="col-2">
                                                                                <div class="symbol symbol-40px mx-3" style="padding-top: 20px;">
                                                                                    <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                        ...
                                                                                        <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                            <img src="../assets/media/UDP/ar.png" alt="AR" width="28" height="25" style="margin: 10px;" />
                                                                                        </span>
                                                                                        <!--end::Svg Icon-->
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class="fs-7 fw-bold" style="color: black; margin-right: 40px;">الذمم</div>
                                                                    ...
                                                                    <!--end::Col-->
                                                                     <!--begin::Col-->
                                                                    <div class="col-4" style="border-bottom-style: dashed; border-bottom-width: thin; border-color: antiquewhite;">
                                                                        <div class="d-flex align-items-center mb-9 ms-2">
                                                                            <!--begin::Symbol-->
                                                                            <div class="col-2">
                                                                                <div class="symbol symbol-40px mx-3" style="padding-top: 20px;">
                                                                                    <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                        ...
                                                                                        <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                            <img src="../assets/media/UDP/merch2.png" alt="merch" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                        </span>
                                                                                        <!--end::Svg Icon-->
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class="fs-7 fw-bold" style="color: black;">تجارة </div>

                                                                            </div>
                                                                            <!--end::Title-->
                                                                            <div class="col-4">
                                                                                <asp:LinkButton ID="lnkMerch" runat="server" OnClick="lnkMerch_Click">
                                                                    ...
                                                                    <!--end::Col-->
                                                                     <!--begin::Col-->
                                                                    <div class="col-4" style=" border-right-style: dashed; border-right-width: thin; border-color: antiquewhite;">
                                                                        <div class="d-flex align-items-center me-2">
                                                                            ...
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class="fs-7 fw-bold" style="color: black;">طلبات</div>
                                                                    ...
                                                                    <div class="col-4" style="border-right-style: dashed; border-right-width: thin; border-color: antiquewhite;">
                                                                        <div class="d-flex align-items-center ms-2">
                                                                            ...
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class="fs-7 fw-bold" style="color: black;">مجموعة مسبقة</div>
                                                                    ...
                                                                    <div class="col-4">
                                                                        <div class="d-flex align-items-center ms-2">
                                                                            ...
                                                                            <div class="col-2">
                                                                                <div class="symbol symbol-40px mx-3" style="padding-top: 20px;">
                                                                                    <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs045.svg-->
                                                                                        <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                            <img src="../assets/media/UDP/others2.png" alt="others" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                        </span>
                                                                                        <!--end::Svg Icon-->
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class="fs-7 fw-bold" style="color: black;">تسويق الآخرين</div>

                                                                            </div>
                                                                            <!--end::Title-->
                                                                            <div class="col-4">
                                                                                <asp:LinkButton ID="lnkOthers" runat="server" OnClick="lnkMerch_Click">
                                        ...
                                        <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="cus_GeoCode" AllowFiltering="true" HeaderStyle-Width="120px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="ماجستير جيو كود" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                    HeaderStyle-Font-Bold="true" UniqueName="cus_GeoCode">
                                                </telerik:GridBoundColumn>

                                                <telerik:GridBoundColumn DataField="cse_StartGeoCode" AllowFiltering="true" HeaderStyle-Width="140px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="الرمز الجغرافي للمعاملة" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                ...
                                                <telerik:GridBoundColumn DataField="cse_IsScheduled" AllowFiltering="true" HeaderStyle-Width="80px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="المقرر" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                ...
                                                <telerik:GridBoundColumn DataField="salecount" AllowFiltering="true" HeaderStyle-Width="80px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="الفواتير" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                ...
                                                <telerik:GridBoundColumn DataField="ordercount" AllowFiltering="true" HeaderStyle-Width="80px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="طلب" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                ...
                                                <telerik:GridBoundColumn DataField="Adpaymentcount" AllowFiltering="true" HeaderStyle-Width="80px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="يتقدم" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="Confirm">هل أنت متأكد أنك تريد تحديث المصادقة .. ؟؟
                    </h5>
                </div>
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                        <asp:LinkButton ID="lnkSave" runat="server" Text="نعم" OnClick="lnkSave_Click" CssClass="btn btn-sm fw-bold btn-primary" />
                    </telerik:RadAjaxPanel>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>يمكنك المضي قدما في التسوية</span>
                </div>
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                      <button type="button" class="btn btn-sm fw-bold btn-secondary" onclick="cancelModal(kt_modal_1_4);">نعم</button>
    ...
    <div class="modal fade" id="FailureAlert" tabindex="-1" role="dialog" style="height:auto"  data-backdrop="static" data-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm fw-bold btn-secondary" onclick="cancelModal(FailureAlert);">نعم</button>
                </div>
            </div>
        </div>
    </div>
