<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="ListCustomerBrochure.aspx.cs" Inherits="SalesForceAutomation.Admin.ListCustomerBrochure" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Customer Brochure
                            </h3>
                        </div>
                                            ...
                                            <telerik:GridTemplateColumn DataField="cbr_Path" UniqueName="cbr_Path" AllowFiltering="false"
                                                ...
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="pp" runat="server"
                                                        ImageUrl="assets/media/icons/svg/Files/File.svg" NavigateUrl='<%#Eval("cbr_Path")%>' Height="50" Width="50" Target="_blank">
                                                    </asp:HyperLink>
                                                </ItemTemplate>
