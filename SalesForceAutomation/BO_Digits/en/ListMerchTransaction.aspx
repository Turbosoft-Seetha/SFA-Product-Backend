<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListMerchTransaction.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListMerchTransaction" %>
                                                                ...
                                                                <div class="kt-portlet__head" style="padding-top: 5px;">
                                                                    <div class="kt-portlet__head-label">
                                                                        <h3 class="kt-portlet__head-title" style="font-size: medium;">
                                                                            <span class="min-w-70px fw-semibold text-gray-700 pt-5">Merchandising Transactions</span>
                                                                        </h3>
                                                                    </div>
                                                                </div>
