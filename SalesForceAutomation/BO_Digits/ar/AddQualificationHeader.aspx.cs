...
{
    public partial class AddQualificationHeader : System.Web.UI.Page
    {
        ...
        protected void Save()
        {
            ...
            if (dsc == null)
            {
                ScriptManager.RegisterStartupScript(this.Page, this.GetType(),
                    "tmp", "<script type='text/javascript'>failedModal('بالنسبة لهذا الواجب ، تعتبر العناصر إلزامية');</script>", false);
                return;
            }
            ...
            string Value = Obj.SaveData("sp_Web_Promotion", "InsertQuallification", Name, arr);
