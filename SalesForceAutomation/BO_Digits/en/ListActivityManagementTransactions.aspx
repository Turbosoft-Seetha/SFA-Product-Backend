<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListActivityManagementTransactions.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListActivityManagementTransactions" %>
                                                            ...
                                                            <div class="kt-portlet__head" style="padding-top: 5px;">
                                                                <div class="kt-portlet__head-label">
                                                                    <h3 class="kt-portlet__head-title" style="font-size: medium;">
                                                                        <span class="min-w-70px fw-semibold text-gray-700 pt-5"><asp:Label runat ="server" ID="lblActMangmnt"></asp:Label></span>
                                                                    </h3>
                                                                </div>
                                                            </div>
