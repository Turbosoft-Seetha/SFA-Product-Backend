<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="AddEditRouteCustomerPromotion.aspx.cs" Inherits="SalesForceAutomation.Admin.AddEditRouteCustomerPromotion" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px">
                        <div class="kt-portlet__head-label">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a class="kt-subheader__breadcrumbs-link"> Add Edit Route Customer Promotion</a>
                        ...
                        <div class="kt-portlet__head-actions">
                            ...
                            <asp:LinkButton ID="lnkAssign" Width="105px" runat="server" Text="Assignment" CssClass="btn btn-brand btn-elevate btn-icon-sm" OnClick="lnkAssign_Click" CausesValidation="false"/>
                            <asp:LinkButton ID="lnkQuali" Width="115px" runat="server" Text="Qualification" CssClass="btn btn-brand btn-elevate btn-icon-sm" OnClick="lnkQuali_Click" CausesValidation="false"/>
                            <asp:LinkButton ID="lnkPromo" Width="100px" runat="server" Text="Promotion" CssClass="btn btn-brand btn-elevate btn-icon-sm" OnClick="lnkPromo_Click" CausesValidation="false" />
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Edit Route Customer Promotion
                        ...
                        <div class="kt-portlet__head-actions">
                            <telerik:RadAjaxPanel ID="rdd" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                <div class="row">
                                <asp:LinkButton ID="lnkAdd" Width="100px" runat="server" ValidationGroup="frm" OnClick="lnkAdd_Click" UseSubmitBehavior="false" Text='Add'
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                        <asp:LinkButton ID="lnkSave" runat="server" Text="Yes" OnClick="lnkSave_Click" CssClass="btn btn-brand btn-elevate btn-icon-sm" />
                    </telerik:RadAjaxPanel>
