<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCustomerBrochure.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditCustomerBrochure" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
     <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
           <a class="btn btn-sm fw-bold btn-secondary" href="ListCustomerBrochure.aspx">Cancel
                                    </a> &nbsp;
