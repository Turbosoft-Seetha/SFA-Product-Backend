<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ReturnApprovalHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ReturnApprovalHeader" %>
                ...
                <div class="kt-form kt-form--label-right">
                           ...
                           <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="true"
                                ...
                                <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                    ShowFooter="false" DataKeyNames="rah_ID"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="rrh_RequestNumber" AllowFiltering="true" HeaderStyle-Width="200px"
                                        ...
                                        HeaderStyle-Font-Bold="true" UniqueName="CreatedDate">
                                         ...
                                         <telerik:GridBoundColumn DataField="rah_ReturnType" AllowFiltering="true" HeaderStyle-Width="200px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="Return Type" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="rah_ReturnType">
                                        </telerik:GridBoundColumn>
                                         <telerik:GridBoundColumn DataField="ReturnMode" AllowFiltering="true" HeaderStyle-Width="200px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Return Mode" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="ReturnMode">
                                            </telerik:GridBoundColumn>
                                        
                                         <telerik:GridBoundColumn DataField="Mode" AllowFiltering="true" HeaderStyle-Width="200px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="Mode" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                    HeaderStyle-Font-Bold="true" UniqueName="Mode" Display="false">
                                                </telerik:GridBoundColumn>
                                        
                                           <telerik:GridBoundColumn DataField="rah_ApprovalStatus" AllowFiltering="true" HeaderStyle-Width="100px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="Status" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                    HeaderStyle-Font-Bold="true" UniqueName="rah_ApprovalStatus">
                                                </telerik:GridBoundColumn>
