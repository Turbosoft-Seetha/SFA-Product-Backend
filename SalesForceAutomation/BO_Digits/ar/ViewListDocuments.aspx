<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="ViewListDocuments.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.ViewListDocuments" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="margin-bottom:20px;">
                        <div class="kt-portlet__head-label">
                            <h6 class="kt-portlet__head-title"><asp:Literal ID="ltrlCustomer" runat="server"></asp:Literal> وثائق
                            </h6>
                        </div>
                                ...
                                <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                    ...
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="cdc_DocName" AllowFiltering="true" HeaderStyle-Width="60px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText=" اسم الملف" FilterControlWidth="100%"
                                        ...
                                        <telerik:GridTemplateColumn DataField="cdc_DocPath" UniqueName="cdc_DpcPath" AllowFiltering="false"
                                                ...
                                                HeaderStyle-Font-Size="Smaller" HeaderText="بي دي إف"
                                        ...
                                        <telerik:GridBoundColumn DataField="cdc_FromDate" AllowFiltering="true" HeaderStyle-Width="60px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="من التاريخ" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                        ...
                                        <telerik:GridBoundColumn DataField="cdc_ToDate" AllowFiltering="true" HeaderStyle-Width="60px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="ان يذهب في موعد" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
