...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
    ...
    <asp:LinkButton ID="btnCancel" Width="100px" runat="server"
     ...
     <asp:LinkButton ID="lnkConfirm" runat="server" ValidationGroup="form" UseSubmitBehavior="false" Text='<i class="icon-ok"></i>Confirm'
         CssClass="btn btn-sm fw-bold btn-primary" CausesValidation="true" OnClick="lnkConfirm_Click1" />
 </telerik:RadAjaxPanel>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="radSelectAllDelete">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grvRpt" />
                ...
                <div class="kt-portlet">
                    ...
                    <div style="text-align: right;">
                        <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
                            <asp:RadioButton ID="radSelectAllDelete" runat="server" Text="All Delete" AutoPostBack="true" OnCheckedChanged="radSelectAllDelete_CheckedChanged1" />
                        </telerik:RadAjaxPanel>
     ...
     <ItemTemplate>
         <asp:ImageButton CommandName="Delete" ID="lnkDelete" Visible="true" AlternateText="Delete" runat="server"
             ...
             ImageUrl="../assets/media/svg/general/Trash.svg"></asp:ImageButton>
                                            ...
                                            <telerik:GridTemplateColumn AllowFiltering="false" HeaderStyle-Width="80px"
                                                ...
                                                <ItemTemplate>
                                                    <asp:RadioButtonList ID="rbActions" runat="server" RepeatDirection="Horizontal" CssClass="radioList">
                                                        <asp:ListItem ID="rdDelete" Text="Delete" Value="A" style="color: blue; padding-right: 5px;" />
                                                    </asp:RadioButtonList>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                        </Columns>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel11" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                        <asp:LinkButton ID="Delete" runat="server" Text="Yes" OnClick="Delete_Click" CssClass="btn btn-sm fw-bold btn-primary" />
                 </telerik:RadAjaxPanel>
