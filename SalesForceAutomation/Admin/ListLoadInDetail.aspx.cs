...
{
    public partial class ListLoadInDetail : System.Web.UI.Page
    {
        ...
        public void LoadList()
        {
            ...
            lstUser = ObjclsFrms.loadList("ListLoadInDetail", "sp_Masters");
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Edit"))
            {
                ...
                Response.Redirect("AddEditLoadDetail.aspx?Id=" + ID+ "&hid=" + ResponseID);
            }
        }
        ...
        protected void lnkSubCat_Click1(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AddEditLoadDetail.aspx?hid="+hid);
        }
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "AR")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Load In Detail", "Xlsx"));
