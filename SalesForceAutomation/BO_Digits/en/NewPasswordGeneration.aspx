<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="NewPasswordGeneration.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.NewPasswordGeneration_a" %>
...
<asp:Content ID="ContentAction" ContentPlaceHolderID="Actions" runat="server">
 ...
 <asp:LinkButton ID="LinkButton2" Width="100px" runat="server" 
                         ...
                         ValidationGroup="form" OnClick="LinkButton1_Click"  UseSubmitBehavior="false" 
                                 Text='<i class="icon-ok"></i>View List' CssClass="btn btn-sm fw-bold btn-primary"  CausesValidation="false"/>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="col-lg-12">
                                            <telerik:RadComboBox Skin="Material" Filter="Contains" RenderMode="Lightweight"
                                                ID="rdRoute" runat="server" DefaultMessage="Select Route" EmptyMessage="Select Route" Width="100%"
                                ...
                                <div class=" col-lg-8 row" style="padding-top: 20px">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="col-lg-12" style="background-color: white">
                                            <asp:TextBox ID="txtKey" runat="server" Skin="Material" RenderMode="Lightweight" MaxLength="6" Width="100%" CssClass="form-control"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtKey" ErrorMessage="Please enter Key" ForeColor="Red" Display="Dynamic"
                                                ValidationGroup="form" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtKey" ErrorMessage="Please enter a valid 6-digit key" ForeColor="Red"
                                                ValidationExpression="^\d{6}$" Display="Dynamic" ValidationGroup="form"></asp:RegularExpressionValidator><br />
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="kt_modal_1_4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:LinkButton ID="btnOK" runat="server"  CssClass="btn btn-sm fw-bold btn-secondary">Ok</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
