<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="ListPromotionType.aspx.cs" Inherits="SalesForceAutomation.Admin.ListPromotionType" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Promotion Type</h3>
                            <%-- breadcrumbs starts --%>
                             <div class="kt-subheader__breadcrumbs" style="padding-left:20px;">
                                <a href="ListPromotionType.aspx" class="kt-subheader__breadcrumbs">
                                <i class="flaticon2-shelter"></i> Promotion Type </a>
                             </div>
                            <%-- breadcrumbs Ends --%>
                        </div>
                        <div class="kt-portlet__head-actions">
                            <div class="row">
                                <asp:LinkButton ID="lnkSubCat" runat="server" CssClass="btn btn-brand btn-elevate btn-icon-sm" Text="Add" OnClick="lnkSubCat_Click" Style="padding-top:14px;" Visible="false"></asp:LinkButton>
                                   </div>
                        </div>
                    </div>
                    <!--end: Search Form -->
