<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="ViewLoadIn.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.ViewLoadIn" %>
                                ...
                                <div class="col-lg-2 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="form"
                                            ControlToValidate="ddlHUom" ErrorMessage="الرجاء اختيار وحدة القياس العلوية" Display="Dynamic" ForeColor="Red"
                                            SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
