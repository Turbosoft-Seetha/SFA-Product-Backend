<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="MerchandisingTransactionDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.MerchandisingTransactionDetail" %>
                ...
                <div class="kt-portlet">
                     ...
                     <div class="kt-portlet__head" style=" padding-bottom: 20px; border-bottom-style:inset;border-bottom-width:thin;">                       
                        <div class="kt-portlet__head-actions">
                            <div class="row">
                                <div class="col-sm-6">
                                 <h5 class="kt-portlet__head-title">عملية العميل - <asp:Label ID="lblType" runat="server" Font-Bold="true" ForeColor="Blue"></asp:Label>
                                    </h5>
                                 </div>
