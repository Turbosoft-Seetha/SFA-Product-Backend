<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="OrderDetailListing.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.OrderDetailListing" %>
...
<asp:Content ID="ContentAction" ContentPlaceHolderID="Actions" runat="server">
    <asp:linkbutton  ID="Linkbtn1" Visible="true" CssClass="btn btn-sm btn-primary me-2"  runat="server" onClick="Linkbtn1_Click" >أكد الطلب
      </asp:linkbutton>
                                                            ...
                                                            <table>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="col-lg-6 mb-2">
                                                                     ...
                                                                     <div class="col-lg-6 mb-2">
                                                                        <label class="col-lg-2 col-form-label" style="display: contents;">مجموعه الخط:</label>
                                                                        <label class="col-lg-4 col-form-label" style="display: contents;">
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="prd_Name" AllowFiltering="false" HeaderStyle-Width="150px"
                                                     ...
                                                     <telerik:GridBoundColumn DataField="prd_NameArabic" AllowFiltering="false" HeaderStyle-Width="150px"
                                                        HeaderStyle-Font-Size="Smaller" HeaderText=" اسم المنتج باللغة العربية"
