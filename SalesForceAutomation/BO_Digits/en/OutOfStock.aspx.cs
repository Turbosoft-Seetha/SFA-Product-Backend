    ...
    public partial class OutOfStock : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else // While loading page from transaction menu
                {
                    try
                    {
                        if (Session["OOSFDate"] != null)
                        {

                            rdfromDate.SelectedDate = DateTime.Parse(Session["OOSFDate"].ToString());
                        }
                        else
                        {
                        ...
                        if (Session["OOSTDate"] != null)
                        {

                            rdendDate.SelectedDate = DateTime.Parse(Session["OOSTDate"].ToString());
                        }
                        else
                        {
                    ...
                    try
                    {
                        ...
                        if (Session["OOSrotID"] != null)
                        {
                            int a = rdRoute.Items.Count;
                            string route = Session["OOSrotID"].ToString();
                        ...
                        if (Session["OOScusID"] != null)
                        {
                            int a = rdCustomer.Items.Count;
                            string cusID = Session["OOScusID"].ToString();
                ...
                try
                {
                    if (Session["OOSAdvFilter"] != null)
                    {
                        if (Session["OOSAdvFilter"].ToString() == "true")
                        {
                ...
                catch (Exception ex)
                {
                    ...
                    ObjclsFrms.LogMessageToFile(UICommon.GetLogFileName(), "OutOfStock.aspx PageLoad()", "Error : " + ex.Message.ToString() + " - " + innerMessage);
                }
        ...
        protected void lnkFilter_Click(object sender, EventArgs e)
        {
            try
            {
                if (Session["OOSFDate"] != null)
                {
                    ...
                    if (fromdate == Session["OOSFDate"].ToString())
                    {
                        rdfromDate.SelectedDate = DateTime.Parse(Session["OOSFDate"].ToString());
                    }
                    else
                    {
                        Session["OOSFDate"] = DateTime.Parse(rdfromDate.SelectedDate.ToString());
                    }
                }
                else
                {
                ...
                if (Session["OOSTDate"] != null)
                {
                    ...
                    if (todate == Session["OOSTDate"].ToString())
                    {
                        rdendDate.SelectedDate = DateTime.Parse(Session["OOSTDate"].ToString());
                    }
                    else
                    {
                        Session["OOSTDate"] = DateTime.Parse(rdendDate.SelectedDate.ToString());
                    }
                ...
                {
                    string route = Rot();
                    if (route == Session["OOSrotID"].ToString())
                    {
                        string rotID = Rot();
                ...
                {
                    string customer = Cus();
                    if (customer == Session["OOScusID"].ToString())
                    {
                        string cusID = Cus();
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("Detail"))
            {
                ...
                Response.Redirect("OutOfStockItem.aspx?HId=" + ID);
            }
        }
