...
{
    public partial class VanToVanWorkFlow : System.Web.UI.Page
    {
        ...
        public void Data()
        {
            DataTable lstdata = ObjclsFrms.loadList("SelectVanToVanWorkFlow", "sp_Transaction", ResponseID.ToString());
