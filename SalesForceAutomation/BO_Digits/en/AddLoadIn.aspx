<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddLoadIn.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddLoadIn" %>
                            ...
                            <div class="col-lg-12 row">
                                   ...
                                   <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                       ...
                                       <div class="col-lg-10">
                                           ...
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" Display="Dynamic" ErrorMessage="Date is mandatory"
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox ID="ddlRotType" Width="80%" runat="server" EmptyMessage="Select Route Type" Filter="Contains" RenderMode="Lightweight" OnSelectedIndexChanged="ddlRotType_SelectedIndexChanged" AutoPostBack="true">
                                            <Items>
                                                ...
                                                <telerik:RadComboBoxItem Text="Order Delivery" Value="OD" />
                                            </Items>
                                        </telerik:RadComboBox>
                                    </div>
                                </div>
                                <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <telerik:RadComboBox ID="ddlp" runat="server" Width="100%" EmptyMessage="Select Route" Filter="Contains" RenderMode="Lightweight" OnSelectedIndexChanged="ddlp_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
                   ...
                   <!-- ------------------------------------->
                            ...
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-2 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox ID="ddlLUom" runat="server"  EmptyMessage="Select Lower UOM" Width="100%" Filter="Contains" RenderMode="Lightweight" OnSelectedIndexChanged="ddlLUom_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
