    ...
    public partial class AddEditPriceListHeader : System.Web.UI.Page
    {
        ...
        protected void Save()
        {
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                if (res > 0)
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Succcess(' تم حفظ قائمة الأسعار بنجاح');</script>", false);
                }
                else
                {
            ...
            else
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Succcess('  تم تحديث قائمة الأسعار بنجاح');</script>", false);
        ...
        {
            Response.Redirect("/BO_Digits/ar/ListPriceListHeader.aspx");
