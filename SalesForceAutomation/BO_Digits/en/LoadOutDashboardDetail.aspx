<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="LoadOutDashboardDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.LoadOutDashboardDetail" %>
      ...
      <div class="app-content flex-column-fluid">
          <div class="">
            <div class="col-lg-12 row">
                 ...
                 <%-- card-1--%>
                <asp:PlaceHolder ID="phLoafTransfer" runat="server">
                <div class="col-lg-6 ">
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark"> Load Transfers</span>
                        ...
                        <div class="card-toolbar" style="padding-top: 8px; padding-left: 5%;">
                            ...
                            <ul class="nav">
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fs-4 fw-bold px-4 me-1 active" data-kt-timeline-widget-1="tab" data-bs-toggle="tab" href="#kt_timeline_widget_1_TotalPlanned">Good Stock  
                                ...
                                <li class="nav-item" style="padding-left: 30px;">
                                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fs-4 fw-bold px-4 me-1 ms-20" data-kt-timeline-widget-1="tab" data-bs-toggle="tab" href="#kt_timeline_widget_1_Visited">Bad Stock
                                                 ...
                                                 <asp:Repeater runat="server" ID="rptLoadTransferGD">
                                                    ...
                                                    <td class="min-w-175px">
                                                         ...
                                                         <div class="position-relative ps-0 pe-3 py-0">
                                                             <a href="LodTransferDetail.aspx?LTH=<%# Eval("lth_ID") %>" class="mb-1 text-dark text-hover-primary fw-bold"><asp:Label ID="lblLTNumber" Text='<%# Eval("lth_TransID") %>' runat="server"></asp:Label></a>
                                                 ...
                                                 <asp:Repeater runat="server" ID="rptLoadTransferBD">
                                                    <ItemTemplate>
                                                       ...
                                                       <tr class="even">
                                                         <td class="min-w-175px">
                                                             <div class="position-relative ps-0 pe-3 py-0">
                                                                 <a href="#" class="mb-1 text-dark text-hover-primary fw-bold"><asp:Label ID="lblbdnumber" Text='<%# Eval("lth_TransID") %>' runat="server"></asp:Label></a>
                  ...
                  <%-- card-2--%>
                 <asp:PlaceHolder ID="phLoadOut" runat="server" Visible="false">
                <div class="col-lg-6">
                ...
                <div class="col-lg-12 mb-5">
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header pt-5">
                            <!--begin::Card title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark"> Load Out</span>
                        ...
                        <div class="card-toolbar" style="padding-top: 8px; padding-left: 5%;">
                            ...
                            <ul class="nav">
                                <li class="nav-item">
                                    ...
                                    <%-- <div style=" width: 8px; height: 8px; margin-top: 5px;background-color: lightgray;"></div>--%>
                                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fs-4 fw-bold px-4 me-1 active" data-kt-timeline-widget-1="tab" data-bs-toggle="tab" href="#kt_timeline_widget_1_Total">Good Stock
                                       <span class="ms-10"><asp:Label runat="server" ID="lblLOGoodStock" Text="25">  </asp:Label> </span></a>

                                </li>
                                <li class="nav-item" style="padding-left: 30px;">
                                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fs-4 fw-bold px-4 me-1 ms-20" data-kt-timeline-widget-1="tab" data-bs-toggle="tab" href="#kt_timeline_widget_1_Planned">Bad Stock
                                                    ...
                                                    <ItemTemplate>
                                                          ...
                                                          <tr class="odd">
                                                                <td class="min-w-175px">
                                                                    ...
                                                                    <div class="fs-8 text-muted fw-bold"> <asp:Label ID="lblCus" Text='<%# Eval("customer") %>' runat="server"></asp:Label></div>
                                                                    </div>
                                                                 </td>                                                 
                                                           </tr>
