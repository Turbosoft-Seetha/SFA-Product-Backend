...
{
	public partial class SettlementApproval : System.Web.UI.Page
	{
		...
		public void LoadList(string mode)
		{
			...
			if (mode.Equals("F"))
			{
				lstUser = ObjclsFrms.loadList("SelectSettlementStatus", "sp_SettlementApproval", mainConditions(rotID, "C").ToString());

			}
			else
			{
				lstUser = ObjclsFrms.loadList("SelectSettlementStatus", "sp_SettlementApproval", mainConditions(rotID, "").ToString());
			}
		...
		protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
		{
			...
			if (e.CommandName.Equals("Detail"))
			{
                ...
                Response.Redirect("SettlementReportCompleted.aspx?Id=" + ID + "&&from=" + "AP");
            }
			...
			if (e.CommandName.Equals("Settlement"))
			{
				...
				{
					//DataTable lstSettlement = ObjclsFrms.loadList("SelectSettlementStatus", "sp_SettlementApproval");
