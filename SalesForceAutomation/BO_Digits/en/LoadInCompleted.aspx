<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="LoadInCompleted.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.LoadInCompleted" %>
                            ...
                            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                ...
                                <div class=" col-lg-12 row" style="padding-bottom: 10px">
                                    <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:RadComboBox Skin="Material" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" RenderMode="Lightweight" Width="100%"
                                                ID="rdstatus" runat="server" EmptyMessage="Select Status" OnSelectedIndexChanged="rdstatus_SelectedIndexChanged" AutoPostBack="true">
                                              <Items>
                                            <telerik:RadComboBoxItem Text="Confirmed" Value="C"  />
                                            <telerik:RadComboBoxItem Text="Pending Approval" Value="P" />
