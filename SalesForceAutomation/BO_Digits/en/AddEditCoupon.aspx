<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCoupon.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditCoupon" %>
                        ...
                        <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
                            <div class="kt-portlet__body">
                                <div class="col-lg-12 row">
                                    ...
                                    <div class="col-lg-4 form-group">
                                        <label class="control-label col-lg-12">No of leaf <span class="required"></span></label>
                                        <div class="col-lg-12">
                                            <telerik:RadTextBox ID="ddlnoofleaf" runat="server" CssClass="form-control" Width="100%" ></telerik:RadTextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
                                                ControlToValidate="ddlnoofleaf" ErrorMessage="Please Enter No of leaf" ForeColor="Red" Display="Dynamic"
                                                SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                        </div>
                                    </div>
