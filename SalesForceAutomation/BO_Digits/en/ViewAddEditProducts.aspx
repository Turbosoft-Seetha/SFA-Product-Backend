<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ViewAddEditProducts.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ViewAddEditProducts" %>
                            ...
                            <div class="kt-portlet__body">
                                <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel6">
                                    ...
                                    <div class="col-lg-12 row" style="padding-top: 10px;">
                                        ...
                                        <div class="col-lg-4 form-group">
                                            <label class="control-label col-lg-12">Arabic Item long Description <span class="required"></span></label>
                                            <div class="col-lg-12">
                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="col-lg-12 row" style="padding-top: 10px;">
                                        ...
                                        <div class="col-lg-3 form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <telerik:RadDropDownList ID="ddlDefault" runat="server" Width="100%" DefaultMessage="please Select" Enabled="false">
                                                    <Items>
                                        ...
                                        <div class="col-lg-3 form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <telerik:RadDropDownList ID="ddlsaleshold" runat="server" Width="100%" DefaultMessage="please Select" Enabled="false">
                                                    <Items>
                                                        <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                        <telerik:DropDownListItem Text="No" Value="N" />
                                                    </Items>
