                        ...
                        <div class="kt-portlet__body">
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddlComments" runat="server" Width="100%" RenderMode="Native" AutoPostBack="true" OnSelectedIndexChanged="ddlOptions_SelectedIndexChanged">
                                            <Items>
                           ...
                           <asp:PlaceHolder ID="PnlComTxt" runat="server" Visible="false">
                                <div class="col-lg-4 form-group" style="padding-top: 15px"; >
                                <label class="control-label col-lg-12">Please add your comments: <span class="required"></span></label>
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="commentsTextArea" runat="server" CssClass="form-control" RenderMode="Lightweight" Width="100%" AutoPostBack="true"></telerik:RadTextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="frm"
                                        ControlToValidate="commentsTextArea" ErrorMessage="Please Enter Comments" Display="Dynamic" ForeColor="Red"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator>
