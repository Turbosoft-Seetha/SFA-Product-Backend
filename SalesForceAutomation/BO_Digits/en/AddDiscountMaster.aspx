<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddDiscountMaster.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddDiscountMaster" %>
...
<asp:Content ID="ContentAction" ContentPlaceHolderID="Actions" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        ...
        <asp:LinkButton ID="lnkSave" runat="server" ValidationGroup="form" OnClick="lnkSave_Click" UseSubmitBehavior="false" Text='Proceed' CssClass="btn btn-sm fw-bold btn-primary" CausesValidation="true" />
                        ...
                        <div class="kt-portlet__body">
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-3 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                            ControlToValidate="ddlCustomer" ValidationGroup="form" ErrorMessage="Please select customer" ForeColor="Red" Display="Dynamic"
                                ...
                                <div class="col-lg-3 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadMonthYearPicker ID="mdpMonth" runat="server" Width="100%"></telerik:RadMonthYearPicker>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                            ControlToValidate="mdpMonth" ErrorMessage="Please select a month" ForeColor="Red" Display="Dynamic"
                                            SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                    </div>
                                </div>

                                <div class="col-lg-3 form-group">
                                    <label class="control-label col-lg-12">Discount</label>
                                    <div class="col-lg-12">
                                        <telerik:RadNumericTextBox ID="txtDiscount" runat="server" Width="100%"></telerik:RadNumericTextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                            ControlToValidate="txtDiscount" ErrorMessage="Please enter percentage" ForeColor="Red" Display="Dynamic"
                                            SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadNumericTextBox ID="txtAmount" runat="server" Width="100%"></telerik:RadNumericTextBox>
