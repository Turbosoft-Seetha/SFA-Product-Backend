                        ...
                        <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                            ...
                            <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                ...
                                <Columns>
                                   ...
                                   <telerik:GridBoundColumn DataField="cct_Code" AllowFiltering="true" HeaderStyle-Width="80px"
                                    ...
                                    <telerik:GridBoundColumn DataField="cct_Name" AllowFiltering="true" HeaderStyle-Width="80px"
                                        HeaderStyle-Font-Size="Smaller" HeaderText="Name" FilterControlWidth="40%"
                                        CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                        HeaderStyle-Font-Bold="true" UniqueName="cct_Name">
                                    </telerik:GridBoundColumn>

                                     <telerik:GridBoundColumn DataField="cct_NameArabic" AllowFiltering="true" HeaderStyle-Width="80px"
                                     ...
                                     <telerik:GridBoundColumn DataField="cum_Name" AllowFiltering="true" HeaderStyle-Width="80px"
