<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="PartialDeliveryApprovalHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.PartialDeliveryApprovalHeader" %>
                                ...
                                <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                    ...
                                    <Columns>
                                        ...
                                        HeaderStyle-Font-Bold="true" UniqueName="OrderID">
                                         ...
                                         <telerik:GridBoundColumn DataField="ExpectedDelDate" AllowFiltering="true" HeaderStyle-Width="150px"
                                        ...
                                        HeaderStyle-Font-Bold="true" UniqueName="dah_FinalAmount">
                                            ...
                                            <HeaderStyle HorizontalAlign="Right" />
                                             ...
                                             <telerik:GridBoundColumn DataField="dah_ApprovalStatus" AllowFiltering="true" HeaderStyle-Width="100px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="Status" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                    HeaderStyle-Font-Bold="true" UniqueName="dah_ApprovalStatus">
                                                </telerik:GridBoundColumn>                                       
