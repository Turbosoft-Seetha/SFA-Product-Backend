<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="CouponReturnBook.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.CouponReturnBook" %>
                                    ...
                                    <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
                                        ...
                                        <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                            ...
                                            <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                                ShowFooter="false" DataKeyNames="crb_ID"
                                            ...
                                            <telerik:GridBoundColumn DataField="crb_BookNumber" AllowFiltering="true" HeaderStyle-Width="80px"
