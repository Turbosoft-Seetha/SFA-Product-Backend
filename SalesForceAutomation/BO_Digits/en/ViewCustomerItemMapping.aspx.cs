...
{
    public partial class ViewCustomerItemMapping : System.Web.UI.Page
    {
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Edit"))
            {
                ...
                Response.Redirect("ViewAddEditProductMappingGroup.aspx?Id=" + ID);
            }
            if (e.CommandName.Equals("Detail"))
            {
                GridDataItem dataItem = e.Item as GridDataItem;
                string ID = dataItem.GetDataKeyValue("pmg_ID").ToString();
                Response.Redirect("ViewCustomerItemMappingDetail.aspx?Id=" + ID);
            }
            if (e.CommandName.Equals("CusAssign"))
            {
                GridDataItem dataItem = e.Item as GridDataItem;
                string ID = dataItem.GetDataKeyValue("pmg_ID").ToString();
                Response.Redirect("ViewListAssign.aspx?Id=" + ID);
            }
        }
