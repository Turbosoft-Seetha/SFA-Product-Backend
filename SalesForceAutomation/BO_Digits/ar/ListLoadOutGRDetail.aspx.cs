...
{
    public partial class ListLoadOutGRDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("LoadOutGoodRtnHistoryByID", "sp_Masters", ResponseID.ToString());
        ...
        public void LoadData()
        {
            ...
            DataTable lstDatas = new DataTable();
            lstDatas = ObjclsFrms.loadList("LoadOutGoodRtnDetail", "sp_Transaction", ResponseID.ToString());
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "LoadOut GR Detail", "Xlsx"));
