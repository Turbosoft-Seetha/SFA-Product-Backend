<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="PendingAR.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.PendingAR" %>
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="Medium" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="arp_Type" AllowFiltering="true" HeaderStyle-Width="100px"
                                                ...
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="arp_Type" ItemStyle-HorizontalAlign="Left" Display="false">
                                            </telerik:GridBoundColumn>
                                             ...
                                             <telerik:GridBoundColumn DataField="arh_PayMode" AllowFiltering="true" HeaderStyle-Width="100px"
                                                ...
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="arh_PayMode" ItemStyle-HorizontalAlign="Left" Display="false">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="bnk_Name" AllowFiltering="true" HeaderStyle-Width="130px"
                                                ...
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="bnk_Name" ItemStyle-HorizontalAlign="Left" Display="false">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="arp_ChequeNo" AllowFiltering="true" HeaderStyle-Width="100px"
                                                ...
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="arp_ChequeNo" ItemStyle-HorizontalAlign="Left" Display="false">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="arp_ChequeDate" AllowFiltering="true" HeaderStyle-Width="100px"
                                                ...
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="arp_ChequeDate" ItemStyle-HorizontalAlign="Left" Display="false">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Void" AllowFiltering="true" HeaderStyle-Width="100px"
                                              ...
                                              <telerik:GridBoundColumn DataField="arh_Remarks" AllowFiltering="true" HeaderStyle-Width="100px"
                                                ...
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="arh_Remarks" ItemStyle-HorizontalAlign="Left" Display="false">
                                            </telerik:GridBoundColumn>
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderStyle-Width="100px" HeaderText="Cheque Image" UniqueName="ImagesCheque" HeaderStyle-Font-Bold="true" AllowFiltering="false" Display="false">
                                                        <ItemTemplate>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderStyle-Width="100px" HeaderText="Reciept Image" UniqueName="Images" HeaderStyle-Font-Bold="true" AllowFiltering="false" Display="false">
                                            <ItemTemplate>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
