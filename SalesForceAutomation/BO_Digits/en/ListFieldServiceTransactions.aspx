<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListFieldServiceTransactions.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListFieldServiceTransactions" %>
                                                       ...
                                                       <div class="col-lg-12 mb-4">
                                                           <div class="kt-portlet__head" style="padding-top: 5px;">
                                                               <div class="kt-portlet__head-label">
                                                                   <h3 class="kt-portlet__head-title" style="font-size: medium;">
                                                                       <span class="min-w-70px fw-semibold text-gray-700 pt-5"><asp:Label runat="server" ID="lblFS"></asp:Label></span>
                                                                   </h3>
                                                               </div>
                                                           </div>
                                                           ...
                                                           <div class="card-body d-flex flex-column">
                                                               ...
                                                               <div class="row g">
                                                                   ...
                                                                   <!--begin::Col-->
                                                                   <asp:PlaceHolder ID="pnlservReq" runat="server">
                                                                       <!--begin::Col-->
                                                                       <div class="col-3">
                                                                           <asp:LinkButton runat="server" ID="BtnServReq" OnClick="BtnServReq_Click">
                                                                                       ...
                                                                                       <div class="symbol symbol-40px me-3" style="padding-top: 20px;">
                                                                                           <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                               ...
                                                                                               <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                   <img src="../assets/media/UDP/sr.png" alt="sr" width="28" height="25" style="margin: 10px;" />
                                                                                               </span>
                                                                                               <!--end::Svg Icon-->
                                                                                           </div>
                                                                                       </div>
                                                                                   ...
                                                                                   <div class="col-10" style="padding-left: 10px;">
                                                                                       ...
                                                                                       <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                           ...
                                                                                           <span class="" style="font-size: 17px; font-weight: bold;">
                                                                                               <asp:Label ID="lblServReq" runat="server"></asp:Label>
                                                                                          </span>
                                                                                       </div>
                                                                                       <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Service Request</div>
                                                                       ...
                                                                       <!--begin::Col-->
                                                                       <div class="col-3">
                                                                           <asp:LinkButton runat="server" ID="BtnServJob" OnClick="BtnServJob_Click">
                                                                               <div class="d-flex align-items-center mb-2 me-2">
                                                                                   <!--begin::Symbol-->
                                                                                   <div class="col-2">
                                                                                       <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                           <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                               ...
                                                                                               <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                   <img src="../assets/media/UDP/sj.png" alt="sj" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                               </span>
                                                                                               <!--end::Svg Icon-->
                                                                                           </div>
                                                                                       </div>
                                                                                   ...
                                                                                   <div class="col-10" style="padding-left: 10px;">
                                                                                       ...
                                                                                       <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                           ...
                                                                                           <span class="" style="font-size: 17px; font-weight: bold;">
                                                                                               <asp:Label ID="lblServJob" runat="server"></asp:Label>
                                                                                           </span>
                                                                                       </div>
                                                                                       <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Service Job</div>
