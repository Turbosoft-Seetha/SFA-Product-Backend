...
{
    public partial class ResolvedServiceRequestDetail : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (lstdata.Rows.Count > 0)
            {
                ...
                lblDate.Text = lstdata.Rows[0]["LastupdateTime"].ToString();
        ...
        protected void RadGridServiceJob_ItemCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Detail"))
            {
                ...
                Response.Redirect("ResolvedServiceJobDetails.aspx?ID=" + ID.ToString());
            }
            ...
            if (e.CommandName.Equals("ReqParts"))
            {
                ...
                Response.Redirect("ResolvedServiceRequiredParts.aspx?ID=" + ID.ToString());
            }
