<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListCustomerActivity.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListCustomerActivity" %>
                    ...
                    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                         ...
                         <div class="col-lg-12 row" style="padding-bottom:10px;">
                                 ...
                                 <div class="col-lg-2" >
                                            ...
                                            <div class="col-lg-12">
                                                <telerik:RadComboBox ID="rdCustomer" runat="server" Filter="Contains" RenderMode="Lightweight" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" EmptyMessage="Select Customer" OnSelectedIndexChanged="rdCustomer_SelectedIndexChanged" AutoPostBack="true" Width="100%">
                                                </telerik:RadComboBox>
                                            </div>
                                        </div>
                              ...
                              <div class="col-lg-2" >
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadComboBox ID="ddlActivity" runat="server" Filter="Contains" RenderMode="Lightweight" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" EmptyMessage="Select Activity" Width="100%">
                                    </telerik:RadComboBox>
                                </div>
                            </div>
