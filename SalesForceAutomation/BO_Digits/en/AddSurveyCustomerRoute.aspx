<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddSurveyCustomerRoute.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddSurveyCustomerRoute" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    <h6 class="kt-portlet__head-title">Customer Route Survey Assignment
                        ...
                        <div class="col-lg-12 row">
                            <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel4" Width="60%">
                                <div class="col-lg-12 row">
                                    <div class="col-lg-3" style="padding-top: 8px;">
                                      ...
                                      <div class="col-lg-3" style="padding-top: 8px;">
                                        <div class="col-lg-12">
                                             <label class="control-label col-lg-12 pl-0">Mandatory </label>
                                        </div>
                                        <div class="col-lg-12">
                                            <telerik:RadDropDownList ID="ddlMand" runat="server" Width="100%" Filter="Contains"  RenderMode="Auto">
                                                <items>
                            ...
                            <div class="col-lg-3" style="padding-top: 10px;">
                                <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                    <asp:LinkButton ID="lnkQuestion" runat="server" CssClass="btn btn-sm fw-bold btn-primary" OnClientClick="Question();">
                                                    View Questions
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="lnkAllAssignCustomer" runat="server" CssClass="btn btn-sm fw-bold btn-primary" OnClick="lnkAllAssignCustomer_Click">
                        ...
                        <div class="kt-portlet">
                            ...
                            <div class="col-lg-12 row" style="padding-top: 20px; padding-bottom: 20px;">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <asp:LinkButton ID="lnkAddQuestion" runat="server" CssClass="btn btn-sm fw-bold btn-success" OnClientClick="Confim();" Style="align-content:flex-end;">
                                                    Add
                                    </asp:LinkButton>
                                    </telerik:RadAjaxPanel>
                            ...
                            <div class="col-lg-12 row" style="padding-top: 20px; padding-bottom: 20px;">
                                ...
                                <div class="col-lg-2">
                                    <telerik:RadAjaxPanel ID="RadAjaxPanel7" runat="server" LoadingPanelID="RadAjaxLoadingPanel8">
                                        <asp:LinkButton ID="lnkRemove" runat="server" CssClass="btn btn-sm fw-bold btn-danger" Text="Remove" OnClientClick="Delete()" style="background-color: red;border-color: red;"></asp:LinkButton>
                                    </telerik:RadAjaxPanel>
                                        ...
                                        <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="true"
                                            ...
                                            <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="srm_Name" AllowFiltering="true" HeaderStyle-Width="80px"
                                                        HeaderStyle-Font-Size="Smaller" HeaderText="Survey" FilterControlWidth="100%"
                                                        CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                        HeaderStyle-Font-Bold="true" UniqueName="srm_Name">
                                                    </telerik:GridBoundColumn>

                                                     <telerik:GridBoundColumn DataField="crs_MandColumns" AllowFiltering="true" HeaderStyle-Width="60px"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Customer route survey has been updated successfully.</span>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="kt_modal_1_7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Customer route survey has been deleted successfully.</span>
                </div>
                <div class="modal-footer">
