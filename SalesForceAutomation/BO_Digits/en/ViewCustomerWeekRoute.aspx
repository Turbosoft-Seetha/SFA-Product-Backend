<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ViewCustomerWeekRoute.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ViewCustomerWeekRoute" %>
                            ...
                            <div class="kt-portlet__body" style="padding-bottom:8px;">
                                ...
                                <div class="col-lg-12 row">
                                    ...
                                    <div class="col-lg-2 " style="margin-top: 20px; padding-top: 15px">
                                        <asp:LinkButton ID="btnSearch" runat="server" OnClick="btnSearch_Click" CssClass="btn btn-sm btn-primary me-2" BackColor="#DAE9F8" ForeColor="#009EF7">Apply Filter</asp:LinkButton>
