<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="ListLoadOutBRHistory.aspx.cs" Inherits="SalesForceAutomation.Admin.ListLoadOutBRHistory" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 8px; padding-bottom: 8px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Load Out Bad Return History
                            </h3>
                             <%-- breadcrumbs --%>
                        ...
                        <div class="kt-portlet__head-actions">
                            ...
                            <asp:ImageButton ID="imgExcel" runat="server" ImageUrl="../Media/excel.png" Height="50" ToolTip="Download" OnClick="imgExcel_Click1" AlternateText="Xlsx" />
