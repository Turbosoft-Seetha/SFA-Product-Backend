<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="AddCustomerProductsMapping.aspx.cs" Inherits="SalesForceAutomation.AddCustomerProductsMapping" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" runat="server">
    <script>
        ...
        function ProMapping() {
            ...
            var R = url.searchParams.get("RID");
            window.location.href = "ListCustomerProductsMapping.aspx?CID=" + c + "&RID="+ R;
        }
    </script>
</asp:Content>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head" style="padding-top: 20px">
                        ...
                        <div class="kt-subheader__breadcrumbs">
                            ...
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a href="javascript:ProMapping();" class="kt-subheader__breadcrumbs-link">Product Group Mapping </a>
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                             <a href="AddCustomerProductsMapping.aspx" class="kt-subheader__breadcrumbs">Add Customer Products Mapping</a>
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Product Mapping  <telerik:RadLabel runat="server" ID="labelqno" Text=""></telerik:RadLabel>
                            </h3>
                        </div>
                        <div class="kt-portlet__head-actions">
                            <telerik:RadAjaxPanel ID="pnl" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                ...
                                &nbsp;
                                    <a class="btn btn-brand btn-elevate btn-icon-sm" href="ListCustomerProductsMapping.aspx">Cancel
                                    </a>
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadComboBox ID="Pgm" runat="server" Width="100%" EmptyMessage="Please Select " RenderMode="Lightweight" Enabled="true" OnSelectedIndexChanged="Pgm_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="frm"
                                        ControlToValidate="Pgm" ErrorMessage="Please choose " Display="Dynamic" ForeColor="Red"
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Mapped Products
                            </h3>
                        </div>
                    </div>
                    <!--End Detail header-->
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                              ...
                                              <telerik:GridBoundColumn DataField="prd_Name" AllowFiltering="true" HeaderStyle-Width="60px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="prd_Name" FilterControlWidth="100%"
