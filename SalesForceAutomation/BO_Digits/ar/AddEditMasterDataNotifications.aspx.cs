    ...
    public partial class AddEditMasterDataNotifications : System.Web.UI.Page
    {
        ...
        protected void Save()
        {
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                if (res > 0)
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Succcess('تم حفظ إعلام البيانات بنجاح');</script>", false);
                }
                else
                {
        ...
        {
            Response.Redirect("/BO_Digits/ar/ListMasterDataNotifications.aspx");
