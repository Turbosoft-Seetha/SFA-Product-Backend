<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ViewListAssetMaster.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ViewListAssetMaster" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">                  
                        <div class="col-lg-10">
                            <h6 class="kt-portlet__head-title"><asp:Literal ID="ltrlCustomer" runat="server"></asp:Literal> Assets 
                            </h6>
