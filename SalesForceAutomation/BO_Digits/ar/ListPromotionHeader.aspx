<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="ListPromotionHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.ListPromotionHeader" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
     <telerik:RadAjaxPanel ID="rdd" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
                                  ...
                                  <asp:LinkButton ID="lnkSave" runat="server" OnClick="lnkSave_Click" Text="يضيف"
