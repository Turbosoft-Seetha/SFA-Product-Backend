<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddProducts.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddProducts" %>
                            ...
                            <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                ...
                                <div class="col-lg-12 row">
                                    ...
                                    <div class="col-lg-4 mt-1 form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:RadDropDownList ID="prd_Type" runat="server" Width="100%" DefaultMessage="Select Product Type" OnSelectedIndexChanged="SelectedIndexChanged_prd_Type" CausesValidation="false" AutoPostBack="true">
                                                <Items>
                                    ...
                                    <asp:PlaceHolder runat="server" ID="IsPrdChargable">
                                        <div class="col-lg-4 mt-1 form-group">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" Display="Dynamic" ValidationGroup="frm"
                                                ...
                                                SetFocusOnError="false"></asp:RequiredFieldValidator>
                                            <telerik:RadLabel runat="server" ID="upcduplicate" Text="" ForeColor="Red"></telerik:RadLabel>
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="true"
                                ...
                                <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                    ShowFooter="false" DataKeyNames="uomID"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="uomID" AllowFiltering="true" HeaderStyle-Width="100px"
                                        ...
                                        <telerik:GridBoundColumn DataField="uom" AllowFiltering="true" HeaderStyle-Width="130px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="UOM" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="uom">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="stdprice" AllowFiltering="true" HeaderStyle-Width="130px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="Standard Selling Price" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="stdprice">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="rtnprice" AllowFiltering="true" HeaderStyle-Width="130px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="Return Price" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="rtnprice">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="UPC" AllowFiltering="true" HeaderStyle-Width="130px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="UPC" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="UPC">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="DefaultVal" AllowFiltering="true" HeaderStyle-Width="90px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="D" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="DefaultVal" Display="false">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="Default" AllowFiltering="true" HeaderStyle-Width="90px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="Default" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="Default">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="salesholdVal" AllowFiltering="true" HeaderStyle-Width="90px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="S" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="salesholdVal" Display="false">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="saleshold" AllowFiltering="true" HeaderStyle-Width="90px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="Disable UOM" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="saleshold">
                                        </telerik:GridBoundColumn>
