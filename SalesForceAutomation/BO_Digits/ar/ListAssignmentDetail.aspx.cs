    ...
    public partial class ListAssignmentDetail : System.Web.UI.Page
    {
        ...
        public void FillForm()
        {
            ...
            if (lstDatas.Rows.Count > 0)
            {
                ...
                name = lstDatas.Rows[0]["ash_ArabicName"].ToString();
        ...
        protected void Save()
        {
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                if (res > 0)
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Succcess('تم حفظ رأس الواجب بنجاح');</script>", false);
                }
                else
                {
            ...
            else
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Succcess('تم تحديث رأس الواجب بنجاح');</script>", false);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Failure();</script>", false);
        ...
        protected void SaveProducts()
        {
            ...
            if (res > 0)
            {
                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Succcesss('تم حفظ تفاصيل الواجب بنجاح');</script>", false);
            }
            else
            {
