<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditDepot.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditDepot" %>
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group">
                             ...
                             <div class="col-lg-4 form-group">
                                <label class="control-label col-lg-12">Region<span class="required"></span></label>
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlregion" runat="server" DefaultMessage="Select Region" Width="100%"></telerik:RadDropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="form"
                                        ControlToValidate="ddlregion" ErrorMessage="Please choose Region" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddldepotcompany" runat="server" DefaultMessage="Select Company" Width="100%"></telerik:RadDropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="form"
                                        ControlToValidate="ddldepotcompany" ErrorMessage="Please choose Company" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
