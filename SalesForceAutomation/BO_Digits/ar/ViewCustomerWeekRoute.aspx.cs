...
{
    public partial class ViewCustomerWeekRoute : System.Web.UI.Page
    {
        ...
        public void ListRoute()
        {
            ...
            {
                string name = lstUser.Rows[0]["rot_ArabicName"].ToString();
                ltrlRoute.Text = "اسم الطريق : " + name.ToString() + " /";
            }
        }
        ...
        public void ListWeek()
        {
            ...
            if (lstUser.Rows.Count > 0)
            {
                ...
                ltrlweek.Text = "تسلسل الأسبوع: " + weekseq.ToString();
            }
        }
