...
{
    public partial class ListDiscountCredits : System.Web.UI.Page
    {
        ...
        public void LoadList()
        {
            ...
            lstUser = ObjclsFrms.loadList("SelectDiscountCredits", "sp_CreditNote");
        ...
        {
            Response.Redirect("AddDiscountCredits.aspx");
        }
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Discount Credits", "Xlsx"));
