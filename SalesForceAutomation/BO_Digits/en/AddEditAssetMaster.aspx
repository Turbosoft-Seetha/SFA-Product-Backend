<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditAssetMaster.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditAssetMaster" %>
...
<%--                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadComboBox ID="ddlType" runat="server" Width="100%" Filter="Contains" EmptyMessage="Select Assets Type" AutoPostBack="true" OnSelectedIndexChanged="ddlType_SelectedIndexChanged"></telerik:RadComboBox>
                                    <asp:Label ID="lblTypeRequired" runat="server" Text="* Please select Assets Type" ForeColor="Red" Visible="false"></asp:Label>
                                </div>
                            </div>
                              <asp:PlaceHolder runat="server" ID="assets">
                                  
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                <label class="control-label col-lg-12">Assets <span class="required"></span></label>
                                <div class="col-lg-12">
                                    <telerik:RadComboBox ID="ddlassets" runat="server" Width="100%"></telerik:RadComboBox>
                                    <asp:Label ID="lblassets" runat="server" Text="* Please enter Name" ForeColor="Red" Visible="false"></asp:Label>
                                </div>
                            </div>
...
<%--                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                <label class="control-label col-lg-12">Reference Name <span class="required"> </span></label>
                                <div class="col-lg-12">
