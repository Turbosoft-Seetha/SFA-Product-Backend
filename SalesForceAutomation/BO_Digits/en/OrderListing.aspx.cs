    ...
    public partial class OrderListing : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (!rotID.Equals("0"))
            {
                ...
                lstDatas = ObjclsFrms.loadList("ListOrderforConfiguration", "sp_Merchandising_UOM", mainCondition);
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Detail"))
            {
                ...
                Response.Redirect("OrderDetailListing.aspx?Id=" + ID);
            }
            if (e.CommandName.Equals("Confirm"))
            {
                GridDataItem dataItem = e.Item as GridDataItem;
                string OID = dataItem.GetDataKeyValue("ord_ID").ToString();
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            int confirmCount = Int32.Parse(grvRpt.SelectedItems.Count.ToString());
            if (confirmCount == 0)
            {
            ...
            using (var sw = new StringWriter())
            {
                using (var writer = XmlWriter.Create(sw))
                {
                    ...
                    if (ColelctionMarkets.Count > 0)
                    {
                        ...
                        {
                            //where 1 = 1
                            string ord_ID = dr.GetDataKeyValue("ord_ID").ToString();
        ...
        public void Save()
        {
            try
            {
                ...
                string[] arr = { ord, user };
                string resp = ObjclsFrms.SaveData("sp_Transaction", "AssignRouteAndConfirmOrder", Rot.ToString(), arr);
        ...
        {
            string User = UICommon.GetCurrentUserID().ToString();
            string url = ConfigurationManager.AppSettings.Get("OrderBulkAssign");
