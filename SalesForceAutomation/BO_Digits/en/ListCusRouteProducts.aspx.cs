...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class ListCusRouteProducts : System.Web.UI.Page
    {
        ...
        public void SaveData()
        {
            ...
            string[] arr = { dates, date, ResponseID.ToString(),usr,ddlpaymode.SelectedValue.ToString() };
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            {                                                                           //If it matched the following code will be executed
                ...
                Response.Redirect("ListCusRouteProductsDetail.aspx?crpId=" + crpID + "&RID=" + RouteID.ToString() + "&CID=" + ResponseID.ToString());                         //With the ID we can redirect to the add page to edit and update the value.
            }
        ...
        protected void lnksplPrice_Click(object sender, EventArgs e)
        {
