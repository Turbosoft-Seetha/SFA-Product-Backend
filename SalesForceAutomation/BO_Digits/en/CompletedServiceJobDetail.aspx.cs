...
{
    public partial class CompletedServiceJobDetail : System.Web.UI.Page
    {
        ...
        {
            DataTable lstdata = ObjclsFrms.loadList("SelCompletedServiceReqDetail", "sp_ServiceRequest", ResponseID.ToString());
        ...
        {
            DataTable lstdata = ObjclsFrms.loadList("CompletedServiceJobDetails", "sp_ServiceRequest", ResponseID.ToString());
            if (lstdata.Rows.Count > 0)
            {
