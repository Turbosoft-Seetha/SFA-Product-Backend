<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="StockCountingHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.StockCountingHeader" %>
                                ...
                                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                    ...
                                    <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                        ...
                                        <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                            ShowFooter="false" DataKeyNames="stk_ID"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="stk_trn_Number" AllowFiltering="true" HeaderStyle-Width="100px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="SC Number" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                    HeaderStyle-Font-Bold="true" UniqueName="stk_trn_Number">
                                                </telerik:GridBoundColumn>
                                            
                                                <telerik:GridBoundColumn DataField="usr_Code" AllowFiltering="true" HeaderStyle-Width="90px"
                                                ...
                                                <telerik:GridBoundColumn DataField="ExpDate" AllowFiltering="true" HeaderStyle-Width="100px"
                                                ...
                                                <telerik:GridBoundColumn DataField="Currentlevel" AllowFiltering="true" HeaderStyle-Width="100px"
                                                    ...
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                    HeaderStyle-Font-Bold="true" UniqueName="Currentlevel" Visible="false">
                                                </telerik:GridBoundColumn>
                                                ...
                                                <telerik:GridBoundColumn DataField="stk_Remarks" AllowFiltering="true" HeaderStyle-Width="100px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="Remarks" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                    HeaderStyle-Font-Bold="true" UniqueName="stk_Remarks" Display="false">
                                                </telerik:GridBoundColumn>
