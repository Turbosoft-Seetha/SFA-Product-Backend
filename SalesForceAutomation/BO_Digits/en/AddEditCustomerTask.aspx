<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCustomerTask.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditCustomerTask" %>
...
<asp:Content ID="ContentAction" ContentPlaceHolderID="Actions" runat="server">
     <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
           <asp:LinkButton ID="LinkButton2" Width="100px" runat="server"
                                ...
                                <asp:LinkButton ID="lnkSave" runat="server"  Width="100px" Text='<i class="icon-ok"></i>Proceed' CssClass="btn btn-sm fw-bold btn-primary" OnClick="lnkSave_Click" CausesValidation="true" ValidationGroup="form"></asp:LinkButton>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="col-lg-12 row">
                             ...
                             <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                     <telerik:RadComboBox ID="ddlroute" runat="server" Filter="Contains" Width="100%" EmptyMessage="Select Route" OnSelectedIndexChanged="ddlroute_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
                             ...
                             <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                     <telerik:RadComboBox ID="ddlCus" runat="server" Filter="Contains" Width="100%" EmptyMessage="Select Customer" OnSelectedIndexChanged="ddlCus_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
                             ...
                             <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                     <telerik:RadComboBox ID="ddlBrd" runat="server" Filter="Contains" Width="100%" EmptyMessage="Select Brand"  OnSelectedIndexChanged="ddlBrd_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
     ...
     <div class="modal fade" id="kt_modal" tabindex="-1" role="dialog" style="height:auto" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
     <button type="button" class="btn btn-sm fw-bold btn-secondary" onclick="cancelModal(kt_modal);">OK</button>                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="kt_modal_1_6" tabindex="-1" role="dialog" style="height:auto" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
<button type="button" class="btn btn-sm fw-bold btn-secondary" onclick="cancelModal(kt_modal_1_6);">OK</button>                </div>
            </div>
        </div>
    </div>
    <!--end::ExistModal-->
