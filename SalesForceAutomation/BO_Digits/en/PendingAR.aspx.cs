...
{
    public partial class PendingAR : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("SelPendingAR", "sp_ITOperations", mainCondition);
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Pending AR", "Xlsx"));
