...
{
    public partial class WHTransferInApprovalDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("ListWHTransferInHeaderByID", "sp_Transaction", HID.ToString());
            if (lstDatas.Rows.Count > 0)
            {
                ...
                rp.Text = "Transfer In No: " + lstDatas.Rows[0]["wti_number"].ToString();
...

        {
            ...
            lstUser = ObjclsFrms.loadList("ListWHTransferInDetail", "sp_Transaction", HID.ToString());
