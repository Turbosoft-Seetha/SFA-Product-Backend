...
namespace SalesForceAutomation.Admin
{
    public partial class AddEditAgreementPayTerms : System.Web.UI.Page
    {
        ...
        {
            DataTable lstDatas = ObjclsFrms.loadList("selAgreementPayTermsById", "sp_Merchandising", ResponseID.ToString());
        ...
        protected void Save()
        {
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Merchandising", "insAgreementPayTerms", Code, arr);
            ...
            else
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Merchandising", "updateAgreementPayTerms", Code, arr);
                int res = Int32.Parse(Value.ToString());
                if (res > 0)
        ...
        {
            Response.Redirect("/Admin/ListAgreementPayTerms.aspx");
        }
