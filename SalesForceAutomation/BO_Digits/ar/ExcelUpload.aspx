<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="ExcelUpload.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.ExcelUpload" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card">
                                        ...
                                        <div class="kt-wizard-v3__form" style="margin-top: 0px !important">
                                            ...
                                            <div class="col-lg-12 mt-3 row" style="padding-top: 23px;">
                                                <div class="col-lg-6">
                                                <h5 style="color: #464646">1 حدد النوع</h5>
                                                <label style="color: #464646; font-size: smaller">الرجاء تحديد النوع للحصول على قالب التنزيل</label>
                                                <div class="col-lg-12 kt--align-center mt-2" style="padding-left: 0px !important;">
                                                  <telerik:RadComboBox ID="cmbType" runat="server" EmptyMessage="اختر صنف" Filter="Contains" 
                                                ...
                                                <asp:PlaceHolder ID="plcTemplate" runat="server" Visible="false">
                                                      <h5 style="color: #464646">تحميل النموذج</h5>
                                                <label style="color: #464646; font-size: smaller">يرجى تنزيل النموذج الخاص بـ  <asp:Label ID="lblTemplateName" runat="server"></asp:Label></label>
                                                <div class="col-lg-12 kt--align-center mt-2" style="padding-left: 0px !important;">
                                            ...
                                            <div class="col-lg-6 mt-5">
                                                <h5 style="color: #464646">2.a اختر  اكسل</h5>
                                                <label style="color: #464646; font-size: smaller">يرجى ملء النموذج الذي قمت بتنزيله وتحميله</label>
                                                <br />
                                            ...
                                            <div class="col-lg-6 mt-5">
                                                ...
                                                <h5 style="color: #464646">2.b اختر ملف مضغوط</h5>
                                                <label style="color: #464646; font-size: smaller">تحميل الصور كملف مضغوط</label>
                                                <br />
                                            ...
                                            <div class="col-lg-6 mt-5">
                                                <h5 style="color: #464646">3. التحقق من الصحة</h5>
                                                <label style="color: #464646; font-size: smaller">سوف نثمن البيانات ونبين لك ما إذا كانت هناك حاجة إلى أي تصحيحات</label>
                                                <br />
                                                <telerik:RadAjaxPanel ID="pl1" runat="server" LoadingPanelID="radloadingvaldate">
                                                    ...
                                                    <asp:LinkButton ID="lnkValidate" runat="server"
                                                        ...
                                                        Text='<span><span>عرض البيانات</span></span>'>            
                                                    </asp:LinkButton>
                                                    ...
                                                    <asp:PlaceHolder ID="plcSUccess" runat="server" Visible="false">
                                                        ...
                                                        <asp:Label ID="uploaded" runat="server" Text="انقر فوق الخطوة التالية"></asp:Label>
                                                    </asp:PlaceHolder>
                                                    <asp:PlaceHolder ID="plcFailed" runat="server" Visible="false">
                                                        <img alt="Loading..." style="height: 10px" src="../assets/media/icons//fail.svg" />
                                                        <asp:Label ID="Label1" runat="server" Text="فشل"></asp:Label>
                                                    </asp:PlaceHolder>
                                                </telerik:RadAjaxPanel>
                                        ...
                                        <div class="kt-wizard-v3__form">
                                            ...
                                            <telerik:RadAjaxPanel ID="pnlGrid" runat="server">
                                                <div class="col-lg-12 mt-3" style="padding-top: 23px;">
                                                    <h5 style="color: #464646">1. البيانات التي تم تحميلها</h5>
                                                ...
                                                <div class="col-lg-12 mt-3" hidden="hidden" style="padding-top: 23px;">
                                                    <h5 style="color: #464646">2. الصور ذات الصلة</h5>
                                                ...
                                                <div class="col-lg-12 mt-3" style="padding-top: 23px;">
                                                    <h5 style="color: #464646">3. لم يتم التحقق من البيانات</h5>
                                                ...
                                                <div class="col-lg-12 mt-3" hidden="hidden" style="padding-top: 23px;">
                                                    <h5 style="color: #464646">4. الصور ذات الصلة</h5>
                                        ...
                                        <telerik:RadAjaxPanel ID="pnlSubmit" runat="server">
                                            <div class="kt-wizard-v3__form">
                                                ...
                                                <div class="col-lg-6 mt-3" style="padding-top: 23px;">
                                                    <h5 style="color: #464646">1. إرسال</h5>
                                                    <asp:Label Style="color: #464646; font-size: smaller" ID="Label5" runat="server" Text="الرجاء الضغط متابعة لتقديم البيانات الخاصة بك"></asp:Label>
                                                    <div class="col-lg-12 kt--align-center mt-2">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:LinkButton ID="lnkSave" runat="server" data-kt-stepper-action="submit"
                                                                    ...
                                                                    Text='<span><span>يتابع</span> &nbsp;<i class="fa fa-save"></i></span>'>            
                                                                </asp:LinkButton>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>تم تحميل البيانات بنجاح.</span>
                </div>
                <div class="modal-footer">
                    <asp:LinkButton ID="lnkOk" runat="server" CssClass="btn btn-sm fw-bold btn-secondary">نعم</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="kt_modal_1_4a" tabindex="-1" role="dialog" style="height:auto" data-backdrop="static" data-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>تم حفظ المطالبات غير المتطابقة كمسودات ، يرجى متابعة المطالبات المطابقة.</span>
                </div>
                <div class="modal-footer">
                    <asp:LinkButton ID="LinkButton2" runat="server" data-dismiss="modal" CssClass="btn btn-sm fw-bold btn-secondary">نعم</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="kt_modal_1_5" tabindex="-1" role="dialog" style="height:auto" data-backdrop="static" data-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm fw-bold btn-secondary" data-dismiss="modal">نعم</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="kt_modal_1_9" tabindex="-1" role="dialog" style="height:auto" data-backdrop="static" data-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">هل أنت متأكد أنك تريد تحميل البيانات؟</h5>
                </div>
              <telerik:RadAjaxPanel ID="d" runat="server">
                ...
                <asp:Timer ID="tmrFinal" runat="server" Interval="1000"  Enabled="false" OnTick="tmrFinal_Tick"></asp:Timer>
                  ...
                  <telerik:RadAjaxPanel ID="pnlSave" LoadingPanelID="RadAjaxLoadingPanel1" runat="server">
                    <div class="modal-body">
                        ...
                        <asp:LinkButton ID="btnSav" runat="server" OnClick="btnSav_Click"  CssClass="btn btn-sm fw-bold btn-secondary">نعم</asp:LinkButton>
                        <button type="button" class="btn btn-sm fw-bold btn-secondary" onclick="cancelModal(kt_modal_1_9)" >يلغي</button>
                          ...
                          <asp:PlaceHolder ID="plcSuc" runat="server" Visible="false"> 
                                       <span style="color:green; font-size:smaller" >اكتمل تحميل الملف ، ستتم إعادة توجيهك إلى لوحة التحكم بتنسيق
                                           <asp:Label ID="lblTimerSuc" runat="server" Text="5"></asp:Label> ثواني</span>
                                       </asp:PlaceHolder>
                       <asp:PlaceHolder ID="plcFail" runat="server" Visible="false"> 
                                       <span style="color:red; font-size:smaller" >قد تكون البيانات التي تحاول تحميلها موجودة بالفعل أو قد يكون التنسيق غير صحيح<br/>يرجى التحقق من البيانات</span>
                                       </asp:PlaceHolder>
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-lg-12">
                              <asp:LinkButton ID="lnkExit" runat="server"  OnClick="lnkExit_Click" Visible="false" CssClass="btn btn-sm fw-bold btn-danger">مخرج</asp:LinkButton>
    ...
    <div class="modal fade" id="kt_modal_1_10" tabindex="-1" role="dialog" style="height:auto" data-backdrop="static" data-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">سيتم حفظ جميع المطالبات غير المتطابقة كمسودة وسيتم إخطارك عند تحميل البيانات الفنية الجديدة</h5>
                </div>
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" LoadingPanelID="RadAjaxLoadingPanel3" runat="server">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:LinkButton ID="lnkDrafts" runat="server"  CssClass="btn btn-sm fw-bold btn-secondary">نعم</asp:LinkButton>
                        <button type="button" class="btn btn-sm fw-bold btn-secondary" data-dismiss="modal">يلغي</button>
