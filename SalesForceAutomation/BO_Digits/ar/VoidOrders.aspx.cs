...
{
    public partial class VoidOrders : System.Web.UI.Page
    {
        ...
        public string mainConditions(string rotID)
        {
            ...
            try
            {
                ...
                dateCondition = " and (cast(O.CreatedDate as date) between cast('" + fromDate + "' as date) and cast('" + endDate + "' as date)) and O.Void='Y'";
                if (cusID.Equals("0"))
                {
                    customerCondition = "";
                }
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Detail"))
            {
                ...
                Response.Redirect("VoidOrderDetail.aspx?Id=" + ID);
            }
        }
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Void Orders ", "Xlsx"));
