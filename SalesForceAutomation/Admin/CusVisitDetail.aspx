<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="CusVisitDetail.aspx.cs" Inherits="SalesForceAutomation.Admin.CusVisitDetail" %>
                                            ...
                                            <div class="kt-portlet__body" style="background-color: #F9FAFC; display: grid;">
                                                <table>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="col-lg-12 mb-2">
                                                            <label class="col-lg-2 col-form-label" style="display: contents;">VersionNumber:</label>
                                                            <label class="col-lg-4 col-form-label" style="display: contents;">
