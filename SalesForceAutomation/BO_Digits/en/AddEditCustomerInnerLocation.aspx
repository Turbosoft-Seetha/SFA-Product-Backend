<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCustomerInnerLocation.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditCustomerInnerLocation" %>
...
<asp:Content ID="ContentAction" ContentPlaceHolderID="Actions" runat="server">
     <telerik:RadAjaxPanel ID="rdd" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                <asp:LinkButton ID="LinkCancel" runat="server"
                                 ...
                                 <asp:LinkButton ID="LinkSave" runat="server" ValidationGroup="form" 
                                     OnClick="LinkSave_Click" UseSubmitBehavior="false" Text='<i class="icon-ok"></i>Proceed'
