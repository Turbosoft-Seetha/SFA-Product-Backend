<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListCouponProduct.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListCouponProduct" %>
                ...
                <div class="kt-portlet" style="background-color:white; padding:20px;">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 8px; ">
                        <div class="kt-portlet__head-label" style="border-bottom-style:inset;">
                            ...
                            <telerik:RadLabel ID="ProCop" runat="server" CssClass="kt-portlet__head-title"></telerik:RadLabel>
                             </h3>
