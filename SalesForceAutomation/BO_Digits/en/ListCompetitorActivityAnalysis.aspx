<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListCompetitorActivityAnalysis.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListCompetitorActivityAnalysis" %>
                            ...
                            <div class=" col-lg-12 row" style="padding-bottom: 10px">
                                ...
                                <div class="col-lg-2" >
                                   ...
                                   <div class="col-lg-2">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox Skin="Material" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" RenderMode="Lightweight" Width="100%"
                                            ID="ddlCompetitor" runat="server" EmptyMessage="Select Competitor">
                                        </telerik:RadComboBox>
