<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListAssign.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListAssign" %>
                                ...
                                <div class="col-lg-12 row"  style="padding-top: 20px; padding-bottom: 20px;">
                                    ...
                                    <div class="col-lg-2">
                                        <telerik:RadAjaxPanel ID="RadAjaxPanel7" runat="server" LoadingPanelID="RadAjaxLoadingPanel8">
                                            <asp:LinkButton ID="lnkRemove" runat="server" CssClass="btn btn-sm fw-bold btn-danger" Text="Remove" OnClientClick="Delete()"></asp:LinkButton>
                                        </telerik:RadAjaxPanel>
