...
namespace SalesForceAutomation.BO_Digits.ar
{
    public partial class ListCustomerAssetTracking : System.Web.UI.Page
    {
        ...
        public void Route()
        {
            ...
            rdRoute.DataTextField = "rot_ArabicName";
        ...
        public void Customers(string routeCondition)
        {
            ...
            rdCustomer.DataTextField = "cus_NameArabic";
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Customer Cooler Tracking", "Xlsx"));
