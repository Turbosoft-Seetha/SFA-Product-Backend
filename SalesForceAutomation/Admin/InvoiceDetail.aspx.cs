...
namespace SalesForceAutomation.Admin
{
    public partial class InvoiceDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("SelInvoiceByID", "sp_Merchandising", ResponseID.ToString());
            ViewState["HeaderData"] = lstDatas;
            if (lstDatas.Rows.Count > 0)
            {
                RadPanelItem rp = RadPanelBar0.Items[0];
               // Label lblinvoice = (Label)rp.FindControl("lblinvoice");
                Label lblCustomer = (Label)rp.FindControl("lblCustomer");
                Label lblCreatedDate = (Label)rp.FindControl("lblCreatedDate");
               // Label lblOrderType = (Label)rp.FindControl("lblOrderType");
                ...
                Label lblDisc = (Label)rp.FindControl("lblDisc");
                Label lblVat = (Label)rp.FindControl("lblVat");
                Label lblInitial = (Label)rp.FindControl("lblInitial");
                //Label lbltotalPaid = (Label)rp.FindControl("lbltotalPaid");


                rp.Text = "Invoice ID: " + lstDatas.Rows[0]["inv_InvoiceID"].ToString();
               // lblOrder.Text = lstDatas.Rows[0]["OrderID"].ToString();
                lblCustomer.Text = lstDatas.Rows[0]["cus_Name"].ToString();
                lblCreatedDate.Text = lstDatas.Rows[0]["InvoicedOn"].ToString();
              //  lblOrderType.Text = lstDatas.Rows[0]["oty_Name"].ToString();
                lblStatus.Text = lstDatas.Rows[0]["Status"].ToString();
                lblGrand.Text = lstDatas.Rows[0]["inv_GrandTotal"].ToString();
                lblSub.Text = lstDatas.Rows[0]["inv_SubTotal"].ToString();
                lblDisc.Text = lstDatas.Rows[0]["inv_Discount"].ToString();
                lblVat.Text = lstDatas.Rows[0]["inv_VAT"].ToString();
                lblInitial.Text = lstDatas.Rows[0]["inv_InitialPaidAmount"].ToString();
                //lbltotalPaid.Text = lstDatas.Rows[0]["inv_TotalPaidAmount"].ToString();
        ...
        {
            DataTable lstDatas = new DataTable();
            lstDatas = ObjclsFrms.loadList("SelInvDetails", "sp_Merchandising", ResponseID.ToString());
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "AR")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Invoie Detail", "Xlsx"));
