...
{
    public partial class ListGoodDetails : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("ListGoodDetailsHeader", "sp_Masters", HID.ToString());
            if (lstDatas.Rows.Count > 0)
            {
                ...
                rp.Text = "Picking No: " + lstDatas.Rows[0]["lgb_Code"].ToString();
        ...
        public void LoadData()
        {
            ...
            DataTable lstDatas = new DataTable();
            lstDatas = ObjclsFrms.loadList("LoadGood", "sp_Masters", ResID.ToString());
