<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="GRNHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.GRNHeader" %>
                                ...
                                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                    ...
                                    <div class=" col-lg-12 row" style="padding-bottom: 10px">
                                        ...
                                        <div class="col-lg-2 ">
                                            ...
                                            <div class="col-lg-12">
                                                <telerik:RadDatePicker RenderMode="Lightweight" ID="rdfromDate" DateInput-DateFormat="dd-MMM-yyyy" runat="server" AutoPostBack="true" OnSelectedDateChanged="rdfromDate_SelectedDateChanged">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-12">
                                                <telerik:RadDatePicker RenderMode="Lightweight" ID="rdendDate" DateInput-DateFormat="dd-MMM-yyyy" runat="server" AutoPostBack="true" OnSelectedDateChanged="rdendDate_SelectedDateChanged">
                                                </telerik:RadDatePicker>
                                   ...
                                   <div class="col-lg-12">
                                       <telerik:RadComboBox ID="rdStatus" runat="server" EmptyMessage="Select Status" Filter="Contains" Width="100%" RenderMode="Lightweight" AutoPostBack="true">
                                           <Items>
                                               ...
                                               <telerik:RadComboBoxItem Text="Receiving Pending" Value="N"/>
                                                   <telerik:RadComboBoxItem Text="Receiving Parked" Value="P" />                                             
                                                 <telerik:RadComboBoxItem Text="Receiving Ongoing" Value="O" />
                                                <telerik:RadComboBoxItem Text="Checking Pending" Value="N2"/>                                               
                                                <telerik:RadComboBoxItem Text="Checking Parked" Value="P2" />
                                                <telerik:RadComboBoxItem Text="Checking Ongoing" Value="O2" />
                                                 <telerik:RadComboBoxItem Text="Completed" Value="C" />
                                           </Items>
                                       </telerik:RadComboBox>
                                   </div>
                               </div>
                                    ...
                                    <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                        ...
                                        <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                            ShowFooter="false" DataKeyNames="grh_ID"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="grh_trn_number" AllowFiltering="true" HeaderStyle-Width="100px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="GRN Number" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                    HeaderStyle-Font-Bold="true" UniqueName="grh_trn_number">
