<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="ListCustomerRetailPriceDetail.aspx.cs" Inherits="SalesForceAutomation.Admin.ListCustomerRetailPriceDetail" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Customer Retail Price Detail
                            </h3>
                        ...
                        <div class="kt-subheader__breadcrumbs" style="padding-left:30px;">
                            ...
                            <span class="kt-subheader__breadcrumbs-separator">></span>--%>
                            <a class="kt-subheader__breadcrumbs-link"> Customer Retail Price Detail </a>
                                                ...
                                                <table>
                                                    ...
                                                    <td>
                                                     <div class="col-lg-12 mb-2">
                                                            ...
                                                            <label class="col-lg-4 col-form-label" style="display: contents;">
                                                                <asp:Label ID="lblVstart" Font-Bold="true" runat="server"></asp:Label></label>
                                                        </div>

                                                         <div class="col-lg-12 mb-2">
                                                            <label class="col-lg-2 col-form-label" style="display: contents;">Visit End:</label>
                                                            <label class="col-lg-4 col-form-label" style="display: contents;">
                                                                <asp:Label ID="lblVend" Font-Bold="true" runat="server"></asp:Label></label>
                                                        </div>
