...
{
    public partial class RouteWiseSpclPriceDetails : System.Web.UI.Page
    {
        ...
        public void Route()
        {
            DataTable dt = ObjclsFrms.loadList("SelRouteWithSpclPrice", "sp_Masters");
        ...
        public void LoadData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("ListRouteWiseSpclPrice", "sp_Masters", mainCondition);
        ...
        public string mainConditions()
        {
            ...
            try
            {
                ...
                {
                    RouteCondition = " and rcs_rot_ID in (" + Route + ")";
                }
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Special Price")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Special Price", "Xlsx"));
