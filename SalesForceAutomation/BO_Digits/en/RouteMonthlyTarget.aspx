<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="RouteMonthlyTarget.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.RouteMonthlyTarget" %>
                            ...
                            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                ...
                                <div class=" col-lg-12 row" style="display: -webkit-box; padding-bottom: 10px">
                                    ...
                                    <div class="col-lg-2 ">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:RadDatePicker RenderMode="Lightweight" ID="rdfromDate" Width="100%" DateInput-DateFormat="dd-MMM-yyyy" runat="server" AutoPostBack="true" OnSelectedDateChanged="rdfromDate_SelectedDateChanged">
                                    ...
                                    <div class="col-lg-2 ">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:RadDatePicker RenderMode="Lightweight" ID="rdendDate" Width="100%" DateInput-DateFormat="dd-MMM-yyyy" runat="server" AutoPostBack="true" OnSelectedDateChanged="rdendDate_SelectedDateChanged">
                                            </telerik:RadDatePicker>
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="tph_Name" AllowFiltering="true" HeaderStyle-Width="150px"
                                             ...
                                             <telerik:GridBoundColumn DataField="rtp_Quantity" AllowFiltering="true" HeaderStyle-Width="130px"
                                                ...
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="rtp_Quantity"><ItemStyle HorizontalAlign="Right" /><HeaderStyle HorizontalAlign="Right" />
                                             ...
                                             <telerik:GridBoundColumn DataField="trp_Amount" AllowFiltering="true" HeaderStyle-Width="130px"
                                                ...
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="trp_Amount"><ItemStyle HorizontalAlign="Right" /><HeaderStyle HorizontalAlign="Right" />
