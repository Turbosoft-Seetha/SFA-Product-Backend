...
{
    public partial class ListInvMonitoringTransactions : System.Web.UI.Page
    {
        ...
        public void MerchCount()
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    lblTotalItemPricing.Text = dt.Rows[0]["ItemPricingCount"].ToString();
                    lblTotalItemAvailability.Text = dt.Rows[0]["ItemAvailCount"].ToString();
                    lblTotalGComplaints.Text = dt.Rows[0]["GComplaintCount"].ToString();
                    lblTotalPComplaints.Text = dt.Rows[0]["PComplaintCount"].ToString();
        ...
        protected void lblTotalItemAvailability_Click(object sender, EventArgs e)
        {
