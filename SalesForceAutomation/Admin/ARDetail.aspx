<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="ARDetail.aspx.cs" Inherits="SalesForceAutomation.ARDetail" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Receipt Detail
                            </h3>
                             <div class="kt-subheader__breadcrumbs" style="padding-left:30px;">


                            <a href="ARHeader.aspx" class="kt-subheader__breadcrumbs">
                                <i class="flaticon2-shelter"></i> AR Header </a>
                             <span class="kt-subheader__breadcrumbs-separator">></span>
                         <a class="kt-subheader__breadcrumbs-link">Receipt Detail</a>
                        </div>
                        </div>
                                               ...
                                               <table>
                                                    ...
                                                    <td>
                                                       ...
                                                       <div class="col-lg-12 mb-2">
                                                        ...
                                                        <div class="col-lg-6 mb-2">
                                                            <label class="col-lg-2 col-form-label" style="display: contents;">Balance amnt:</label>
                                                            <label class="col-lg-4 col-form-label" style="display: contents;">
                                ...
                                <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="inv_InitialPaidAmount" AllowFiltering="true" HeaderStyle-Width="60px"
                                            ...
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="inv_InitialPaidAmount" >
                                        </telerik:GridBoundColumn>
                                       ...
                                       <%-- <telerik:GridBoundColumn DataField="inv_TotalPaidAmount" AllowFiltering="true" HeaderStyle-Width="60px"
                                            ...
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="inv_TotalPaidAmount">
                                        </telerik:GridBoundColumn>--%>
