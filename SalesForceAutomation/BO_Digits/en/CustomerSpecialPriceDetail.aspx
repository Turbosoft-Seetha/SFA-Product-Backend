<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="CustomerSpecialPriceDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.CustomerSpecialPriceDetail" %>
                                                        ...
                                                        <table>
                                                            <td style="width: 56%">
                                                                ...
                                                                <div class="col-lg-12 mb-2">
                                                                    ...
                                                                    <label class="col-lg-4 col-form-label" style="display: contents;">
                                                                        <asp:Label ID="lblPayMode" Font-Bold="true" runat="server"></asp:Label>
                                                                    </label>
                                                                </div>
