...
{
    public partial class ListCustomerAssetTrackingDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            if (lstDatas.Rows.Count > 0)
            {
                ...
                Label lblAssetType = (Label)rp.FindControl("lblAssetType");
                Label lblSerialNo = (Label)rp.FindControl("lblSerialNo");
                ...
                lblAssetType.Text = lstDatas.Rows[0]["ast_Name"].ToString();
                lblSerialNo.Text = lstDatas.Rows[0]["asc_Code"].ToString();
            }
        }
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "CustomerAssetTracking Detail", "Xlsx"));
