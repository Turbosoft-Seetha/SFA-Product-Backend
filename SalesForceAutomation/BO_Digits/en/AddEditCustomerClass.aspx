<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCustomerClass.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditCustomerClass" %>
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ValidationGroup="form"
                                        ControlToValidate="txtname" ErrorMessage="Please Enter Customer Class" ForeColor="Red" Display="Dynamic"
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="form"
                                        ControlToValidate="txtarabic" ErrorMessage="Please Enter Arabic Name" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
                              <div class="col-lg-4 form-group">
                                  ...
                                  <div class="col-lg-12">
                                      <telerik:RadComboBox ID="ddlcategory" runat="server" EmptyMessage="Select Category" CausesValidation="false" Width="100%" Filter="Contains"></telerik:RadComboBox>
                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                          ControlToValidate="ddlcategory" ErrorMessage="Please Select Category Name" ForeColor="Red" Display="Dynamic"
                                          SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                  </div>
                              </div>
                            <div class="col-lg-4 form-group" >
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlclscompany" runat="server" Width="100%" DefaultMessage="Select Company"></telerik:RadDropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="form"
                                        ControlToValidate="ddlclscompany" ErrorMessage="Please Choose Company" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
                            <div class="col-lg-4 form-group">
