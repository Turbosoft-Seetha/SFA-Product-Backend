<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="DeliveryRouteDashboard.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.DeliveryRouteDashboard" %>
                ...
                <div class="kt-portlet__head-label row" style="padding-bottom: 10px">
                    ...
                    <div class="col-lg-12 row" style="padding-top: 10px;">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-12">
                                <telerik:RadDatePicker RenderMode="Lightweight" ID="rdfromDate" runat="server" DateInput-DateFormat="dd-MM-yyyy" AutoPostBack="true" OnSelectedDateChanged="rdfromDate_SelectedDateChanged">
                        ...
                        <asp:LinkButton ID="Productivevisits" runat="server" OnClick="Productivevisits_Click" CausesValidation="true">
                            <div class="card bgi-no-repeat card-xl-stretch mb-xl-8" style="background-color: #6397b2; background-image: url(../assets/media/dashboard/bg.png), linear-gradient(#03CDFD, #3483D9); background-size: 100%;">
                                ...
                                <div class="col-xl-12 row py-10">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="btn btn-warning" style="width: 100%; font-family: 'Segoe UI';">Planned</div>
                                    </div>
                                    <div class="col-xl-3" style="text-align: center;">
                                        <h6 style="color: white; font-weight: 600;">
                                ...
                                <div class="col-xl-12 row py-10 ">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="btn btn-primary" style="width: 100%; font-family: 'Segoe UI';">Unplanned</div>
                                    </div>
                                    <div class="col-xl-3" style="text-align: center;">
                                        <h6 style="color: white; font-weight: 600;">
               ...
               <asp:PlaceHolder runat="server" ID="pnlDel">
                ...
                <div class="col-xl-6 row">
                              <asp:PlaceHolder ID="pnlInvoices" runat="server">
                                ...
                                <div class="col-xl-12">
                                    <!--begin::List Widget 6-->
                                    <div class="card card-xl-stretch mb-5 mb-xl-8 mt-8 py-1">
                                        <!--begin::Header-->
