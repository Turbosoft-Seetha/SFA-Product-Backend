    ...
    public partial class AddEditProductMappingGroup : System.Web.UI.Page
    {
        ...
        public void SaveData()
        {
            ...
            if (ResponseID.Equals("0") || ResponseID == 0)
            {
                ...
                if (res > 0)
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Succcess(' تم حفظه بنجاح');</script>", false);
                }
                else
                {
            ...
            else
            {
                ...
                if (res > 0)
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Succcess('تم التحديث بنجاح');</script>", false);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Failure();</script>", false);
