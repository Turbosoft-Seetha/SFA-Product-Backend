...
namespace SalesForceAutomation.Admin
{
    public partial class AddEditProducts : System.Web.UI.Page
    {
        ...
        {
            string pname, arabicName, pcode, pcat, psubcat, pbrd, rtndays,itemlong,Status,user,uom,stdprice,UPC,Default, arabicItemlong;
            ...
            { if (psubcat.Equals("0"))
                ...
                {
                   string[] arr = { pcode, pcat, psubcat, pbrd, rtndays, user,itemlong, Status, arabicName, arabicItemlong };
            ...
            else
            {
                ...
                {
                    string ID = ResponseID.ToString();
                    string[] arr = { pcode, pcat, psubcat, pbrd, rtndays, user, itemlong, Status, arabicName, arabicItemlong , ID };
       ...
       public void SaveDat()
        ...
        {
            string stdprice, UPC, Default, ID,uom;
            uom = ddlUom.SelectedValue.ToString();
            stdprice = txtStdPrice.Text.ToString();
            UPC = txtupc.Text.ToString();
            Default = ddlDefault.SelectedValue.ToString();
