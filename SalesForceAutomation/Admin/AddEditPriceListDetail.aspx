<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="AddEditPriceListDetail.aspx.cs" Inherits="SalesForceAutomation.Admin.AddEditPriceListDetail" %>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="col-lg-12 row">
                             ...
                             <div class="col-lg-4 form-group" >
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadComboBox ID="ddlp" runat="server" EmptyMessage="Select Product Name" OnSelectedIndexChanged="ddlp_SelectedIndexChanged" AutoPostBack="true" CausesValidation="false" Width="100%" Filter="Contains"></telerik:RadComboBox><br />
                              ...
                              <div class="col-lg-4 form-group" >
                                ...
                                <div class="col-lg-12">
                                     <telerik:RadComboBox ID="ddlUom" runat="server" Width="100%" EmptyMessage="Select Uom"  OnSelectedIndexChanged="ddlUom_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
                              ...
                              <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadNumericTextBox ID="txtstdprice" runat="server" CssClass="form-control" Width="100%" Enabled="false"></telerik:RadNumericTextBox>
                                    </div>
                            </div>
                              ...
                              <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadNumericTextBox ID="txtprice" runat="server" CssClass="form-control" Width="100%"></telerik:RadNumericTextBox>
