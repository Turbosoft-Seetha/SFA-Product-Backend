...
{
    public partial class ListLoadOutBRDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("LoadOutBadRtnHistoryByID", "sp_Transaction", ResponseID.ToString());
        ...
        public void LoadData()
        {
            ...
            DataTable lstDatas = new DataTable();
            lstDatas = ObjclsFrms.loadList("LoadOutBadRtnDetail", "sp_Transaction", ResponseID.ToString());
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Batch"))
            {
                ...
                Response.Redirect("ListBadDetails.aspx?ID=" + ID + "&&HID=" + ResponseID.ToString());
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "LoadOut BR Detail ", "Xlsx"));
