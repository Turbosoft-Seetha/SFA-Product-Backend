    ...
    public partial class NewPasswordGeneration: System.Web.UI.Page
    {
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string key = GeneratePassword(Convert.ToInt64(rdRoute.SelectedValue.ToString()), Convert.ToInt64(rdCus.SelectedValue.ToString()),
                               Convert.ToInt64(rdFeature.SelectedValue.ToString()), 1, 10, txtKey.Text.ToString(), rdTimeZone.SelectedItem.Text.ToString());
                txtPass.Text = key;
                Save();
            }
            catch (Exception ex)
        ...
        public void Save()
        {
            ...
            if (res > 0)
            {
                ...
                ltrlSuccess.Append("<div class=\"col-lg-12\">");
                ltrlSuccess.Append("<span style=\"color:green;\">تم حفظ طلب التجاوز بنجاح.</span>");
                ltrlSuccess.Append("</div>");
            ...
            else
            {
                ...
                ltrlSuccess.Append("<div class=\"col-lg-12\">");
                ltrlSuccess.Append("<span>حدث خطأ ما. أعد المحاولة من فضلك.</span>");
                ltrlSuccess.Append("</div>");
