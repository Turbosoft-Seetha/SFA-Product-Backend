<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="Roles.aspx.cs" Inherits="SalesForceAutomation.Admin.RolesList" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Roles
                            </h3>
                        </div>
                        <asp:PlaceHolder ID="pnlButton" runat="server">
                            <div class="kt-portlet__head-actions">
                                <asp:LinkButton ID="lnkAddRole" runat="server" CssClass="btn btn-brand btn-elevate btn-icon-sm" OnClick="lnkAddRole_Click">
                                                    Add
                                </asp:LinkButton>
                            </div>
                        </asp:PlaceHolder>
