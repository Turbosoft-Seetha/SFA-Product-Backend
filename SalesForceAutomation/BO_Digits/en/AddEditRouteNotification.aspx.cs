    ...
    public partial class AddEditRouteNotification : System.Web.UI.Page
    {
        ...
        protected void Save()
        {
			...
			if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                if (res > 0)
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "tmp", "<script type='text/javascript'>Succcess('Route Notification Saved Successfully');</script>", false);
                }
                else
                {
        ...
        {
            Response.Redirect("/BO_Digits/en/RouteNotification.aspx");
