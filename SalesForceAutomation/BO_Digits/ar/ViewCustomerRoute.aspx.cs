...
{
    public partial class ViewCustomerRoute : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                cusroute.Text = "طريق :" + lstRoute.Rows[0]["rot_ArabicName"].ToString();
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            {                                                                           //If it matched the following code will be executed
                ...
                Response.Redirect("ViewAddEditCusRoute.aspx?CID=" + CID + "&RID=" + RID);                         //With the ID we can redirect to the add page to edit and update the value.
            }
