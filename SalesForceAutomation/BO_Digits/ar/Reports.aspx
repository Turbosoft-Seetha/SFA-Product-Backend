<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.Reports" %>
                ...
                <div class="kt-portlet__head-label row" style="padding-bottom: 20px;">
                    ...
                    <div class="col-lg-12 row" style="padding-bottom: 10px">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-12">
                                <telerik:RadComboBox RenderMode="Lightweight" ID="ddlRoute" runat="server" EmptyMessage="حدد الطريق" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true">
                                </telerik:RadComboBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" ErrorMessage="الرجاء تحديد أي طريق" ForeColor="Red" ControlToValidate="rdfromDate"></asp:RequiredFieldValidator>
                            </div>
                        </div>
            ...
            <div class="col-xl-4">
                ...
                <asp:LinkButton ID="lnkSchVisNoTrans" runat="server" CssClass="card hoverable card-xl-stretch mb-xl-8" OnClick="lnkSchVisNoTrans_Click" BackColor="#e75a7d">
                    ...
                    <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
                        ...
                        <div class="text-white fw-bold fs-2 mb-2">المقرر - تمت زيارته - لا ترانس</div>
            ...
            <div class="col-xl-4">
                ...
                <asp:LinkButton ID="lnkUnSchVisNoTrans" runat="server" CssClass="card hoverable card-xl-stretch mb-xl-8" OnClick="lnkUnSchVisNoTrans_Click" BackColor="#419fd5">
                    ...
                    <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
                        ...
                        <div class="text-white fw-bold fs-2 mb-2">غير مجدول - تمت زيارته - لا ترانس</div>
                        <div class="fw-semibold text-white">انقر هنا لتنزيل التقرير</div>
                    </div>
                    <!--end::Body-->
                </asp:LinkButton>
            ...
            <div class="col-xl-4">
                ...
                <asp:LinkButton ID="lnkSchNotVis" runat="server" CssClass="card hoverable card-xl-stretch mb-5 mb-xl-8" OnClick="lnkSchNotVis_Click" BackColor="#7fc9a1">
                    ...
                    <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
                        ...
                        <div class="text-white fw-bold fs-2 mb-2">المقرر - لم تتم زيارتها</div>
                        <div class="fw-semibold text-white">انقر هنا لتنزيل التقرير</div>
                    </div>
                    <!--end::Body-->
                </asp:LinkButton>
            ...
            <div class="col-xl-3">
                ...
                <asp:LinkButton ID="lnkNoSaleCustom" runat="server" CssClass="card bg-body hoverable card-xl-stretch mb-xl-8" OnClick="lnkNoSaleCustom_Click">
                    ...
                    <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
                        ...
                        <div class="text-gray-900 fw-bold fs-2 mb-2">لا يوجد عملاء بيع</div>
                        <div class="fw-semibold text-gray-400">انقر هنا لتنزيل التقرير</div>
                    </div>
                    <!--end::Body-->
                </asp:LinkButton>
                <!--end::Statistics Widget 5-->
            ...
            <div class="col-xl-3">
                ...
                <asp:LinkButton ID="lnkNotVisited" runat="server" CssClass="card hoverable card-xl-stretch mb-5 mb-xl-8" OnClick="lnkNotVisited_Click" BackColor="#866eb9">
                    ...
                    <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
                        ...
                        <div class="text-white fw-bold fs-2 mb-2">لم تتم زيارتها</div>
                        <div class="fw-semibold text-white">انقر هنا لتنزيل التقرير</div>
                    </div>
                    <!--end::Body-->
                </asp:LinkButton>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="card-rounded-bottom" data-kt-color="info" style="height: 160px; background-image: linear-gradient(to right, #33b670, #40cd81);">
                        <div class="d-flex text-center flex-column text-white pt-8">
                            <span class="fw-semibold fs-2">العملاء المجدولين</span>
                    ...
                    <div class="card-p mt-n20 position-relative">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col bg-light px-6 py-8 rounded-2 me-7 mb-7">
                                ...
                                <!--end::Svg Icon-->
                                <a href="#" class="text-gray-500 fw-semibold fs-6">تمت زيارته</a>
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col bg-light px-6 py-8 rounded-2 mb-7">
                                ...
                                <!--end::Svg Icon-->
                                <a href="#" class="text-gray-500 fw-semibold fs-6">إنتاجي</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col bg-light px-6 py-8 rounded-2 me-7">
                                ...
                                <!--end::Svg Icon-->
                                <a href="#" class="text-gray-500 fw-semibold fs-6 mt-2">غير منتج</a>
                            ...
                            <div class="col bg-light px-6 py-8 rounded-2">
                                ...
                                <!--end::Svg Icon-->
                                <a href="#" class="text-gray-500 fw-semibold fs-6 mt-2">لم تتم زيارتها</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-xl-8">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="card-rounded-bottom" data-kt-color="danger" style="height: 160px; background-image: linear-gradient(to right, #bd307c, #c7428b);">
                        <div class="d-flex text-center flex-column text-white pt-8">
                            <span class="fw-semibold fs-2">الزيارات غير المجدولة</span>
                            <span class="fw-bold fs-2x pt-1">
                    ...
                    <div class="card-p mt-n20 position-relative">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col bg-light px-6 py-8 rounded-2">
                                ...
                                <!--end::Svg Icon-->
                                <a href="#" class="text-gray-500 fw-semibold fs-6">غير منتج</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
            ...
            <asp:LinkButton ID="lnkNoSaleItem" runat="server" CssClass="card hoverable mb-xl-8" OnClick="lnkNoSaleItem_Click" BackColor="#d83f63">
                ...
                <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
                    ...
                    <div class="text-gray-100 fw-bold fs-2 mb-2">لا توجد عناصر بيع</div>
                </div>
                <!--end::Body-->
            </asp:LinkButton>
            <!--end::Statistics Widget 5-->
        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="card-rounded-bottom" data-kt-color="primary" style="height: 160px; background-image: linear-gradient(to right, #888887, #989898);">
                        <div class="d-flex text-center flex-column text-white pt-8">
                            <span class="fw-semibold fs-2">لا عملاء المعاملات</span>
                            <span class="fw-bold fs-2x pt-1">
                    ...
                    <div class="card-p mt-n20 position-relative">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col bg-light px-6 py-8 rounded-2 me-7">
                                ...
                                <!--end::Svg Icon-->
                                <a href="#" class="text-gray-500 fw-semibold fs-6">المقرر</a>
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col bg-light px-6 py-8 rounded-2">
                                ...
                                <!--end::Svg Icon-->
                                <a href="#" class="text-gray-500 fw-semibold fs-6">غير مجدول</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
            ...
            <asp:LinkButton ID="lnkItemWiseSale" runat="server" CssClass="card hoverable mb-xl-8" OnClick="lnkItemWiseSale_Click" BackColor="#603db4">
                ...
                <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
                    ...
                    <div class="text-white fw-bold fs-2 mb-2">بيع البند الحكيم</div>
                </div>
                <!--end::Body-->
            </asp:LinkButton>
            <!--end::Statistics Widget 5-->
