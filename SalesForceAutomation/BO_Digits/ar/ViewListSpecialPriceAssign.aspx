<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="ViewListSpecialPriceAssign.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.ViewListSpecialPriceAssign" %>
                        ...
                        <div class=" col-lg-12 row" style="display: -webkit-box; padding-bottom: 10px">
                            ...
                            <div class="col-lg-3">
                             ...
                             <div class="col-lg-3" >
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlPayMode" runat="server" DefaultMessage="حدد وضع الدفع" EmptyMessage="Select Payment Mode" Width="100%"  RenderMode="Lightweight">
                                    <items>
