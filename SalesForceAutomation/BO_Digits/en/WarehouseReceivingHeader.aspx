<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="WarehouseReceivingHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.WarehouseReceivingHeader" %>
                            ...
                            <div class="kt-portlet__body">
                                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                    ...
                                    <div class="col-lg-12">
                                     ...
                                     <asp:PlaceHolder ID="pnlfilter2" runat="server" Visible="true">
                                    <div class=" col-lg-12 row" style="padding-bottom: 10px">

                                           <asp:PlaceHolder ID="pnlfilter1" runat="server" Visible="true">
                                        <div class="col-lg-2 ">
                                        ...
                                        <div class="col-lg-2">
                                            <label class="control-label col-lg-12">Received Location</label>
                                            <div class="col-lg-12">
                                                <telerik:RadComboBox Skin="Material" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" Width="100%"
                                    ...
                                    <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                        ...
                                        <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                            ShowFooter="false" DataKeyNames="wrh_ID"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="wti_number" AllowFiltering="true" HeaderStyle-Width="100px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="TI Number" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                    HeaderStyle-Font-Bold="true" UniqueName="wti_number">
                                                </telerik:GridBoundColumn>

                                                <telerik:GridBoundColumn DataField="wrh_trn_number" AllowFiltering="true" HeaderStyle-Width="100px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="Receive Number" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                    HeaderStyle-Font-Bold="true" UniqueName="wrh_trn_number">
                                                </telerik:GridBoundColumn>
                                                ...
                                                <telerik:GridBoundColumn DataField="Currentlevel" AllowFiltering="true" HeaderStyle-Width="100px"
                                                    HeaderStyle-Font-Size="Smaller" HeaderText="Current level" FilterControlWidth="100%"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
