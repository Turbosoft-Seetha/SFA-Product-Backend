<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCustomerActivityDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditCustomerActivityDetail" %>
                             ...
                             <div class="col-lg-4 form-group pb-4">
                                ...
                                <div class="col-lg-12">
                                     <telerik:RadDatePicker ID="rdDueDate" DateInput-DateFormat="dd-MMM-yyyy" runat="server" Width="100%" ></telerik:RadDatePicker>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Display="Dynamic" ErrorMessage="Date is mandatory"  ValidationGroup="form"
