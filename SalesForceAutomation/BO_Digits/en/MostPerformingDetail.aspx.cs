...
{
    public partial class MostPerformingDetail : System.Web.UI.Page
    {
        ...
        public void LoadRoute()
        {
            ...
            item = ObjclsFrms.loadList("SelMostPerformRouteDetail", "sp_Dashboard", UICommon.GetCurrentUserID().ToString(), arr);
        ...
        public void LoadCustomer()
        {
            ...
            string[] arr = { start, end };
            Category = ObjclsFrms.loadList("SelMostPerformCustDetail", "sp_Dashboard", UICommon.GetCurrentUserID().ToString(), arr);
