<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="AddEditRouteProduct.aspx.cs" Inherits="SalesForceAutomation.Admin.AddEditRouteProduct" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" runat="server">
     <script type="text/javascript">
         ...
         function Proroute() {
             ...
             window.location.href = "ListRouteProduct.aspx?ID=" + c;
         }
     </script>
</asp:Content>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head" style="padding-top: 20px">
                        ...
                        <div class="kt-subheader__breadcrumbs">
                            ...
                            <a href="javascript:Proroute();" class="kt-subheader__breadcrumbs-link">Route Product </a>
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a class="kt-subheader__breadcrumbs-link">Add/Edit Route Product  </a>
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Edit Route Product/
                            </h3>
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadComboBox Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"
                                        ID="ddlItems" runat="server"   Width="80%" OnSelectedIndexChanged="ddlItems_SelectedIndexChanged" AutoPostBack="true"  ></telerik:RadComboBox>
