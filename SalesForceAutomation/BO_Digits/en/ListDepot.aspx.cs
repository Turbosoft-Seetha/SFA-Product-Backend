...
namespace SalesForceAutomation.BO_Digits.en
{
    ...
    public partial class ListDepot : System.Web.UI.Page
    {
        ...
        public void List()
        {
            DataTable lstdata = obj.loadList("SelDepot", "sp_Masters");
        ...
        {
            Response.Redirect("AddEditDepot.aspx?Id=" + ID);
        }
        ...
        protected void grvRpt_ItemCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Edit"))
            {
                ...
                string ID = dataItem.GetDataKeyValue("dep_ID").ToString();
                Response.Redirect("AddEditDepot.aspx?Id=" + ID);
            }
