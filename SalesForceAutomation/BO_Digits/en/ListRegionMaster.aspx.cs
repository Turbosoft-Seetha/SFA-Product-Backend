...
{
    public partial class ListRegionMaster : System.Web.UI.Page
    {
        ...
        public void List()
        {
            DataTable lstdata = obj.loadList("SelRegion", "sp_Masters");
        ...
        {
            Response.Redirect("AddEditRegion.aspx?Id=" + ID);
        }
        ...
        protected void grvRpt_ItemCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Edit"))
            {
                ...
                string ID = dataItem.GetDataKeyValue("reg_ID").ToString();
                Response.Redirect("AddEditRegion.aspx?Id=" + ID);
            }
