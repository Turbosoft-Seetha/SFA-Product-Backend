...
{
    public partial class RouteWiseCustomerInfo : System.Web.UI.Page
    {
        ...
        public void ListData()
        {
          ...
          string   rotID = Rot();
            mainCondition = "rcs_rot_ID in (" + rotID + ")";
            
            DataTable lstdata = ObjclsFrms.loadList("RouteWiseCustomerInfo", "sp_Report", mainCondition);
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "RouteWiseCusInfo", "Xlsx"));
