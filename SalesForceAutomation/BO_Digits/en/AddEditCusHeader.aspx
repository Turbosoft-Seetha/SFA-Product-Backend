                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="col-lg-12 row" style="padding-top:10px;">
                            ...
                            <div class="col-lg-4 form-group" style="padding-top: 10px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlcshcompany" runat="server" Width="100%" DefaultMessage="Select Company"></telerik:RadDropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="form"
                                        ControlToValidate="ddlcshcompany" ErrorMessage="Please Choose Company" ForeColor="Red" Display="Dynamic"
