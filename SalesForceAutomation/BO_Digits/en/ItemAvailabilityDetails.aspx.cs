...
{
    public partial class ItemAvailabilityDetails : System.Web.UI.Page
    {
        ...
        public void CustomerHeader()
        {
            ...
            lstDatas = ObjclsFrms.loadList("SelectItemAvailabilityHeader", "sp_Transaction", ResponseID.ToString());
        ...
        public void ListData()
        {
            ...
            lstUser = ObjclsFrms.loadList("SelectItemAvailabilityDetail", "sp_Transaction", ResponseID.ToString());
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Item Availability Detail", "Xlsx"));
