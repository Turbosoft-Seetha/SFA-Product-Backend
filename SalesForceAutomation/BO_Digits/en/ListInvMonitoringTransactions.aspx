<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListInvMonitoringTransactions.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListInvMonitoringTransactions" %>
                                                            ...
                                                            <div class="kt-portlet__head" style="padding-top: 5px;">
                                                                <div class="kt-portlet__head-label">
                                                                    <h3 class="kt-portlet__head-title" style="font-size: medium;">
                                                                        <span class="min-w-70px fw-semibold text-gray-700 pt-5"><asp:Label ID="lblInvmonit" runat ="server"></asp:Label></span>
                                                                    </h3>
                                                                </div>
                                                            </div>
                                                                            ...
                                                                            <asp:LinkButton runat="server" ID="BtnOutOfStock" OnClick="BtnOutOfStock_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Out of Stock</div>
                                                                            ...
                                                                            <asp:LinkButton runat="server" ID="BtnItemAvailability" OnClick="BtnItemAvailability_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Item Availability</div>
     ...
     <asp:LinkButton runat="server" ID="BtnCusInventory" OnClick="BtnCusInventory_Click">
         <div class="d-flex align-items-center mb-2 me-2">
             ...
             <div class="col-10" style="padding-left: 10px;">
                 ...
                 <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Customer Inventory</div>
             ...
             <!--end::Title-->
                                                                            ...
                                                                            <asp:LinkButton runat="server" ID="BtnItemPricing" OnClick="BtnItemPricing_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Item Pricing</div>
                                                                        ...
                                                                        <asp:LinkButton runat="server" ID="BtnPComplaints" OnClick="BtnPComplaints_Click">
                                                                            <div class="d-flex align-items-center mb-2 me-2">
                                                                                ...
                                                                                <div class="col-10" style="padding-left: 10px;">
                                                                                    ...
                                                                                    <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Products Complaints</div>
                                                                        ...
                                                                        <asp:LinkButton runat="server" ID="BtnSurvey" OnClick="BtnSurvey_Click">
                                                                            <div class="d-flex align-items-center mb-2 me-2">
                                                                                ...
                                                                                <div class="col-10" style="padding-left: 10px;">
                                                                                    ...
                                                                                    <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Survey</div>
                                                                        ...
                                                                        <asp:LinkButton runat="server" ID="BtnImageCapture" OnClick="BtnImageCapture_Click">
                                                                            <div class="d-flex align-items-center mb-2 me-2">
                                                                                ...
                                                                                <div class="col-10" style="padding-left: 10px;">
                                                                                    ...
                                                                                    <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Image Capture</div>
                                                                            ...
                                                                            <asp:LinkButton runat="server" ID="BtnCompetitorActivity" OnClick="BtnCompetitorActivity_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Competitor Activities</div>
                                                                            ...
                                                                            <asp:LinkButton runat="server" ID="BtnAssetTracking" OnClick="BtnAssetTracking_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Asset Tracking</div>
                                                        ...
                                                        <div class="col-lg-12 mb-4" hidden="hidden">
                                                            <div class="kt-portlet__head" style="padding-top: 10px;">
                                                                <div class="kt-portlet__head-label">
                                                                    <asp:PlaceHolder ID="pnlmerchother" runat="server">
                                                                        <h3 class="kt-portlet__head-title" style="font-size: medium">
                                                                            <span class="min-w-70px fw-semibold text-gray-700 pt-5">Merchandising Others Transactions</span>
                                                                        </h3>
                                                                    </asp:PlaceHolder>
                                                                </div>
                                                            </div>
                                                                            ...
                                                                            <asp:LinkButton runat="server" ID="BtnTasks" OnClick="BtnTasks_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Tasks</div>
                                                                            ...
                                                                            <asp:LinkButton runat="server" ID="BtnDisplayAgreement" OnClick="BtnDisplayAgreement_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Display Agreements</div>
                                                                            ...
                                                                            <asp:LinkButton runat="server" ID="CusActivity" OnClick="CusActivity_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">Customer Activities</div>
