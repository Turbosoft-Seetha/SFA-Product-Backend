...
{
    public partial class ListPickingSerialDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("InvPickingBatchHeader", "sp_Transaction", HID.ToString());
        ...
        public void LoadData()
        {
            ...
            DataTable lstDatas = new DataTable();
            lstDatas = ObjclsFrms.loadList("InvPickingBatch", "sp_Transaction", ResID.ToString());
