<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="DetailedDailyTransactions.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.DetailedDailyTransactions" %>
...
<asp:Content ID="ContentAction" ContentPlaceHolderID="Actions" runat="server">
     ...
     <asp:ImageButton ID="ImgExcel" runat="server" ImageUrl="../assets/media/UDP/excel.png" Height="20" OnClick="ImgExcel_Click" ToolTip="Download" AlternateText="Xlsx" />
