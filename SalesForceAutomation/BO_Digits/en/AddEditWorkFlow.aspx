<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditWorkFlow.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditWorkFlow" %>
                                    ...
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"
                                                ControlToValidate="txtcode" ErrorMessage="Please Enter Workflow Code" ForeColor="Red" Display="Dynamic"
                                    ...
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                                ControlToValidate="txtname" ErrorMessage="Please Enter Workflow Name" ForeColor="Red" Display="Dynamic"
                                                SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                        </div>
                                    </div>
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:RadDropDownList ID="ddlwfmcompany" runat="server" Width="100%" DefaultMessage="Select Company"></telerik:RadDropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="form"
                                                ControlToValidate="ddlwfmcompany" ErrorMessage="Please Choose Company" ForeColor="Red" Display="Dynamic"
                                                SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                        </div>
                                    </div>
