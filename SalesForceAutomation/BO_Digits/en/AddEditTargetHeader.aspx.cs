    ...
    public partial class AddEditTargetHeader : System.Web.UI.Page
    {
        ...
        protected void Save()
        {
            ...
            else
            {
                ...
                string[] arr = { number, status, id, user };
        ...
        {
            Response.Redirect("ListTargetHeader.aspx");
        }
        ...
        {
            string code = this.txtNumber.Text.ToString();
            DataTable lstCodeChecker = ObjclsFrms.loadList("CheckTargetPackageHeader", "sp_CodeChecker", code);
