<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditTasks.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditTasks" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                             ...
                             <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                     <telerik:RadComboBox ID="ddlBrd" runat="server" Filter="Contains" Width="100%" EmptyMessage="Select Brand" AutoPostBack="true"></telerik:RadComboBox>
                             ...
                             <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                    <div class="col-lg-12">
                                        <label class="control-label col-lg-12 pl-0">Due Date <span class="required"> </span></label>
                                    </div>
                                    <div class="col-lg-12">
                                     
                                        <telerik:RadDatePicker ID="txtduedate" runat="server" DateInput-DateFormat="dd-MMM-yyyy" Width="100%" ></telerik:RadDatePicker>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="form"
                                            ControlToValidate="txtduedate" ErrorMessage="Please select due date" ForeColor="Red" Display="Dynamic"
                                            SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                    </div>
                                </div>
    ...
    <!--end::SuccessModal-->
      ...
      <div class="modal fade" id="kt_modal_5" tabindex="-1" role="dialog" style="height:auto" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
