...
{
    public partial class CustomerTask : System.Web.UI.Page
    {
		...
		public void Tasks(string routeCondition)
		{
			DataTable dtc = ObjclsFrms.loadList("SelectTasksByRoute", "sp_wb_merch_others", routeCondition);
			rdTask.DataSource = dtc;
			rdTask.DataTextField = "name";
			rdTask.DataValueField = "id";
			rdTask.DataBind();
		}
		public string Rot()
        {
		...
		public string Task()
		{
			var ColelctionMarkets = rdTask.CheckedItems;
			string taskID = "";
			int k = 0;
			int MarCounts = ColelctionMarkets.Count;
			if (ColelctionMarkets.Count > 0)
		...
		protected void rdTask_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
		{
