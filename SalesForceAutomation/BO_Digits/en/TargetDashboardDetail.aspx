<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="TargetDashboardDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.TargetDashboardDetail" %>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card card-flush mb-5">
                      ...
                      <div class="px-2 mb-5 col-sm-4">
                          <span class="fs-8 fw-semibold text-gray-700 pt-5">Overall Target Amount </span><br />
                         
                          <span class="fw-bold text-dark h4"> 
                              <asp:Label ID="lblOverTargetAmt" runat="server" Text="0"></asp:Label></span>
                      </div>
                        <div class="px-2 mb-5 col-sm-4">
                          <span class="fs-8 fw-semibold text-gray-700 pt-5">Achieved Amount </span><br />
                           
                          <span class="fw-bold text-success h4 text-success">
                              <asp:Label ID="lblAchievedAmt" runat="server" Text="0"></asp:Label>  </span>
                      </div>
                        <div class="px-2 mb-5 col-sm-4">
                          <span class="fs-8 fw-semibold text-gray-700 pt-5">Remaining Amount </span><br />
                      ...
                      <div class="px-2 mb-5 col-sm-4">
                          <span class="fs-8 fw-semibold text-gray-700 pt-5">Overall Target Quantity </span><br />
                         
                          <span class="fw-bold text-dark h5">
                              <asp:Label ID="lblOverTargetQty" runat="server" Text="0"></asp:Label> </span>
                      </div>
                        <div class="px-2 mb-5 col-sm-4">
                          <span class="fs-8 fw-semibold text-gray-700 pt-5">Achieved Quantity </span><br />
                         
                          <span class="fw-bold text-success h5">
                              <asp:Label ID="lblAchievedQty" runat="server" Text="0"></asp:Label> </span>
                      </div>
                        <div class="px-2 mb-5 col-sm-4">
                          <span class="fs-8 fw-semibold text-gray-700 pt-5">Remaining Quantity </span><br />
                       ...
                       <div class="mx-6 m-2 rounded" style="border-style:solid; border-width:thin; border-color:gainsboro;">
                        ...
                        <div class="Card-body pb-0 m-5 row">
                      <div class="px-2 mb-5 col-sm-4">
                          <span class="fs-8 fw-semibold text-gray-700 pt-5">Target Amount </span><br />
                          <span class="fw-bold text-dark h4">
                       ...
                       <div class="Card-body pb-0 mx-5 row">
                      <div class="px-2 mb-5 col-sm-4">
                          <span class="fs-8 fw-semibold text-gray-700 pt-5">Target Quantity</span><br />
