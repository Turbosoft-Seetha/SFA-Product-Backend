...
{
    public partial class ListCustomerRetailPrice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                else // While loading page from transaction menu
                {
                    try
                    {
                        if (Session["CRPFDate"] != null)
                        {

                            rdfromDate.SelectedDate = DateTime.Parse(Session["CRPFDate"].ToString());
                        }
                        else
                        {
                        ...
                        if (Session["CRPTDate"] != null)
                        {

                            rdendDate.SelectedDate = DateTime.Parse(Session["CRPTDate"].ToString());
                        }
                        else
                        {
                    ...
                    try
                    {
                        ...
                        if (Session["CRProtID"] != null)
                        {
                            int a = rdRoute.Items.Count;
                            string route = Session["CRProtID"].ToString();
                        ...
                        if (Session["CRPcusID"] != null)
                        {
                            int a = rdCustomer.Items.Count;
                            string cusID = Session["CRPcusID"].ToString();
                ...
                try
                {
                    if (Session["CRPAdvFilter"] != null)
                    {
                        if (Session["CRPAdvFilter"].ToString() == "true")
                        {
        ...
        public string mainConditions(string rotID)
        {
            ...
            try
            {
                ...
                {
                    customerCondition = " and crp_cus_ID in (" + cusID + ")";
                }
        ...
        public void ListData()
        {
            ...
            if (!rotID.Equals("0"))
            {
                ...
                lstUser = ObjclsFrms.loadList("SelCustomerRetailPrice", "sp_wb_merch_others", mainCondition.ToString());
        ...
        protected void lnkFilter_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Session["CRPFDate"] != null)
                {
                    ...
                    if (fromdate == Session["CRPFDate"].ToString())
                    {
                        rdfromDate.SelectedDate = DateTime.Parse(Session["CRPFDate"].ToString());
                    }
                    else
                    {
                        Session["CRPFDate"] = DateTime.Parse(rdfromDate.SelectedDate.ToString());
                    }
                }
                else
                {
                ...
                if (Session["CRPTDate"] != null)
                {
                    ...
                    if (todate == Session["CRPTDate"].ToString())
                    {
                        rdendDate.SelectedDate = DateTime.Parse(Session["CRPTDate"].ToString());
                    }
                    else
                    {
                        Session["CRPTDate"] = DateTime.Parse(rdendDate.SelectedDate.ToString());
                    }
                ...
                {
                    string route = Rot();
                    if (route == Session["CRProtID"].ToString())
                    {
                        string rotID = Rot();
                ...
                {
                    string customer = Cus();
                    if (customer == Session["CRPcusID"].ToString())
                    {
                        string cusID = Cus();
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("Detail"))
            {
                ...
                Response.Redirect("ListCustomerRetailPriceDetail.aspx?Id=" + ID);
            }
        }
        public void Region()
        {
