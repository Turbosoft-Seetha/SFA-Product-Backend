<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="OrderListing.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.OrderListing" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
      <asp:linkbutton  ID="Linkbtn1" Visible="true" CssClass="btn btn-sm btn-primary me-2"  runat="server" onClick="Linkbtn1_Click" >طلب جديد
      </asp:linkbutton>
    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../assets/media/icons/excel.png" ToolTip="تحميل" OnClick="ImageButton1_Click" AlternateText="Xlsx" />


    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../assets/media/icons/file.png" Style="height: 40px; width: 40px;" ToolTip="مطبعة"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="rotname" AllowFiltering="true" HeaderStyle-Width="100px"
                                             ...
                                             <telerik:GridBoundColumn DataField="rot_ArabicName" AllowFiltering="true" HeaderStyle-Width="100px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="اسم المسار باللغة العربية" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            ...
                                            <telerik:GridTemplateColumn HeaderStyle-Width="100px" AllowFiltering="false" HeaderText="" HeaderStyle-Font-Size="Smaller" HeaderStyle-Font-Bold="true">
                                                <ItemTemplate>
                                                  <asp:linkbutton CommandName="Confirm" ID="Confirm" Visible="true"  text="Confirm" runat="server" ForeColor="Green" Font-Bold="true" >
                                                  </asp:linkbutton>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                        </Columns>
