<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="WHTransferInHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.WHTransferInHeader" %>
                                                ...
                                                <div class="col-lg-12">
                                                    <telerik:RadComboBox ID="rdStatus" runat="server" EmptyMessage="Select Status" Filter="Contains" Width="100%" RenderMode="Lightweight" AutoPostBack="true">
                                                        <Items>
                                                            ...
                                                            <telerik:RadComboBoxItem Text="Completed" Value="A" />
