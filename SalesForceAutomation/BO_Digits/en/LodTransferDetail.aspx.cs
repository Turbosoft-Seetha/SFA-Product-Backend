...
{
    public partial class LodTransferDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            if (lstDatas.Rows.Count > 0)
            {
                ...
                rp.Text = "Transaction No: " + lstDatas.Rows[0]["lth_TransID"].ToString();
                ...
                lblType.Text = lstDatas.Rows[0]["lth_Type"].ToString();

                ViewState["rotid"] = lstDatas.Rows[0]["lth_rot_ID"].ToString();
                ViewState["usr"] = lstDatas.Rows[0]["lth_usr_ID"].ToString();
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Load Transfer Detail", "Xlsx"));
