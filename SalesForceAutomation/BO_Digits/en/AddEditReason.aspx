<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditReason.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditReason" %>
                ...
                <div class="kt-portlet" style="background-color:white; padding:20px;">
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                           ...
                           <div class="col-lg-4 form-group" >
                             ...
                             <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddltype" runat="server" Width="100%" DefaultMessage="Select Type">
                                        <items>
                                            <telerik:DropDownListItem Text="Customer Start" Value="CS" Selected="true" />
                                             <telerik:DropDownListItem Text="Item Availability" Value="IA" />     
                                             <telerik:DropDownListItem Text="Un-Planned" Value="UP" />     
                                             <telerik:DropDownListItem Text="No Transaction" Value="NT" />     
                                             <telerik:DropDownListItem Text="Manual Start" Value="MS" />  
                                             <telerik:DropDownListItem Text="Asset Add" Value="AA" /> 
                                             <telerik:DropDownListItem Text="Asset Removal" Value="AR" />  
                                             <telerik:DropDownListItem Text="Service Job Action Taken" Value="AT" />
                                              <telerik:DropDownListItem Text="Bad Return" Value="BR" />
                                           
                                             <telerik:DropDownListItem Text="Good Return" Value="GR" />
                                             <telerik:DropDownListItem Text="Credit Note Request " Value="CNR" />
                                             <telerik:DropDownListItem Text="Field Service " Value="FS" />
                                             <telerik:DropDownListItem Text="Journey Plan " Value="JP" />
                                             <telerik:DropDownListItem Text="Load Rejection " Value="LR" />
                                             <telerik:DropDownListItem Text="Partial Delivery" Value="PD" />
                                            <telerik:DropDownListItem Text="Price Update" Value="PU" />
                                            <telerik:DropDownListItem Text="Return Request" Value="RR" />
                                             <telerik:DropDownListItem Text="Scheduled Return Request" Value="SRR" />
                                     ...
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="form"
                                        ControlToValidate="ddltype" ErrorMessage="Please Enter Arabic Name" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
                         </div>
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <div class="col-lg-12">
                                <telerik:RadDropDownList ID="ddlrsncompany" runat="server" Width="100%" DefaultMessage="Select Company"></telerik:RadDropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="form"
                                    ControlToValidate="ddlrsncompany" ErrorMessage="Please Choose Company" ForeColor="Red" Display="Dynamic"
                                    SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                            </div>
                        </div>
                            <div class="col-lg-4 form-group">
