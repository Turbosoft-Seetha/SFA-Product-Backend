...
{
    public partial class FreeSampleApprovalDetail : System.Web.UI.Page
    {
        ...
        public int ResponseID
        {
            ...
            {
                int ResponseID;
                int.TryParse(Request.Params["FAID"], out ResponseID);
                return ResponseID;
            }
        }
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("ListFreeSampleApprovalHeaderbyID", "sp_SFA_App_Sales", ResponseID.ToString());
            if (lstDatas.Rows.Count > 0)
            {
                ...
                lblCustomer.Text = lstDatas.Rows[0]["ord_ID"].ToString();
        ...
        public void LoadData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("ListFreeSampleApprovalDetail", "sp_SFA_App_Sales", ResponseID.ToString());
            if (lstDatas.Rows.Count >= 0)
            {
                    ...
                    foreach (GridDataItem item in grvRpt.MasterTableView.Items)
                    {
                        ...
                        if (!string.IsNullOrEmpty(selectedValue))
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    string Status = "A";
                                    string dad_ID = item.GetDataKeyValue("fsa_ID").ToString();
        ...
        public void Save()
        {
            ...
            string resp = ObjclsFrms.SaveData("sp_SFA_App_Sales", "FreeSampleApprovalSave", ResponseID.ToString(), arr);
        ...
        protected void lnkConfirm_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (GridDataItem item in grvRpt.MasterTableView.Items)
                {
                    ...
                    string OrderQty = item["OrderQty"].Text;
                    //string ReturnLQty = item["ReturnLQty"].Text;

                    if ((OrderQty == "0") && selectedValue.Equals("A"))
                    {
        ...
        {
            Response.Redirect("FreeSampleApprovalHeader.aspx");
        ...
        {// Check if the current item is a data item (not header, footer, etc.)
            if (e.Item is GridDataItem)
            {
                ...
                reasonDrop.DataSource = ObjclsFrms.loadList("SelectReasonforApprovalReq", "sp_SFA_App_Sales");
                reasonDrop.DataTextField = "rsn_Name";
                reasonDrop.DataValueField = "rsn_ID";
                reasonDrop.DataBind();

                string id = item["fsa_ID"].Text;
