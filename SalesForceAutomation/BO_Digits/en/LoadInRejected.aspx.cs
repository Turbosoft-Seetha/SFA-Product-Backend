...
{
	public partial class LoadInRejected : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!Page.IsPostBack)
			{
                ...
                try
                {
                    if (Session["LIRFDate"] != null)
                    {

                        rdfromDate.SelectedDate = DateTime.Parse(Session["LIRFDate"].ToString());
                    }
                    else
                    {
                    ...
                    if (Session["LIRTDate"] != null)
                    {

                        rdendDate.SelectedDate = DateTime.Parse(Session["LIRTDate"].ToString());
                    }
                    else
                    {
                ...
                try
                {
                    if (Session["LIRrotID"] != null)
                    {
                        int a = rdRoute.Items.Count;
                        string route = Session["LIRrotID"].ToString();
		...
		public void LoadData()
		{
			...
			if (!rotID.Equals("0"))
			{
				...
				lstDatas = ObjclsFrms.loadList("ListLoadInRejected", "sp_Backend", mainCondition);
		...
		protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
		{
            ...
            if (e.CommandName.Equals("Detail"))
			{
				...
				Response.Redirect("LoadInRejectedDetail.aspx?LIH=" + ID);
			}
		}
		...
		protected void Filter_Click(object sender, EventArgs e)
		{
            try
            {
                if (Session["LIRFDate"] != null)
                {
                    ...
                    if (fromdate == Session["LIRFDate"].ToString())
                    {
                        rdfromDate.SelectedDate = DateTime.Parse(Session["LIRFDate"].ToString());
                    }
                    else
                    {
                        Session["LIRFDate"] = DateTime.Parse(rdfromDate.SelectedDate.ToString());
                    }
                }
                else
                {
                ...
                if (Session["LIRTDate"] != null)
                {
                    ...
                    if (todate == Session["LIRTDate"].ToString())
                    {
                        rdendDate.SelectedDate = DateTime.Parse(Session["LIRTDate"].ToString());
                    }
                    else
                    {
                        Session["LIRTDate"] = DateTime.Parse(rdendDate.SelectedDate.ToString());
                    }
                ...
                {
                    string route = Rot();
                    if (route == Session["LIRrotID"].ToString())
                    {
                        string rotID = Rot();
