...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class TargetDashboardDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                try
                {
                    ...
                    //Session["monthDate"] = DateTime.Parse(Session["Date"].ToString());
                }
                catch(Exception ex)
                {
        ...
        protected void btnItemDetail_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("/BO_Digits/en/DetailOfTargetDetail.aspx?ID=" + tphID);
        ...
        protected void btnMonthlyProduct_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("/BO_Digits/en/MonthlyTargetDetail.aspx?ID=" + tphID);
