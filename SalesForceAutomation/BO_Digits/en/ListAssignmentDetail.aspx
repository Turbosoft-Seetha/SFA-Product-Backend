<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListAssignmentDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListAssignmentDetail" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                     ...
                     <div class="kt-portlet__body">
                           ...
                           <div> <h3 class="kt-portlet__head-title">Assignment Header </h3> </div> <br />
                          ...
                          <div class="col-lg-12 row">                                                  
                           ...
                           <%-- <div class="col-lg-4 form-group">
                            ...
                            <telerik:RadAjaxPanel ID="RadAjaxPanel5" runat="server" LoadingPanelID="RadAjaxLoadingPanel4">
                                <asp:LinkButton ID="BtnAdd" runat="server" ValidationGroup="frm" UseSubmitBehavior="false" OnClick="BtnAdd_Click" Text='<i class="icon-ok"></i> Add'
                    ...
                    <div class="kt-portlet__body">
                         ...
                         <div class="col-lg-12 row"  style="padding-top: 20px; padding-bottom: 20px;">
                                     <div class="col-lg-10">
                                        <h3 class="kt-portlet__head-title">Assignment Detail
                                        </h3>
                                    </div>
                                    <div class="col-lg-2" style="text-align:end">
                                        <telerik:RadAjaxPanel ID="RadAjaxPanel6" runat="server" LoadingPanelID="RadAjaxLoadingPanel8">
                                            <asp:LinkButton ID="BtnDelete" runat="server" CssClass="btn btn-sm fw-bold btn-danger" Text="Remove Product"   OnClick="BtnDelete_Click"></asp:LinkButton>
                                        </telerik:RadAjaxPanel>
