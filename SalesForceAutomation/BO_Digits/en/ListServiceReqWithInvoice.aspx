<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListServiceReqWithInvoice.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListServiceReqWithInvoice" %>
                            ...
                            <div class=" col-lg-12 row" style="padding-bottom: 10px">
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="Medium" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                            <telerik:GridTemplateColumn HeaderStyle-Width="50px" UniqueName="Invoice" AllowFiltering="false" HeaderText="Invoice" HeaderStyle-Font-Size="Smaller" HeaderStyle-Font-Bold="true">
                                                <ItemTemplate>
                                                    <asp:ImageButton CommandName="Invoice" ID="RadImageButton2"  Visible="true" AlternateText="Invoice" runat="server"
