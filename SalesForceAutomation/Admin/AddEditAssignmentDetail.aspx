<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="AddEditAssignmentDetail.aspx.cs" Inherits="SalesForceAutomation.Admin.AddEditAssignmentDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" runat="server">
    <script type="text/javascript">
        ...
        function redirect() {
            ...
            window.location.href = "ListAssignmentDetail.aspx?Id=" + c;
        }
    </script>
</asp:Content>
                ...
                <div class="kt-portlet">
                  <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        ...
                        <div class="kt-subheader__breadcrumbs">
                            ...
                            <a href="javascript:redirect();" class="kt-subheader__breadcrumbs-link"> List Assignment Detail </a>
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a class="kt-subheader__breadcrumbs-link">Add Edit Assignment Detail </a>
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Edit Assignment Detail <asp:Label ID="lblTitle" runat="server"></asp:Label>
                            </h3>                           
                        </div>
