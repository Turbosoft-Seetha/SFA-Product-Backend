<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="AddEditAssetType.aspx.cs" Inherits="SalesForceAutomation.Admin.AddEditAssetType" %>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head" style="padding-top: 20px">
                        ...
                        <div class="kt-subheader__breadcrumbs">
                            ...
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a class="kt-subheader__breadcrumbs-link"> Add Edit Assets Type </a>
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Edit Assets Type
                            </h3>
                        </div>
                        <div class="kt-portlet__head-actions">
                            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                ...
                                &nbsp;
                                    <a class="btn btn-brand btn-elevate btn-icon-sm" href="ListAssetType.aspx">Cancel
                                    </a>
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                           ...
                           <%-- <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                <label class="control-label col-lg-12">Capacity <span class="required">* </span></label>
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtCapacity" runat="server" CssClass="form-control" Width="100%"></telerik:RadTextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="form"
                                        ControlToValidate="txtCapacity" ErrorMessage="Please Enter Capacity" Display="Dynamic" ForeColor="Red"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                                </div>
                            </div>--%>
                         ...
                         <div class="col-lg-4">
                           ...
                           <%-- <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                <label class="control-label col-lg-12">Planogram <span class="required">* </span></label>
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtPlanogram" runat="server" CssClass="form-control" Width="100%" TextMode="MultiLine" Rows="5"></telerik:RadTextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="form"
                                        ControlToValidate="txtPlanogram" ErrorMessage="Please Enter Planogram" Display="Dynamic" ForeColor="Red"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                                </div>
                            </div>--%>
