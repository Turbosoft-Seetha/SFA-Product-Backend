/*
 CanvasJS HTML5 & JavaScript Charts - v3.4.11 GA - https://canvasjs.com/ 
...
Math.floor(s);for(0>s&&(s+=v);s<v;s++)if(s in this&&this[s]===g)return s;return-1}function s(g){return null===g||"undefined"===typeof g}function Ca(g){g.indexOf||(g.indexOf=db);return g}function eb(g){if(S.fSDec)g[ga("`eeDwdouMhrudods")](ga("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){S._fTWm&&S._fTWm(g)})}function Wa(g,l,v){v=v||"normal";var s=g+"_"+l+"_"+v,w=Xa[s];if(isNaN(w)){try{g="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
...
function(g){l=!0},g.allDOMEventHandlers),J(v,"mousemove",function(){l||(this.style.backgroundColor=g.toolbar.itemBackgroundColorOnHover,this.style.color=g.toolbar.fontColorOnHover)},g.allDOMEventHandlers,!0),J(v,"mouseout",function(){l||(this.style.backgroundColor=g.toolbar.itemBackgroundColor,this.style.color=g.toolbar.fontColor)},g.allDOMEventHandlers,!0),J(v,"click",function(){g.print();ua(g._dropdownMenu)},g.allDOMEventHandlers,!0),v=document.createElement("div"),v.style.cssText="padding: 12px 8px 12px 8px",
v.innerHTML=g._cultureInfo.saveJPGText,v.style.backgroundColor=g.toolbar.itemBackgroundColor,v.style.color=g.toolbar.fontColor,g._dropdownMenu.appendChild(v),J(v,"touchstart",function(g){l=!0},g.allDOMEventHandlers),J(v,"mousemove",function(){l||(this.style.backgroundColor=g.toolbar.itemBackgroundColorOnHover,this.style.color=g.toolbar.fontColorOnHover)},g.allDOMEventHandlers,!0),J(v,"mouseout",function(){l||(this.style.backgroundColor=g.toolbar.itemBackgroundColor,this.style.color=g.toolbar.fontColor)},
g.allDOMEventHandlers,!0),J(v,"click",function(){g.exportChart({format:"jpeg",fileName:g.exportFileName});ua(g._dropdownMenu)},g.allDOMEventHandlers,!0),v=document.createElement("div"),v.style.cssText="padding: 12px 8px 12px 8px",v.innerHTML=g._cultureInfo.savePNGText,v.style.backgroundColor=g.toolbar.itemBackgroundColor,v.style.color=g.toolbar.fontColor,g._dropdownMenu.appendChild(v),J(v,"touchstart",function(g){l=!0},g.allDOMEventHandlers),J(v,"mousemove",function(){l||(this.style.backgroundColor=
...
g[v]!==g[v+12]){l=!1;break}return l?g[0]<<16|g[1]<<8|g[2]:0}function la(g,l,v){return g in l?l[g]:v[g]}function La(g,l,v){if(w&&Za){var s=g.getContext("2d");Ma=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ka=Qa/Ma;g.width=l*ka;g.height=v*ka;Qa!==Ma&&(g.style.width=l+"px",g.style.height=v+"px",s.scale(ka,ka))}else g.width=l,g.height=v}function hb(g){if(!ib){var l=!1,v=!1;}}function ta(g,l){Ga&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
var v=document.createElement("canvas");v.setAttribute("class","canvasjs-chart-canvas");La(v,g,l);w||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(v);return v}function ha(g,l){for(var v in l)g.style[v]=l[v]}function va(g,l,v){l.getAttribute("state")||(l.style.backgroundColor=g.toolbar.itemBackgroundColor,l.style.color=g.toolbar.fontColor,l.style.border="none",ha(l,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));l.getAttribute("state")!==
v&&(l.setAttribute("state",v),l.setAttribute("type","button"),ha(l,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),l.setAttribute("title",g._cultureInfo[v+"Text"]),l.innerHTML="<img style='height:95%; pointer-events: none;' src='"+jb[v].image+"' alt='"+g._cultureInfo[v+"Text"]+"' />")}function Ka(){for(var g=null,l=0;l<arguments.length;l++)g=arguments[l],g.style&&(g.style.display="inline")}function ua(){for(var g=
...
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,
labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:y,titleFontSize:T,titleFontColor:$,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:Z,
labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],
legend:{fontFamily:y,fontSize:14,fontColor:$,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};Z=$="#F5F5F5";H="#FFFFFF";da="#40BAF1";X="#F5F5F5";var T=20,F=14,$a={colorSet:"colorSet2",title:{fontFamily:y,fontSize:33,fontColor:"#3A3A3A",
...
case "DD":return W(U,2);case "DDD":return J[K];case "DDDD":return H[K];case "M":return V+1;case "MM":return W(V+1,2);case "MMM":return R[V];case "MMMM":return P[V];case "Y":return parseInt(String(a).slice(-2));case "YY":return W(String(a).slice(-2),2);case "YYY":return W(String(a).slice(-3),3);case "YYYY":return W(a,4);case "h":return d%12||12;case "hh":return W(d%12||12,2);case "H":return d;case "HH":return W(d,2);case "m":return c;case "mm":return W(c,2);case "s":return b;case "ss":return W(b,2);
case "f":return W(String(e),3).slice(0,1);case "ff":return W(String(e),3).slice(0,2);case "fff":return W(String(e),3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return S?"UTC":(String(F).match(y)||[""]).pop().replace(E,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+W(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+W(Math.floor(Math.abs(f)/60),2)+
W(Math.abs(f)%60,2);default:return p.slice(1,p.length-1)}})}}(),ea=function(g,l,v){if(null===g)return"";if(!isFinite(g))return g;g=Number(g);var s=0>g?!0:!1;s&&(g*=-1);var w=v?v.decimalSeparator:".",y=v?v.digitGroupSeparator:",",E="";l=String(l);var E=1,F=v="",N=-1,M=[],H=[],P=0,J=0,R=0,S=!1,U=0,F=l.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);l=null;for(var K=0;F&&K<F.length;K++)if(l=F[K],"."===l&&0>N)N=K;else{if("%"===l)E*=100;else if("\u2030"===l){E*=1E3;continue}else if(","===l[0]&&
...
"").replace("-",""):l.replace("-",""),v+=l.replace(/[0]+/,function(a){return W(U,a.length)}));y="";for(M=!1;0<H.length;)l=H.shift(),"#"===l||"0"===l?0<g.length&&0!==Number(g.join(""))?(y+=g.shift(),M=!0):"0"===l&&(y+="0",M=!0):1<l.length&&('"'===l[0]&&'"'===l[l.length-1]||"'"===l[0]&&"'"===l[l.length-1])?y+=l.slice(1,l.length-1):"E"!==l[0]&&"e"!==l[0]||"0"!==l[l.length-1]||!/[eE][+-]*[0]+/.test(l)?y+=l:(l=0>U?l.replace("+","").replace("-",""):l.replace("-",""),y+=l.replace(/[0]+/,function(a){return W(U,
...
"undefined"!==typeof module.exports?module.exports=Oa:"function"===typeof define&&define.amd?define([],function(){return Oa}):(window.CanvasJS&&window.console&&window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."),window.CanvasJS=window.CanvasJS?window.CanvasJS:Oa);y=Oa.Chart=function(){function g(a,d){return a.x-d.x}function l(a,d,c){d=d||{};s(c)?(this.predefinedThemes=ab,this.optionsName=
...
2+1;var B=(a[p].x-a[f].x)/b;b=(a[p].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<B||a[t].x<a[f].x&&0>B?{x:a[t].x+B/3,y:a[t].y+b/3}:{x:a[t].x,y:a[t].y+b/9};t=e;f=0===t?0:t-1;p=t===a.length-1?t:t+1;b=Math.abs((a[p].x-a[f].x)/(0===a[t].x-a[f].x?0.01:a[t].x-a[f].x))*(d-1)/2+1;B=(a[p].x-a[f].x)/b;b=(a[p].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<B||a[t].x<a[f].x&&0>B?{x:a[t].x-B/3,y:a[t].y-b/3}:{x:a[t].x,y:a[t].y-b/9};c[c.length]=a[e]}return c}function y(a,d,c,b,e,f,p,t,B,k){var m=0;k?(p.color=f,t.color=f):
...
this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function $(a,d,c){$.base.constructor.call(this,"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function W(a,d){W.base.constructor.call(this,"ToolTip","toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=
NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName="toolTip";this._initialize()}function da(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=ta(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function X(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;
...
new Ia(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&w;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.toolbar=new Sa(this,this.options.toolbar);if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)ha(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+
...
function(a){d=!0},this.allDOMEventHandlers);J(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,va(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,va(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);J(this._zoomButton,"mousemove",function(){d?d=!1:(ha(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ha(a._zoomButton.childNodes[0],
{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);J(this._zoomButton,"mouseout",function(){d||(ha(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ha(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers)}this._resetButton?(ha(this._resetButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+
...
null;a.resetOverlayedCanvas();0>=navigator.userAgent.search("MSIE")&&ha(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"});ua(a._zoomButton,a._resetButton);a.stockChart&&(a.stockChart._rangeEventParameter={stockChart:a.stockChart,source:"chart",index:a.stockChart.charts.indexOf(a),minimum:null,maximum:null});a._dispatchRangeEvent("rangeChanging","reset");a.stockChart&&(a.stockChart._rangeEventParameter.type="rangeChanging",a.stockChart.dispatchEvent("rangeChanging",a.stockChart._rangeEventParameter,
a.stockChart));a.render();a.syncCharts&&a.syncCharts(null,null);a._dispatchRangeEvent("rangeChanged","reset");a.stockChart&&(a.stockChart._rangeEventParameter.type="rangeChanged",a.stockChart.dispatchEvent("rangeChanged",a.stockChart._rangeEventParameter,a.stockChart))},this.allDOMEventHandlers),J(this._resetButton,"mousemove",function(){d||(ha(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&
ha(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers),J(this._resetButton,"mouseout",function(){d||(ha(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ha(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers),this.overlaidCanvas.style.cursor=a._defaultCursor);this.zoomEnabled||
this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),Ka(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))}else this.panEnabled=this.zoomEnabled=!1;gb(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?va(a,a._zoomButton,"zoom"):va(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&va(a,
a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(var c in this.toolTip.options)this.toolTip.options.hasOwnProperty(c)&&this.toolTip.updateOption(c)};l.prototype._updateSize=function(){var a;a=[this.canvas,this.overlaidCanvas,this._eventManager.ghostCanvas];var d=0,c=0;this.options.width?d=this.width:this.width=d=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?c=this.height:
...
this.layoutManager=new Da(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=l._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new H(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=s(this.options.data[c].linkedDataSeriesIndex)?
...
d||"normal",this.data[c]._linkedSeries=null===this.data[c].linkedDataSeriesIndex?null:this.data[this.data[c].linkedDataSeriesIndex])}}this._objectsInitialized=!0;this._plotAreaElements=[]};l._supportedChartTypes=Ca("line stepLine spline column area stepArea splineArea bar bubble scatter stackedColumn stackedColumn100 stackedBar stackedBar100 stackedArea stackedArea100 candlestick ohlc boxAndWhisker rangeColumn error rangeBar rangeArea rangeSplineArea pie doughnut funnel pyramid waterfall".split(" "));
...
"px solid "+this.toolbar.buttonBorderColor,this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.buttonBorderThickness:0)+"px solid "+this.toolbar.buttonBorderColor):(ua(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.buttonBorderThickness+"px solid transparent",this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));eb(this);this._processData();
this.options.title&&(this.title=new ya(this,this.options.title),this.title.dockInsidePlotArea?a.push(this.title):this.title.setLayout());if(this.options.subtitles)for(d=0;d<this.options.subtitles.length;d++)c=new Ha(this,this.options.subtitles[d],d),this.subtitles.push(c),c.dockInsidePlotArea?a.push(c):c.setLayout();this.legend=new F(this,this.options.legend);for(d=0;d<this.data.length;d++)(this.data[d].showInLegend||"pie"===this.data[d].type||"doughnut"===this.data[d].type||"funnel"===this.data[d].type||
...
{chart:m});m.dispatchEvent("dataAnimationEnd",{chart:m})}this.attachPlotAreaEventHandlers();this.zoomEnabled||(this.panEnabled||!this._zoomButton||"none"===this._zoomButton.style.display)||ua(this._zoomButton,this._resetButton);this.toolTip._updateToolTip();this.renderCount++;Ga&&(m=this,setTimeout(function(){var a=document.getElementById("ghostCanvasCopy");a&&(La(a,m.width,m.height),a.getContext("2d").drawImage(m._eventManager.ghostCanvas,0,0))},2E3));this._breaksCanvas&&(delete this._breaksCanvas,
...
"move":"default",capture:!0,bounds:this.plotArea})};l.prototype.categoriseDataSeries=function(){for(var a="",d=0;d<this.data.length;d++)if(a=this.data[d],a.dataPoints&&(0!==a.dataPoints.length&&a.visible)&&0<=l._supportedChartTypes.indexOf(a.type)){for(var c=null,b=!1,e=null,f=!1,p=0;p<this.plotInfo.plotTypes.length;p++)if(this.plotInfo.plotTypes[p].type===a.type){b=!0;c=this.plotInfo.plotTypes[p];break}b||(c={type:a.type,totalDataSeries:0,plotUnits:[]},this.plotInfo.plotTypes.push(c));for(p=0;p<
...
a.axisYIndex&&a.axisYIndex<this.axisY2.length?a.axisYIndex:0],axisX:"primary"===a.axisXType?this.axisX[0<=a.axisXIndex&&a.axisXIndex<this.axisX.length?a.axisXIndex:0]:this.axisX2[0<=a.axisXIndex&&a.axisXIndex<this.axisX2.length?a.axisXIndex:0],dataSeriesIndexes:[],yTotals:[],yAbsTotals:[]},c.plotUnits.push(e));c.totalDataSeries++;e.dataSeriesIndexes.push(d);a.plotUnit=e}for(d=0;d<this.plotInfo.plotTypes.length;d++)for(c=this.plotInfo.plotTypes[d],p=a=0;p<c.plotUnits.length;p++)c.plotUnits[p].previousDataSeriesCount=
...
this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(t.dataPoints[B].x&&t.dataPoints[B].x.getTime||"dateTime"===t.xValueType)f=!0;for(B=0;B<t.dataPoints.length;B++){"undefined"===typeof t.dataPoints[B].x&&(t.dataPoints[B].x=B+(a.axisX.logarithmic?1:0));t.dataPoints[B].x.getTime?(f=!0,b=t.dataPoints[B].x.getTime()):b=t.dataPoints[B].x;e=t.dataPoints[B].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);e<d.min&&"number"===typeof e&&(d.min=e);e>d.max&&"number"===typeof e&&(d.max=e);if(0<B){if(a.axisX.logarithmic){var r=
b/t.dataPoints[B-1].x;1>r&&(r=1/r);c.minDiff>r&&1!==r&&(c.minDiff=r)}else r=b-t.dataPoints[B-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==t.dataPoints[B-1].y&&(a.axisY.logarithmic?(r=e/t.dataPoints[B-1].y,1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-t.dataPoints[B-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!k)null!==e&&(n=b);else{if(!k&&(k=!0,0<B)){B-=2;continue}if(b>h&&!m)m=!0;else if(b>h&&m)continue;t.dataPoints[B].label&&(a.axisX.labels[b]=t.dataPoints[B].label);
b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&n<b&&(c.viewPortMin=n):(e<d.viewPortMin&&"number"===typeof e&&(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=e))}}t.axisX.valueType=t.xValueType=f?"dateTime":"number"}};l.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,p=[],t=[],B=Infinity,k=-Infinity,m=0;m<a.dataSeriesIndexes.length;m++){var n=
this.data[a.dataSeriesIndexes[m]],q=0,h=!1,r=!1,g;if("normal"===n.axisPlacement||"xySwapped"===n.axisPlacement)var l=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,u=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(n.dataPoints[q].x&&n.dataPoints[q].x.getTime||"dateTime"===n.xValueType)f=!0;for(q=0;q<n.dataPoints.length;q++){"undefined"===typeof n.dataPoints[q].x&&(n.dataPoints[q].x=q+(a.axisX.logarithmic?1:0));n.dataPoints[q].x.getTime?(f=!0,b=n.dataPoints[q].x.getTime()):b=n.dataPoints[q].x;e=s(n.dataPoints[q].y)?0:n.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var x=
b/n.dataPoints[q-1].x;1>x&&(x=1/x);c.minDiff>x&&1!==x&&(c.minDiff=x)}else x=b-n.dataPoints[q-1].x,0>x&&(x*=-1),c.minDiff>x&&0!==x&&(c.minDiff=x);null!==e&&null!==n.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(x=e/n.dataPoints[q-1].y,1>x&&(x=1/x),d.minDiff>x&&1!==x&&(d.minDiff=x)):(x=e-n.dataPoints[q-1].y,0>x&&(x*=-1),d.minDiff>x&&0!==x&&(d.minDiff=x)))}if(b<l&&!h)null!==n.dataPoints[q].y&&(g=b);else{if(!h&&(h=!0,0<q)){q-=2;continue}if(b>u&&!r)r=!0;else if(b>u&&r)continue;n.dataPoints[q].label&&(a.axisX.labels[b]=
n.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===n.dataPoints[q].y?c.viewPortMin===b&&g<b&&(c.viewPortMin=g):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?p[b]?p[b]+=e:(p[b]=e,B=Math.min(e,B)):t[b]?t[b]+=e:(t[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,
p),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,t)):(d.dataPointYPositiveSums=p,d.dataPointYNegativeSums=t));n.axisX.valueType=n.xValueType=f?"dateTime":"number"}for(q in p)p.hasOwnProperty(q)&&!isNaN(q)&&(a=p[q],a<d.min&&(d.min=Math.min(a,B)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,B)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in t)t.hasOwnProperty(q)&&!isNaN(q)&&(a=t[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<
c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,k))))}};l.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,p=!1,t=!1,B=[],k=0;k<a.dataSeriesIndexes.length;k++){var m=this.data[a.dataSeriesIndexes[k]],n=0,q=!1,h=!1,r;if("normal"===m.axisPlacement||"xySwapped"===m.axisPlacement)var g=a.axisX.sessionVariables.newViewportMinimum?
a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,l=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(m.dataPoints[n].x&&
m.dataPoints[n].x.getTime||"dateTime"===m.xValueType)f=!0;for(n=0;n<m.dataPoints.length;n++){"undefined"===typeof m.dataPoints[n].x&&(m.dataPoints[n].x=n+(a.axisX.logarithmic?1:0));m.dataPoints[n].x.getTime?(f=!0,b=m.dataPoints[n].x.getTime()):b=m.dataPoints[n].x;e=s(m.dataPoints[n].y)?null:m.dataPoints[n].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<n){if(a.axisX.logarithmic){var u=b/m.dataPoints[n-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-m.dataPoints[n-1].x,0>u&&(u*=-1),c.minDiff>
u&&0!==u&&(c.minDiff=u);s(e)||null===m.dataPoints[n-1].y||(a.axisY.logarithmic?0<e&&(u=e/m.dataPoints[n-1].y,1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e-m.dataPoints[n-1].y,0>u&&(u*=-1),d.minDiff>u&&0!==u&&(d.minDiff=u)))}if(b<g&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<n)){n-=2;continue}if(b>l&&!h)h=!0;else if(b>l&&h)continue;m.dataPoints[n].label&&(a.axisX.labels[b]=m.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&r<
b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?p=!0:0>e&&(t=!0),B[b]=B[b]?B[b]+Math.abs(e):Math.abs(e))}}m.axisX.valueType=m.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):p&&!t?(d.max=s(d.viewPortMax)?99:Math.max(d.viewPortMax,
...
f,p,t=!1,B=0;B<a.dataSeriesIndexes.length;B++){var k=this.data[a.dataSeriesIndexes[B]],m=0,n=!1,q=!1,h,r,g;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var l=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,u=a.axisX.sessionVariables.newViewportMaximum?
a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(k.dataPoints[m].x&&k.dataPoints[m].x.getTime||"dateTime"===k.xValueType)t=!0;for(m=0;m<k.dataPoints.length;m++){"undefined"===typeof k.dataPoints[m].x&&(k.dataPoints[m].x=m+(a.axisX.logarithmic?1:0));k.dataPoints[m].x.getTime?(t=!0,b=k.dataPoints[m].x.getTime()):b=k.dataPoints[m].x;
if((e=k.dataPoints[m].y)&&e.length){f=Math.min.apply(null,e);p=Math.max.apply(null,e);r=!0;for(var x=0;x<e.length;x++)null===e.k&&(r=!1);r&&(n||(g=h),h=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);p>d.max&&(d.max=p);0<m&&(a.axisX.logarithmic?(r=b/k.dataPoints[m-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-k.dataPoints[m-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&k.dataPoints[m-1].y&&null!==k.dataPoints[m-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/
k.dataPoints[m-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[m-1].y[0],0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<l)||n){if(!n&&(n=!0,0<m)){m-=2;h=g;continue}if(b>u&&!q)q=!0;else if(b>u&&q)continue;k.dataPoints[m].label&&(a.axisX.labels[b]=k.dataPoints[m].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(x=0;x<e.length;x++)if(null===e[x]&&h<b){c.viewPortMin=h;break}null===e?c.viewPortMin===b&&h<b&&
(c.viewPortMin=h):(f<d.viewPortMin&&(d.viewPortMin=f),p>d.viewPortMax&&(d.viewPortMax=p))}}k.axisX.valueType=k.xValueType=t?"dateTime":"number"}};l.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,p=0;p<a.dataSeriesIndexes.length;p++){var t=this.data[a.dataSeriesIndexes[p]],B=0,k=!1,m=!1,n=b=0;if("normal"===t.axisPlacement||"xySwapped"===t.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?
a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,h=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;
if(t.dataPoints[B].x&&t.dataPoints[B].x.getTime||"dateTime"===t.xValueType)f=!0;for(B=0;B<t.dataPoints.length;B++)"undefined"!==typeof t.dataPoints[B].isCumulativeSum&&!0===t.dataPoints[B].isCumulativeSum?(t.dataPointEOs[B].cumulativeSumYStartValue=0,t.dataPointEOs[B].cumulativeSum=0===B?0:t.dataPointEOs[B-1].cumulativeSum,t.dataPoints[B].y=0===B?0:t.dataPointEOs[B-1].cumulativeSum):"undefined"!==typeof t.dataPoints[B].isIntermediateSum&&!0===t.dataPoints[B].isIntermediateSum?(t.dataPointEOs[B].cumulativeSumYStartValue=
n,t.dataPointEOs[B].cumulativeSum=0===B?0:t.dataPointEOs[B-1].cumulativeSum,t.dataPoints[B].y=0===B?0:b,n=0===B?0:t.dataPointEOs[B-1].cumulativeSum,b=0):(e="number"!==typeof t.dataPoints[B].y?0:t.dataPoints[B].y,t.dataPointEOs[B].cumulativeSumYStartValue=0===B?0:t.dataPointEOs[B-1].cumulativeSum,t.dataPointEOs[B].cumulativeSum=0===B?e:t.dataPointEOs[B-1].cumulativeSum+e,b+=e);for(B=0;B<t.dataPoints.length;B++)if("undefined"===typeof t.dataPoints[B].x&&(t.dataPoints[B].x=B+(a.axisX.logarithmic?1:0)),
t.dataPoints[B].x.getTime?(f=!0,b=t.dataPoints[B].x.getTime()):b=t.dataPoints[B].x,e=t.dataPoints[B].y,b<c.min&&(c.min=b),b>c.max&&(c.max=b),t.dataPointEOs[B].cumulativeSum<d.min&&(d.min=t.dataPointEOs[B].cumulativeSum),t.dataPointEOs[B].cumulativeSum>d.max&&(d.max=t.dataPointEOs[B].cumulativeSum),0<B&&(a.axisX.logarithmic?(n=b/t.dataPoints[B-1].x,1>n&&(n=1/n),c.minDiff>n&&1!==n&&(c.minDiff=n)):(n=b-t.dataPoints[B-1].x,0>n&&(n*=-1),c.minDiff>n&&0!==n&&(c.minDiff=n)),null!==e&&null!==t.dataPoints[B-
1].y&&(a.axisY.logarithmic?(e=t.dataPointEOs[B].cumulativeSum/t.dataPointEOs[B-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=t.dataPointEOs[B].cumulativeSum-t.dataPointEOs[B-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<B)){B-=2;continue}if(b>h&&!m)m=!0;else if(b>h&&m)continue;t.dataPoints[B].label&&(a.axisX.labels[b]=t.dataPoints[B].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<B&&(t.dataPointEOs[B-
...
c)for(var d=a.axisY.dataInfo,f=a.axisX.dataInfo,h,k=f.min,p=f.max,m=d.min,n=d.max,f=f._dataRanges,d=d._dataRanges,q,t=0,B=0;B<a.dataSeriesIndexes.length;B++){var g=e.data[a.dataSeriesIndexes[B]];if(!(4>g.dataPoints.length))for(t=0;t<g.dataPoints.length;t++)if(b&&(q=(p+1-k)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,h=g.dataPoints[t].x.getTime?g.dataPoints[t].x.getTime():g.dataPoints[t].x,q=Math.floor((h-k)/q),h<f[q].min&&(f[q].min=h),h>f[q].max&&(f[q].max=h)),c){var l=
(n+1-m)*Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold)||10,10)/100;if((h="waterfall"===a.type?g.dataPointEOs[t].cumulativeSum:g.dataPoints[t].y)&&h.length)for(var w=0;w<h.length;w++)q=Math.floor((h[w]-m)/l),h[w]<d[q].min&&(d[q].min=h[w]),h[w]>d[q].max&&(d[q].max=h[w]);else s(h)||(q=Math.floor((h-m)/l),h<d[q].min&&(d[q].min=h),h>d[q].max&&(d[q].max=h))}}}}function c(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)&&a.axisX.scaleBreaks&&a.axisX.scaleBreaks.autoCalculate&&1<=
a.axisX.scaleBreaks.maxNumberOfAutoBreaks)for(var b=a.axisX.dataInfo,c=b.min,d=b.max,f=b._dataRanges,h,k=0,p=0;p<a.dataSeriesIndexes.length;p++){var m=e.data[a.dataSeriesIndexes[p]];if(!(4>m.dataPoints.length))for(k=0;k<m.dataPoints.length;k++)h=(d+1-c)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,b=m.dataPoints[k].x.getTime?m.dataPoints[k].x.getTime():m.dataPoints[k].x,h=Math.floor((b-c)/h),b<f[h].min&&(f[h].min=b),b>f[h].max&&(f[h].max=b)}}for(var b,e=this,f=!1,p=0;p<
this._axes.length;p++)if(this._axes[p].scaleBreaks&&this._axes[p].scaleBreaks.autoCalculate&&1<=this._axes[p].scaleBreaks.maxNumberOfAutoBreaks){f=!0;this._axes[p].dataInfo._dataRanges=[];for(var t=0;t<100/Math.max(parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold)||10,10);t++)this._axes[p].dataInfo._dataRanges.push({min:Infinity,max:-Infinity})}if(f){for(p=0;p<this.plotInfo.plotTypes.length;p++)for(f=this.plotInfo.plotTypes[p],t=0;t<f.plotUnits.length;t++)b=f.plotUnits[t],"line"===b.type||
"stepLine"===b.type||"spline"===b.type||"column"===b.type||"area"===b.type||"stepArea"===b.type||"splineArea"===b.type||"bar"===b.type||"bubble"===b.type||"scatter"===b.type||"candlestick"===b.type||"ohlc"===b.type||"rangeColumn"===b.type||"rangeBar"===b.type||"rangeArea"===b.type||"rangeSplineArea"===b.type||"waterfall"===b.type||"error"===b.type||"boxAndWhisker"===b.type?d(b):0<=b.type.indexOf("stacked")&&c(b);for(p=0;p<this._axes.length;p++)if(this._axes[p].dataInfo._dataRanges){var B=this._axes[p].dataInfo.min;
b=(this._axes[p].dataInfo.max+1-B)*Math.max(parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold)||10,10)/100;var k=this._axes[p].dataInfo._dataRanges,m,n,f=[];if(this._axes[p].dataInfo.dataPointYPositiveSums){var q=this._axes[p].dataInfo.dataPointYPositiveSums;m=k;for(t in q)if(q.hasOwnProperty(t)&&!isNaN(t)&&(n=q[t],!s(n))){var h=Math.floor((n-B)/b);n<m[h].min&&(m[h].min=n);n>m[h].max&&(m[h].max=n)}delete this._axes[p].dataInfo.dataPointYPositiveSums}if(this._axes[p].dataInfo.dataPointYNegativeSums){q=
this._axes[p].dataInfo.dataPointYNegativeSums;m=k;for(t in q)q.hasOwnProperty(t)&&!isNaN(t)&&(n=-1*q[t],s(n)||(h=Math.floor((n-B)/b),n<m[h].min&&(m[h].min=n),n>m[h].max&&(m[h].max=n)));delete this._axes[p].dataInfo.dataPointYNegativeSums}for(t=0;t<k.length-1;t++)if(m=k[t].max,isFinite(m))for(;t<k.length-1;)if(B=k[t+1].min,isFinite(B)){n=B-m;n>b&&f.push({diff:n,start:m,end:B});break}else t++;if(this._axes[p].scaleBreaks.customBreaks)for(t=0;t<this._axes[p].scaleBreaks.customBreaks.length;t++)for(b=
0;b<f.length;b++)if(this._axes[p].scaleBreaks.customBreaks[t].startValue<=f[b].start&&f[b].start<=this._axes[p].scaleBreaks.customBreaks[t].endValue||this._axes[p].scaleBreaks.customBreaks[t].startValue<=f[b].start&&f[b].start<=this._axes[p].scaleBreaks.customBreaks[t].endValue||f[b].start<=this._axes[p].scaleBreaks.customBreaks[t].startValue&&this._axes[p].scaleBreaks.customBreaks[t].startValue<=f[b].end||f[b].start<=this._axes[p].scaleBreaks.customBreaks[t].endValue&&this._axes[p].scaleBreaks.customBreaks[t].endValue<=
f[b].end)f.splice(b,1),b--;f.sort(function(a,b){return b.diff-a.diff});for(t=0;t<Math.min(f.length,this._axes[p].scaleBreaks.maxNumberOfAutoBreaks);t++)b=a(f[t].start,f[t].end,this._axes[p].logarithmic?this._axes[p].dataInfo.max/this._axes[p].dataInfo.min:this._axes[p].dataInfo.max-this._axes[p].dataInfo.min,this._axes[p].logarithmic),this._axes[p].scaleBreaks.autoBreaks.push(new T(this,"autoBreaks",b,t,++this._eventManager.lastObjectId,this._axes[p].scaleBreaks)),this._axes[p].scaleBreaks._appliedBreaks.push(this._axes[p].scaleBreaks.autoBreaks[this._axes[p].scaleBreaks.autoBreaks.length-
1]);this._axes[p].scaleBreaks._appliedBreaks.sort(function(a,b){return a.startValue-b.startValue})}}};l.prototype.renderCrosshairs=function(a){for(var d=0;d<this.axisX.length;d++)this.axisX[d]!=a&&(this.axisX[d].crosshair&&this.axisX[d].crosshair.enabled&&!this.axisX[d].crosshair._hidden)&&this.axisX[d].showCrosshair(this.axisX[d].crosshair._updatedValue);for(d=0;d<this.axisX2.length;d++)this.axisX2[d]!=a&&(this.axisX2[d].crosshair&&this.axisX2[d].crosshair.enabled&&!this.axisX2[d].crosshair._hidden)&&
...
!0;this.dragStartPoint={x:a,y:d}};l.prototype._plotAreaMouseUp=function(a,d){if(("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)&&this.isDrag){var c=d-this.dragStartPoint.y,b=a-this.dragStartPoint.x,e=0<=this.zoomType.indexOf("x"),f=0<=this.zoomType.indexOf("y"),p=!1;this.resetOverlayedCanvas();if("xySwapped"===this.plotInfo.axisPlacement)var t=f,f=e,e=t;if(this.panEnabled||this.zoomEnabled){if(this.panEnabled)for(e=f=0;e<this._axes.length;e++)c=this._axes[e],c.logarithmic?
...
b,e,f)&&(p=!0)}p&&(this._ignoreNextEvent=!0,this._dispatchRangeEvent("rangeChanging","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter||(this.stockChart._rangeEventParameter={stockChart:this.stockChart,source:"chart",index:this.stockChart.charts.indexOf(this),minimum:this.stockChart.sessionVariables._axisXMin,maximum:this.stockChart.sessionVariables._axisXMax}),this.stockChart._rangeEventParameter.type="rangeChanging",this.stockChart.dispatchEvent("rangeChanging",
this.stockChart._rangeEventParameter,this.stockChart)),this.render(),this._dispatchRangeEvent("rangeChanged","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),p&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(Ka(this._zoomButton,this._resetButton),va(this,this._zoomButton,"pan"),va(this,this._resetButton,
...
this.axisY[p].crosshair.enabled&&this.axisY[p].renderCrosshair(a,d);if(this.axisY2&&0<this.axisY2.length)for(p=0;p<this.axisY2.length;p++)this.axisY2[p].crosshair&&this.axisY2[p].crosshair.enabled&&this.axisY2[p].renderCrosshair(a,d)}};l.prototype._plotAreaMouseMove=function(a,d){if(this.isDrag&&"none"!==this.plotInfo.axisPlacement){var c=0,b=0,e=c=null,e=0<=this.zoomType.indexOf("x"),f=0<=this.zoomType.indexOf("y"),p=this;"xySwapped"===this.plotInfo.axisPlacement&&(c=f,f=e,e=c);c=this.dragStartPoint.x-
a;b=this.dragStartPoint.y-d;if(2<Math.abs(c)&&8>Math.abs(c)&&(this.panEnabled||this.zoomEnabled)){this.toolTip.hide();this.toolTip&&this.toolTip.enabled&&this.toolTip.dispatchEvent("hidden",{chart:this,toolTip:this.toolTip},this.toolTip);for(var t=0;t<this.axisX.length;t++)this.axisX[t].crosshair&&this.axisX[t].crosshair.enabled&&(this.axisX[t].crosshair.hide(),this.axisX[t].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisX[t].options},this.axisX[t].crosshair));for(t=0;t<this.axisX2.length;t++)this.axisX2[t].crosshair&&
this.axisX2[t].crosshair.enabled&&(this.axisX2[t].crosshair.hide(),this.axisX2[t].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisX2[t].options},this.axisX2[t].crosshair));for(t=0;t<this.axisY.length;t++)this.axisY[t].crosshair&&this.axisY[t].crosshair.enabled&&(this.axisY[t].crosshair.hide(),this.axisY[t].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisY[t].options},this.axisY[t].crosshair));for(t=0;t<this.axisY2.length;t++)this.axisY2[t].crosshair&&this.axisY2[t].crosshair.enabled&&
(this.axisY2[t].crosshair.hide(),this.axisY2[t].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisY2[t].options},this.axisY2[t].crosshair))}else this.panEnabled||this.zoomEnabled||this.toolTip.mouseMoveHandler(a,d);if((!e||2<Math.abs(c)||!f||2<Math.abs(b))&&(this.panEnabled||this.zoomEnabled))if(this.panEnabled)e={x1:e?this.plotArea.x1+c:this.plotArea.x1,y1:f?this.plotArea.y1+b:this.plotArea.y1,x2:e?this.plotArea.x2+c:this.plotArea.x2,y2:f?this.plotArea.y2+b:this.plotArea.y2},clearTimeout(p._panTimerId),
...
this.plotArea.y1;this.validateRegion(b,t,e?a:this.plotArea.x2-this.plotArea.x1,f?d:this.plotArea.y2-this.plotArea.y1,"xy"!==this.zoomType).isValid&&(this.resetOverlayedCanvas(),this.overlaidCanvasCtx.fillStyle="#99B2B5");this.overlaidCanvasCtx.globalAlpha=0.7;this.overlaidCanvasCtx.fillRect(b,t,B,k);this.overlaidCanvasCtx.globalAlpha=c}}else if(this.toolTip.mouseMoveHandler(a,d),"none"!==this.plotInfo.axisPlacement){if(this.axisX&&0<this.axisX.length)for(e=0;e<this.axisX.length;e++)this.axisX[e].crosshair&&
this.axisX[e].crosshair.enabled&&this.axisX[e].renderCrosshair(a,d);if(this.axisX2&&0<this.axisX2.length)for(e=0;e<this.axisX2.length;e++)this.axisX2[e].crosshair&&this.axisX2[e].crosshair.enabled&&this.axisX2[e].renderCrosshair(a,d);if(this.axisY&&0<this.axisY.length)for(e=0;e<this.axisY.length;e++)this.axisY[e].crosshair&&this.axisY[e].crosshair.enabled&&this.axisY[e].renderCrosshair(a,d);if(this.axisY2&&0<this.axisY2.length)for(e=0;e<this.axisY2.length;e++)this.axisY2[e].crosshair&&this.axisY2[e].crosshair.enabled&&
this.axisY2[e].renderCrosshair(a,d)}};l.prototype._zoomPanToSelectedRegion=function(a,d,c,b,e){a=this.validateRegion(a,d,c,b,e);d=a.axesWithValidRange;c=a.axesRanges;if(a.isValid)for(b=0;b<d.length;b++)e=c[b],d[b].setViewPortRange(e.val1,e.val2),this.syncCharts&&"y"!=this.zoomType&&this.syncCharts(e.val1,e.val2),this.stockChart&&(this.stockChart._rangeEventParameter={stockChart:this.stockChart,source:"chart",index:this.stockChart.charts.indexOf(this),minimum:e.val1,maximum:e.val2});return a.isValid};
l.prototype.validateRegion=function(a,d,c,b,e){e=e||!1;for(var f=0<=this.zoomType.indexOf("x"),p=0<=this.zoomType.indexOf("y"),t=!1,B=[],k=[],m=[],n=0;n<this._axes.length;n++)("axisX"===this._axes[n].type&&f||"axisY"===this._axes[n].type&&p)&&k.push(this._axes[n]);for(p=0;p<k.length;p++){var n=k[p],f=!1,q=n.convertPixelToValue({x:a,y:d}),h=n.convertPixelToValue({x:c,y:b});if(q>h)var r=h,h=q,q=r;if(n.scaleBreaks)for(r=0;!f&&r<n.scaleBreaks._appliedBreaks.length;r++)f=n.scaleBreaks._appliedBreaks[r].startValue<=
q&&n.scaleBreaks._appliedBreaks[r].endValue>=h;if(isFinite(n.dataInfo.minDiff))if(r=n.getApparentDifference(q,h,null,!0),!(f||!(this.panEnabled&&n.scaleBreaks&&n.scaleBreaks._appliedBreaks.length)&&(n.logarithmic&&r<Math.pow(n.dataInfo.minDiff,3)||!n.logarithmic&&r<3*Math.abs(n.dataInfo.minDiff))||q<n.minimum||h>n.maximum))B.push(n),m.push({val1:q,val2:h}),t=!0;else if(!e){t=!1;break}}return{isValid:t,axesWithValidRange:B,axesRanges:m}};l.prototype.preparePlotArea=function(){var a=this.plotArea;!w&&
(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&(this.axisY[0]||this.axisY2[0])){var d=this.axisX[0]?this.axisX[0].lineCoordinates:this.axisX2[0].lineCoordinates;if(this.axisY&&0<this.axisY.length&&this.axisY[0]){var c=this.axisY[0];a.x1=d.x1<d.x2?d.x1:c.lineCoordinates.x1;a.y1=d.y1<c.lineCoordinates.y1?d.y1:c.lineCoordinates.y1;a.x2=d.x2>c.lineCoordinates.x2?d.x2:c.lineCoordinates.x2;a.y2=d.y2>d.y1?d.y2:c.lineCoordinates.y2;a.width=a.x2-a.x1;a.height=a.y2-a.y1}this.axisY2&&
0<this.axisY2.length&&this.axisY2[0]&&(c=this.axisY2[0],a.x1=d.x1<d.x2?d.x1:c.lineCoordinates.x1,a.y1=d.y1<c.lineCoordinates.y1?d.y1:c.lineCoordinates.y1,a.x2=d.x2>c.lineCoordinates.x2?d.x2:c.lineCoordinates.x2,a.y2=d.y2>d.y1?d.y2:c.lineCoordinates.y2,a.width=a.x2-a.x1,a.height=a.y2-a.y1)}else d=this.layoutManager.getFreeSpace(),a.x1=d.x1,a.x2=d.x2,a.y1=d.y1,a.y2=d.y2,a.width=d.width,a.height=d.height;w||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=
a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Da(a.x1,a.y1,a.x2,a.y2,2)};l.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,p=f=e=0,t=0,B=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var m=this._indexLabels[a],n=m.chartType.toLowerCase(),q,h,p=la("indexLabelFontColor",m.dataPoint,m.dataSeries),r=la("indexLabelFontSize",m.dataPoint,m.dataSeries),t=la("indexLabelFontFamily",m.dataPoint,m.dataSeries),B=la("indexLabelFontStyle",
m.dataPoint,m.dataSeries),k=la("indexLabelFontWeight",m.dataPoint,m.dataSeries),g=la("indexLabelBackgroundColor",m.dataPoint,m.dataSeries);q=la("indexLabelMaxWidth",m.dataPoint,m.dataSeries);h=la("indexLabelWrap",m.dataPoint,m.dataSeries);var l=la("indexLabelLineDashType",m.dataPoint,m.dataSeries),u=la("indexLabelLineColor",m.dataPoint,m.dataSeries),x=s(m.dataPoint.indexLabelLineThickness)?s(m.dataSeries.options.indexLabelLineThickness)?0:m.dataSeries.options.indexLabelLineThickness:m.dataPoint.indexLabelLineThickness,
b=0<x?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,A={percent:null,total:null},C=null;if(0<=m.dataSeries.type.indexOf("stacked")||"pie"===m.dataSeries.type||"doughnut"===m.dataSeries.type)A=this.getPercentAndTotal(m.dataSeries,m.dataPoint);if(m.dataSeries.indexLabelFormatter||m.dataPoint.indexLabelFormatter)C={chart:this,dataSeries:m.dataSeries,dataPoint:m.dataPoint,index:m.indexKeyword,total:A.total,percent:A.percent};var D=m.dataPoint.indexLabelFormatter?
m.dataPoint.indexLabelFormatter(C):m.dataPoint.indexLabel?this.replaceKeywordsWithValue(m.dataPoint.indexLabel,m.dataPoint,m.dataSeries,null,m.indexKeyword):m.dataSeries.indexLabelFormatter?m.dataSeries.indexLabelFormatter(C):m.dataSeries.indexLabel?this.replaceKeywordsWithValue(m.dataSeries.indexLabel,m.dataPoint,m.dataSeries,null,m.indexKeyword):null;if(null!==D&&""!==D){var A=la("indexLabelPlacement",m.dataPoint,m.dataSeries),C=la("indexLabelOrientation",m.dataPoint,m.dataSeries),z=la("indexLabelTextAlign",
m.dataPoint,m.dataSeries),v=m.direction,e=m.dataSeries.axisX,f=m.dataSeries.axisY,y=!1,g=new ia(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:h?5*r:1.5*r,angle:"horizontal"===C?0:-90,text:D,padding:0,backgroundColor:g,textAlign:z,fontSize:r,fontFamily:t,fontWeight:k,fontColor:p,fontStyle:B,textBaseline:"middle"});g.measureText();m.dataSeries.indexLabelMaxWidth=g.maxWidth;if("stackedarea100"===n){if(m.point.x<c.x1||m.point.x>c.x2||m.point.y<c.y1-1||m.point.y>c.y2+1)continue}else if("rangearea"===
n||"rangesplinearea"===n){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,m.dataPoint.y)>f.viewportMaximum)continue}else if(0<=n.indexOf("line")||0<=n.indexOf("area")||0<=n.indexOf("bubble")||0<=n.indexOf("scatter")){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||m.dataPoint.y<f.viewportMinimum||m.dataPoint.y>f.viewportMaximum)continue}else if(0<=n.indexOf("column")||"waterfall"===
n||"error"===n&&!m.axisSwapped){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||m.bounds.y1>c.y2||m.bounds.y2<c.y1)continue}else if(0<=n.indexOf("bar")||"error"===n){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||m.bounds.x1>c.x2||m.bounds.x2<c.x1)continue}else if("candlestick"===n||"ohlc"===n){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,m.dataPoint.y)>f.viewportMaximum)continue}else if(m.dataPoint.x<
e.viewportMinimum||m.dataPoint.x>e.viewportMaximum)continue;p=t=2;"horizontal"===C?(B=g.width,k=g.height):(k=g.width,B=g.height);if("normal"===this.plotInfo.axisPlacement){if(0<=n.indexOf("line")||0<=n.indexOf("area"))A="auto",t=4;else if(0<=n.indexOf("stacked"))"auto"===A&&(A="inside");else if("bubble"===n||"scatter"===n)A="inside";q=m.point.x-("horizontal"===C?B/2:B/2-r/2);"inside"!==A?(e=c.y1,f=c.y2,0<v?(h=m.point.y+("horizontal"===C?r/2:0)-k-t-b,h<e&&(h="auto"===A?Math.max(m.point.y,e)+r/2+t:
e+r/2+t,y=h+k>m.point.y)):(h=m.point.y+r/2+t+b,h>f-k&&(h="auto"===A?Math.min(m.point.y,f)+r/2-k-t:f+r/2-k,y=h<m.point.y))):(e=Math.max(m.bounds.y1,c.y1),f=Math.min(m.bounds.y2,c.y2-k+r/2),b=0<=n.indexOf("range")||"error"===n?0<v?Math.max(m.bounds.y1,c.y1)+r/2+t:Math.min(m.bounds.y2,c.y2)+r/2-k+t:(Math.max(m.bounds.y1,c.y1)+Math.min(m.bounds.y2,c.y2))/2-k/2+r/2+("horizontal"===C?t:0),0<v?(h=Math.max(m.point.y,b),h<e&&("bubble"===n||"scatter"===n)&&(h=Math.max(m.point.y-k-t,c.y1+t))):(h=Math.min(m.point.y,
b),h>f-k-t&&("bubble"===n||"scatter"===n)&&(h=Math.min(m.point.y+t,c.y2-k-t))),h=Math.min(h,f))}else 0<=n.indexOf("line")||0<=n.indexOf("area")||0<=n.indexOf("scatter")?(A="auto",p=4):0<=n.indexOf("stacked")?"auto"===A&&(A="inside"):"bubble"===n&&(A="inside"),h=m.point.y+r/2-k/2+t,"inside"!==A?(e=c.x1,f=c.x2,0>v?(q=m.point.x-("horizontal"===C?B:B-r/2)-p-b,q<e&&(q="auto"===A?Math.max(m.point.x,e)+p:e+p,y=q+B>m.point.x)):(q=m.point.x+("horizontal"===C?0:r/2)+p+b,q>f-B-p-b&&(q="auto"===A?Math.min(m.point.x,
f)-("horizontal"===C?B:B/2)-p:f-B-p,y=q<m.point.x))):(e=Math.max(m.bounds.x1,c.x1),Math.min(m.bounds.x2,c.x2),b=0<=n.indexOf("range")||"error"===n?0>v?Math.max(m.bounds.x1,c.x1)+r/2+p:Math.min(m.bounds.x2,c.x2)-B/2-p+("horizontal"===C?0:r/2):(Math.max(m.bounds.x1,c.x1)+Math.min(m.bounds.x2,c.x2))/2+("horizontal"===C?0:r/2),q=0>v?Math.max(m.point.x,b)-("horizontal"===C?B/2:0):Math.min(m.point.x,b)-B/2,q=Math.max(q,e));"vertical"===C&&(h+=k-r/2);g.x=q;g.y=h;g.render(!0);x&&("inside"!==A&&(0>n.indexOf("bar")&&
("error"!==n||!m.axisSwapped)&&m.point.x>c.x1&&m.point.x<c.x2||!y)&&(0>n.indexOf("column")&&("error"!==n||m.axisSwapped)&&m.point.y>c.y1&&m.point.y<c.y2||!y))&&(d.lineWidth=x,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(N(l,x)),d.beginPath(),d.moveTo(m.point.x,m.point.y),0<=n.indexOf("bar")||"error"===n&&m.axisSwapped?d.lineTo(q+(0<m.direction?-p:B+p)+("vertical"===C?-r/2:0),h+("vertical"===C?-k/2:k/2-r/2)-t):0<=n.indexOf("column")||"error"===n&&!m.axisSwapped?d.lineTo(q+B/2-("horizontal"===
C?0:r/2),h+("vertical"===C?(h-k<m.point.y?0:-k)+t:(h-r/2<m.point.y?k:0)-r/2)):d.lineTo(q+B/2-("horizontal"===C?0:r/2),h+("vertical"===C?h-k<m.point.y?0:-k:(h-r/2<m.point.y?k:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)m=this._indexLabels[a],g=la("indexLabelBackgroundColor",m.dataPoint,m.dataSeries),m.dataSeries.indexLabelBackgroundColor=s(g)?
w?"transparent":null:g;return d};l.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],p,t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];c.lineWidth=k.lineThickness;var m=k.dataPoints,n="solid";if(c.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),
n=k.lineDashType,h=N(n,k.lineThickness);c.setLineDash(h)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=P(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,g=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var l=!0,u=0,x,s;c.beginPath();if(0<m.length){for(var C=!1,u=0;u<m.length;u++)if(x=m[u].x.getTime?m[u].x.getTime():m[u].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&
(!k.connectNullData||!C)))if("number"!==typeof m[u].y)0<u&&!(k.connectNullData||C||l)&&(c.stroke(),w&&b.stroke()),C=!0;else{x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(m[u].y);var D=k.dataPointIds[u];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:x,y1:s};l||C?(!l&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||n===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(p.x,
...
c.setLineDash(N(n,k.lineThickness))):(n=k.lineDashType,c.setLineDash(h))));if(0<m[u].markerSize||0<k.markerSize){var z=k.getMarkerProperties(u,x,s,c);f.push(z);D=P(D);w&&f.push({x:x,y:s,ctx:b,type:z.type,size:z.size,color:D,borderColor:D,borderThickness:z.borderThickness})}(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:m[u],dataSeries:k,point:{x:x,y:s},direction:0>m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();
w&&b.stroke()}}V.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,
animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],p,t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];c.lineWidth=k.lineThickness;var m=k.dataPoints,n="solid";
if(c.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),n=k.lineDashType,h=N(n,k.lineThickness);c.setLineDash(h)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=P(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,g=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var l=!0,u=0,x,s;c.beginPath();if(0<m.length){for(var C=!1,u=0;u<m.length;u++)if(x=m[u].getTime?m[u].x.getTime():
m[u].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof m[u].y)0<u&&!(k.connectNullData||C||l)&&(c.stroke(),w&&b.stroke()),C=!0;else{var D=s;x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(m[u].y);var z=k.dataPointIds[u];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:x,y1:s};l||C?(!l&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||n===k.lineDashType&&
k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(p.x,p.y),n=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,D),c.lineTo(x,s),w&&(b.lineTo(x,D),b.lineTo(x,s))):(c.beginPath(),c.moveTo(x,s),w&&(b.beginPath(),b.moveTo(x,s))),C=l=!1):(c.lineTo(x,D),w&&b.lineTo(x,D),c.lineTo(x,s),w&&b.lineTo(x,s),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),w&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));p={x:x,y:s};u<m.length-1&&(g!==(m[u].lineColor||r)||n!==(m[u].lineDashType||k.lineDashType))&&
(c.stroke(),c.beginPath(),c.moveTo(x,s),g=m[u].lineColor||r,c.strokeStyle=g,c.setLineDash&&(m[u].lineDashType?(n=m[u].lineDashType,c.setLineDash(N(n,k.lineThickness))):(n=k.lineDashType,c.setLineDash(h))));if(0<m[u].markerSize||0<k.markerSize)D=k.getMarkerProperties(u,x,s,c),f.push(D),z=P(z),w&&f.push({x:x,y:s,ctx:b,type:D.type,size:D.size,color:z,borderColor:z,borderThickness:D.borderThickness});(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",
dataPoint:m[u],dataSeries:k,point:{x:x,y:s},direction:0>m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}V.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderSpline=function(a){function d(a){a=v(a,2);if(0<a.length){b.beginPath();w&&e.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);w&&e.moveTo(a[0].x,a[0].y);for(var c=0;c<a.length-
3;c+=3)if(b.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+2].y,a[c+3].x,a[c+3].y),w&&e.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+2].y,a[c+3].x,a[c+3].y),0<c&&0===c%3E3||a[c+3].newStrokeStyle||a[c+3].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(a[c+3].x,a[c+3].y),a[c+3].newStrokeStyle&&(b.strokeStyle=a[c+3].newStrokeStyle),a[c+3].newLineDashArray&&b.setLineDash(a[c+3].newLineDashArray),w&&(e.stroke(),e.beginPath(),e.moveTo(a[c+3].x,a[c+3].y));b.stroke();w&&e.stroke()}}var c=a.targetCanvasCtx||
this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var p=[],t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];b.lineWidth=k.lineThickness;var m=k.dataPoints,n="solid";if(b.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),n=k.lineDashType,h=N(n,k.lineThickness);b.setLineDash(h)}var r=k.id;this._eventManager.objectMap[r]=
{objectType:"dataSeries",dataSeriesIndex:B};r=P(r);e.strokeStyle=r;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,g=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var l=0,u,x,s=[];b.beginPath();if(0<m.length)for(x=!1,l=0;l<m.length;l++)if(u=m[l].getTime?m[l].x.getTime():m[l].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!x)))if("number"!==typeof m[l].y)0<l&&!x&&(k.connectNullData?b.setLineDash&&(0<
s.length&&(k.options.nullDataLineDashType||!m[l-1].lineDashType))&&(s[s.length-1].newLineDashArray=q,n=k.nullDataLineDashType):(d(s),s=[])),x=!0;else{u=a.axisX.convertValueToPixel(u);x=a.axisY.convertValueToPixel(m[l].y);var C=k.dataPointIds[l];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:l,x1:u,y1:x};s[s.length]={x:u,y:x};l<m.length-1&&(g!==(m[l].lineColor||r)||n!==(m[l].lineDashType||k.lineDashType))&&(g=m[l].lineColor||r,s[s.length-1].newStrokeStyle=
g,b.setLineDash&&(m[l].lineDashType?(n=m[l].lineDashType,s[s.length-1].newLineDashArray=N(n,k.lineThickness)):(n=k.lineDashType,s[s.length-1].newLineDashArray=h)));if(0<m[l].markerSize||0<k.markerSize){var D=k.getMarkerProperties(l,u,x,b);p.push(D);C=P(C);w&&p.push({x:u,y:x,ctx:e,type:D.type,size:D.size,color:C,borderColor:C,borderThickness:D.borderThickness})}(m[l].indexLabel||k.indexLabel||m[l].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:m[l],
dataSeries:k,point:{x:u,y:x},direction:0>m[l].y===a.axisY.reversed?1:-1,color:r});x=!1}d(s)}V.drawMarkers(p);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(f.x1,f.y1,
f.width,f.height),e.beginPath());b.restore();b.beginPath();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,p,t,B,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?
this.dataPointWidth:1,m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<0,n=a.axisX.dataInfo.minDiff;isFinite(n)||(n=0.3*Math.abs(a.axisX.range));n=this.dataPointWidth=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(n)/Math.log(a.axisX.range):Math.abs(n)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&
f>m&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<f)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));n<f&&(n=f);n>m&&(n=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(m=0;m<a.dataSeriesIndexes.length;m++){var q=
a.dataSeriesIndexes[m],h=this.data[q],r=h.dataPoints;if(0<r.length)for(var g=5<n&&h.bevelEnabled?!0:!1,f=0;f<r.length;f++)if(r[f].getTime?B=r[f].x.getTime():B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){p=a.axisX.convertValueToPixel(B);t=a.axisY.convertValueToPixel(r[f].y);p=a.axisX.reversed?p+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+m)*n<<0:p-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+m)*n<<0;var l=a.axisX.reversed?
p-n<<0:p+n<<0,u;0<=r[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=r[f].color?r[f].color:h._colorSet[f%h._colorSet.length];ca(c,p,t,l,u,b,0,null,g&&0<=r[f].y,0>r[f].y&&g,!1,!1,h.fillOpacity);b=h.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:p,y1:t,x2:l,y2:u};b=P(b);w&&ca(this._eventManager.ghostCtx,p,t,l,u,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||h.indexLabel||r[f].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",
dataPoint:r[f],dataSeries:h,point:{x:p+(l-p)/2,y:0>r[f].y===a.axisY.reversed?t:u},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:p,y1:Math.min(t,u),x2:l,y2:Math.max(t,u)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};l.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,
f=[],p=[],t=[],B=[],k=0,m,n,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var h=a.axisX.dataInfo.minDiff;isFinite(h)||(h=0.3*Math.abs(a.axisX.range));h=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(h)/
Math.log(a.axisX.range):Math.abs(h)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>m&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<k)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));h<k&&(h=k);h>m&&(h=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var g=a.dataSeriesIndexes[r],l=this.data[g],u=l.dataPoints;if(0<u.length){var x=5<h&&l.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);var s=m-a.plotType.plotUnits.length*h/2+a.index*h<<0,C=s+h<<0,D;if(a.axisY.logarithmic||
a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(n=a.axisY.convertValueToPixel(t[b]),D="undefined"!==typeof f[b]?f[b]:q,f[b]=n);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=u[k].y+(B[b]?B[b]:0),D=a.axisY.convertValueToPixel(B[b]),n="undefined"!==typeof p[b]?p[b]:q,p[b]=D;else if(n=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var z="undefined"!==typeof f[b]?f[b]:0;n-=z;D=q-z;f[b]=z+(D-n)}else z=
p[b]?p[b]:0,D=n+z,n=q+z,p[b]=z+(D-n);b=u[k].color?u[k].color:l._colorSet[k%l._colorSet.length];ca(c,s,n,C,D,b,0,null,x&&0<=u[k].y,0>u[k].y&&x,!1,!1,l.fillOpacity);b=l.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:g,dataPointIndex:k,x1:s,y1:n,x2:C,y2:D};b=P(b);w&&ca(this._eventManager.ghostCtx,s,n,C,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||l.indexLabel||u[k].indexLabelFormatter||l.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",
dataPoint:u[k],dataSeries:l,point:{x:m,y:0<=u[k].y?n:D},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(n,D),x2:C,y2:Math.max(n,D)},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};l.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,
f=[],p=[],t=[],B=[],k=0,m,n,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var h=a.axisX.dataInfo.minDiff;isFinite(h)||(h=0.3*Math.abs(a.axisX.range));h=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(h)/
Math.log(a.axisX.range):Math.abs(h)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>m&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<k)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));h<k&&(h=k);h>m&&(h=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var g=a.dataSeriesIndexes[r],l=this.data[g],u=l.dataPoints;if(0<u.length)for(var x=5<h&&l.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);n=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;var s=m-a.plotType.plotUnits.length*h/
2+a.index*h<<0,C=s+h<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=n+("undefined"!==typeof t[b]?t[b]:0);if(0>=t[b])continue;n=a.axisY.convertValueToPixel(t[b]);D=f[b]?f[b]:q;f[b]=n}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=n+("undefined"!==typeof B[b]?B[b]:0),D=a.axisY.convertValueToPixel(B[b]),n=p[b]?p[b]:q,p[b]=D;else if(n=a.axisY.convertValueToPixel(n),0<=u[k].y){var z="undefined"!==typeof f[b]?
f[b]:0;n-=z;D=q-z;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y1-n)&&(n=e.y1);f[b]=z+(D-n)}else z="undefined"!==typeof p[b]?p[b]:0,D=n+z,n=q+z,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y2-D)&&(D=e.y2),p[b]=z+(D-n);b=u[k].color?u[k].color:l._colorSet[k%l._colorSet.length];ca(c,s,n,C,D,b,0,null,x&&0<=u[k].y,0>u[k].y&&x,!1,!1,l.fillOpacity);b=l.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:g,dataPointIndex:k,x1:s,y1:n,x2:C,y2:D};b=P(b);w&&ca(this._eventManager.ghostCtx,
...
this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.yScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};l.prototype.renderBar=
...
0,n=a.axisX.dataInfo.minDiff;isFinite(n)||(n=0.3*Math.abs(a.axisX.range));n=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(n)/Math.log(a.axisX.range):Math.abs(n)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>m&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<f)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));n<f&&(n=
f);n>m&&(n=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(m=0;m<a.dataSeriesIndexes.length;m++){var q=a.dataSeriesIndexes[m],h=this.data[q],r=h.dataPoints;if(0<r.length){var g=5<n&&h.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<r.length;f++)if(r[f].getTime?B=r[f].x.getTime():B=r[f].x,!(B<
a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){t=a.axisX.convertValueToPixel(B);p=a.axisY.convertValueToPixel(r[f].y);t=a.axisX.reversed?t+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+m)*n<<0:t-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+m)*n<<0;var l=a.axisX.reversed?t-n<<0:t+n<<0,u;0<=r[f].y?u=k:(u=p,p=k);b=r[f].color?r[f].color:h._colorSet[f%h._colorSet.length];ca(c,u,t,p,l,b,0,null,g,!1,!1,!1,h.fillOpacity);b=h.dataPointIds[f];
...
0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.xScaleAnimation,easingFunction:K.easing.easeOutQuart,
animationBase:k<a.axisY.bounds.x1?a.axisY.bounds.x1:k>a.axisY.bounds.x2?a.axisY.bounds.x2:k}}};l.prototype.renderStackedBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],p=[],t=[],B=[],k=0,m,n,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;n=this.options.dataPointMaxWidth?
this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0;var h=a.axisX.dataInfo.minDiff;isFinite(h)||(h=0.3*Math.abs(a.axisX.range));h=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(h)/Math.log(a.axisX.range):Math.abs(h)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>n&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&
n<k)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));h<k&&(h=k);h>n&&(h=n);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var g=a.dataSeriesIndexes[r],l=this.data[g],u=l.dataPoints;if(0<u.length){var x=5<h&&l.bevelEnabled?!0:!1;c.strokeStyle=
"#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){n=a.axisX.convertValueToPixel(b);var s=n-a.plotType.plotUnits.length*h/2+a.index*h<<0,C=s+h<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(D=f[b]?f[b]:q,f[b]=m=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0>=u[k].y)B[b]=u[k].y+(B[b]?B[b]:0),m=p[b]?p[b]:q,p[b]=D=a.axisY.convertValueToPixel(B[b]);else if(m=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var z=f[b]?f[b]:0;D=q+z;m+=z;f[b]=z+(m-D)}else z=p[b]?p[b]:0,D=m-z,m=q-z,p[b]=z+(m-D);b=u[k].color?u[k].color:l._colorSet[k%l._colorSet.length];ca(c,D,s,m,C,b,0,null,x,!1,!1,!1,l.fillOpacity);b=l.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:g,dataPointIndex:k,x1:D,y1:s,x2:m,y2:C};b=P(b);w&&ca(this._eventManager.ghostCtx,
D,s,m,C,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||l.indexLabel||u[k].indexLabelFormatter||l.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:u[k],dataSeries:l,point:{x:0<=u[k].y?m:D,y:n},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(D,m),y1:s,x2:Math.max(D,m),y2:C},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.xScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};l.prototype.renderStackedBar100=
function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],p=[],t=[],B=[],k=0,m,n,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0;var h=a.axisX.dataInfo.minDiff;
isFinite(h)||(h=0.3*Math.abs(a.axisX.range));h=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(h)/Math.log(a.axisX.range):Math.abs(h)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>n&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<k)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));h<k&&(h=k);h>n&&(h=n);c.save();w&&
this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var g=a.dataSeriesIndexes[r],l=this.data[g],u=l.dataPoints;if(0<u.length){var s=5<h&&l.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||
b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){n=a.axisX.convertValueToPixel(b);var A;A=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;var C=n-a.plotType.plotUnits.length*h/2+a.index*h<<0,D=C+h<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=A+(t[b]?t[b]:0);if(0>=t[b])continue;A=f[b]?f[b]:q;f[b]=m=a.axisY.convertValueToPixel(t[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=
A+(B[b]?B[b]:0),m=p[b]?p[b]:q,p[b]=A=a.axisY.convertValueToPixel(B[b]);else if(m=a.axisY.convertValueToPixel(A),0<=u[k].y){var z=f[b]?f[b]:0;A=q+z;m+=z;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-m)&&(m=e.x2);f[b]=z+(m-A)}else z=p[b]?p[b]:0,A=m-z,m=q-z,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-A)&&(A=e.x1),p[b]=z+(m-A);b=u[k].color?u[k].color:l._colorSet[k%l._colorSet.length];ca(c,A,C,m,D,b,0,null,s,!1,!1,!1,l.fillOpacity);b=l.dataPointIds[k];this._eventManager.objectMap[b]={id:b,
objectType:"dataPoint",dataSeriesIndex:g,dataPointIndex:k,x1:A,y1:C,x2:m,y2:D};b=P(b);w&&ca(this._eventManager.ghostCtx,A,C,m,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||l.indexLabel||u[k].indexLabelFormatter||l.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:u[k],dataSeries:l,point:{x:0<=u[k].y?m:A,y:n},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(A,m),y1:C,x2:Math.max(A,m),y2:D},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.xScaleAnimation,easingFunction:K.easing.easeOutQuart,
animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};l.prototype.renderArea=function(a){var d,c;function b(){D&&(0<h.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=A:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=A),f.lineTo(l,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=h.fillOpacity,f.fill(),f.globalAlpha=1,w&&(p.lineTo(l,C),p.lineTo(D.x,C),p.closePath(),p.fill()),f.beginPath(),f.moveTo(l,
u),p.beginPath(),p.moveTo(l,u),D={x:l,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var p=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,B=[],k=this.plotArea,m;f.save();w&&p.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(p.beginPath(),p.rect(k.x1,k.y1,k.width,k.height),p.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],h=this.data[q],r=h.dataPoints,B=h.id;this._eventManager.objectMap[B]=
{objectType:"dataSeries",dataSeriesIndex:q};B=P(B);p.fillStyle=B;B=[];d=!0;var g=0,l,u,s,A=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C,D=null;if(0<r.length){var z=h._colorSet[g%h._colorSet.length],v=h.lineColor=h.options.lineColor||z,y=v;f.fillStyle=z;f.strokeStyle=v;f.lineWidth=h.lineThickness;c="solid";if(f.setLineDash){var Q=N(h.nullDataLineDashType,h.lineThickness);c=h.lineDashType;var aa=N(c,h.lineThickness);f.setLineDash(aa)}for(var ja=!0;g<r.length;g++)if(s=
r[g].x.getTime?r[g].x.getTime():r[g].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!ja)))if("number"!==typeof r[g].y)h.connectNullData||(ja||d)||b(),ja=!0;else{l=a.axisX.convertValueToPixel(s);u=a.axisY.convertValueToPixel(r[g].y);d||ja?(!d&&h.connectNullData?(f.setLineDash&&(h.options.nullDataLineDashType||c===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(d=l,c=u,l=m.x,u=m.y,b(),f.moveTo(m.x,m.y),l=d,u=c,D=m,c=h.nullDataLineDashType,f.setLineDash(Q)),
f.lineTo(l,u),w&&p.lineTo(l,u)):(f.beginPath(),f.moveTo(l,u),w&&(p.beginPath(),p.moveTo(l,u)),D={x:l,y:u}),ja=d=!1):(f.lineTo(l,u),w&&p.lineTo(l,u),0==g%250&&b());m={x:l,y:u};g<r.length-1&&(y!==(r[g].lineColor||v)||c!==(r[g].lineDashType||h.lineDashType))&&(b(),y=r[g].lineColor||v,f.strokeStyle=y,f.setLineDash&&(r[g].lineDashType?(c=r[g].lineDashType,f.setLineDash(N(c,h.lineThickness))):(c=h.lineDashType,f.setLineDash(aa))));var Y=h.dataPointIds[g];this._eventManager.objectMap[Y]={id:Y,objectType:"dataPoint",
dataSeriesIndex:q,dataPointIndex:g,x1:l,y1:u};0!==r[g].markerSize&&(0<r[g].markerSize||0<h.markerSize)&&(s=h.getMarkerProperties(g,l,u,f),B.push(s),Y=P(Y),w&&B.push({x:l,y:u,ctx:p,type:s.type,size:s.size,color:Y,borderColor:Y,borderThickness:s.borderThickness}));(r[g].indexLabel||h.indexLabel||r[g].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[g],dataSeries:h,point:{x:l,y:u},direction:0>r[g].y===a.axisY.reversed?1:-1,color:z})}b();V.drawMarkers(B)}}w&&
(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,
easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderSplineArea=function(a){function d(){var c=v(s,2);if(0<c.length){if(0<m.lineThickness){b.beginPath();b.moveTo(c[0].x,c[0].y);c[0].newStrokeStyle&&(b.strokeStyle=c[0].newStrokeStyle);c[0].newLineDashArray&&b.setLineDash(c[0].newLineDashArray);for(var d=0;d<c.length-3;d+=3)if(b.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),w&&e.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),c[d+3].newStrokeStyle||
c[d+3].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(c[d+3].x,c[d+3].y),c[d+3].newStrokeStyle&&(b.strokeStyle=c[d+3].newStrokeStyle),c[d+3].newLineDashArray&&b.setLineDash(c[d+3].newLineDashArray);b.stroke()}b.beginPath();b.moveTo(c[0].x,c[0].y);w&&(e.beginPath(),e.moveTo(c[0].x,c[0].y));for(d=0;d<c.length-3;d+=3)b.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),w&&e.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y);a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&
0<=a.axisY.viewportMaximum?l=g:0>a.axisY.viewportMaximum?l=f.y1:0<a.axisY.viewportMinimum&&(l=g);u={x:c[0].x,y:c[0].y};b.lineTo(c[c.length-1].x,l);b.lineTo(u.x,l);b.closePath();b.globalAlpha=m.fillOpacity;b.fill();b.globalAlpha=1;w&&(e.lineTo(c[c.length-1].x,l),e.lineTo(u.x,l),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,p=[],t=this.plotArea;b.save();w&&
e.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(e.beginPath(),e.rect(t.x1,t.y1,t.width,t.height),e.clip());for(var B=0;B<a.dataSeriesIndexes.length;B++){var k=a.dataSeriesIndexes[B],m=this.data[k],n=m.dataPoints,p=m.id;this._eventManager.objectMap[p]={objectType:"dataSeries",dataSeriesIndex:k};p=P(p);e.fillStyle=p;var p=[],q=0,h,r,g=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),l,u=null,s=[];if(0<n.length){var A=m._colorSet[q%m._colorSet.length],
C=m.lineColor=m.options.lineColor||A,D=C;b.fillStyle=A;b.strokeStyle=C;b.lineWidth=m.lineThickness;var z="solid";if(b.setLineDash){var y=N(m.nullDataLineDashType,m.lineThickness),z=m.lineDashType,E=N(z,m.lineThickness);b.setLineDash(E)}for(r=!1;q<n.length;q++)if(h=n[q].x.getTime?n[q].x.getTime():n[q].x,!(h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!r)))if("number"!==typeof n[q].y)0<q&&!r&&(m.connectNullData?b.setLineDash&&(0<s.length&&(m.options.nullDataLineDashType||
!n[q-1].lineDashType))&&(s[s.length-1].newLineDashArray=y,z=m.nullDataLineDashType):(d(),s=[])),r=!0;else{h=a.axisX.convertValueToPixel(h);r=a.axisY.convertValueToPixel(n[q].y);var Q=m.dataPointIds[q];this._eventManager.objectMap[Q]={id:Q,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:h,y1:r};s[s.length]={x:h,y:r};q<n.length-1&&(D!==(n[q].lineColor||C)||z!==(n[q].lineDashType||m.lineDashType))&&(D=n[q].lineColor||C,s[s.length-1].newStrokeStyle=D,b.setLineDash&&(n[q].lineDashType?(z=
n[q].lineDashType,s[s.length-1].newLineDashArray=N(z,m.lineThickness)):(z=m.lineDashType,s[s.length-1].newLineDashArray=E)));if(0!==n[q].markerSize&&(0<n[q].markerSize||0<m.markerSize)){var aa=m.getMarkerProperties(q,h,r,b);p.push(aa);Q=P(Q);w&&p.push({x:h,y:r,ctx:e,type:aa.type,size:aa.size,color:Q,borderColor:Q,borderThickness:aa.borderThickness})}(n[q].indexLabel||m.indexLabel||n[q].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:n[q],dataSeries:m,
point:{x:h,y:r},direction:0>n[q].y===a.axisY.reversed?1:-1,color:A});r=!1}d();V.drawMarkers(p)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),
this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderStepArea=function(a){var d,c;function b(){D&&(0<h.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=A:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=A),f.lineTo(l,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=h.fillOpacity,f.fill(),f.globalAlpha=
1,w&&(p.lineTo(l,C),p.lineTo(D.x,C),p.closePath(),p.fill()),f.beginPath(),f.moveTo(l,u),p.beginPath(),p.moveTo(l,u),D={x:l,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var p=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,B=[],k=this.plotArea,m;f.save();w&&p.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(p.beginPath(),p.rect(k.x1,k.y1,k.width,k.height),p.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var q=
a.dataSeriesIndexes[n],h=this.data[q],r=h.dataPoints,B=h.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=P(B);p.fillStyle=B;B=[];d=!0;var g=0,l,u,s,A=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C,D=null;c=!1;if(0<r.length){var z=h._colorSet[g%h._colorSet.length],v=h.lineColor=h.options.lineColor||z,y=v;f.fillStyle=z;f.strokeStyle=v;f.lineWidth=h.lineThickness;var Q="solid";if(f.setLineDash){var aa=N(h.nullDataLineDashType,h.lineThickness),
Q=h.lineDashType,E=N(Q,h.lineThickness);f.setLineDash(E)}for(;g<r.length;g++)if(s=r[g].x.getTime?r[g].x.getTime():r[g].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!c))){var Y=u;"number"!==typeof r[g].y?(h.connectNullData||(c||d)||b(),c=!0):(l=a.axisX.convertValueToPixel(s),u=a.axisY.convertValueToPixel(r[g].y),d||c?(!d&&h.connectNullData?(f.setLineDash&&(h.options.nullDataLineDashType||Q===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(d=l,
c=u,l=m.x,u=m.y,b(),f.moveTo(m.x,m.y),l=d,u=c,D=m,Q=h.nullDataLineDashType,f.setLineDash(aa)),f.lineTo(l,Y),f.lineTo(l,u),w&&(p.lineTo(l,Y),p.lineTo(l,u))):(f.beginPath(),f.moveTo(l,u),w&&(p.beginPath(),p.moveTo(l,u)),D={x:l,y:u}),c=d=!1):(f.lineTo(l,Y),w&&p.lineTo(l,Y),f.lineTo(l,u),w&&p.lineTo(l,u),0==g%250&&b()),m={x:l,y:u},g<r.length-1&&(y!==(r[g].lineColor||v)||Q!==(r[g].lineDashType||h.lineDashType))&&(b(),y=r[g].lineColor||v,f.strokeStyle=y,f.setLineDash&&(r[g].lineDashType?(Q=r[g].lineDashType,
f.setLineDash(N(Q,h.lineThickness))):(Q=h.lineDashType,f.setLineDash(E)))),s=h.dataPointIds[g],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:g,x1:l,y1:u},0!==r[g].markerSize&&(0<r[g].markerSize||0<h.markerSize)&&(Y=h.getMarkerProperties(g,l,u,f),B.push(Y),s=P(s),w&&B.push({x:l,y:u,ctx:p,type:Y.type,size:Y.size,color:s,borderColor:s,borderThickness:Y.borderThickness})),(r[g].indexLabel||h.indexLabel||r[g].indexLabelFormatter||h.indexLabelFormatter)&&
this._indexLabels.push({chartType:"stepArea",dataPoint:r[g],dataSeries:h,point:{x:l,y:u},direction:0>r[g].y===a.axisY.reversed?1:-1,color:z}))}b();V.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),f.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<z.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(s.closePath(),
...
a.dataSeriesIndexes[C],z=this.data[D],v=z.dataPoints;z.dataPointIndexes=[];for(q=0;q<v.length;q++)D=v[q].x.getTime?v[q].x.getTime():v[q].x,z.dataPointIndexes[D]=q,e[D]||(m.push(D),e[D]=!0);m.sort(Pa)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];z=this.data[D];v=z.dataPoints;x=!0;k=[];q=z.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=P(q);s.fillStyle=q;if(0<m.length){var e=z._colorSet[0],y=z.lineColor=z.options.lineColor||e,Q=y;b.fillStyle=e;
b.strokeStyle=y;b.lineWidth=z.lineThickness;A="solid";if(b.setLineDash){var aa=N(z.nullDataLineDashType,z.lineThickness);A=z.lineDashType;var E=N(A,z.lineThickness);b.setLineDash(E)}for(var Y=!0,q=0;q<m.length;q++){var f=m[q],fa=null,fa=0<=z.dataPointIndexes[f]?v[z.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!z.connectNullData||!Y)))if("number"!==typeof fa.y)z.connectNullData||(Y||x)||d(),Y=!0;else{h=a.axisX.convertValueToPixel(f);var ma=
g[f]?g[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){n[f]=fa.y+(n[f]?n[f]:0);if(0>=n[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(n[f])}else r=a.axisY.convertValueToPixel(fa.y),r-=ma;k.push({x:h,y:l-ma});g[f]=l-r;x||Y?(!x&&z.connectNullData?(b.setLineDash&&(z.options.nullDataLineDashType||A===z.lineDashType&&z.lineDashType!==z.nullDataLineDashType)&&(x=k.pop(),A=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(A),k.push(x),A=z.nullDataLineDashType,
...
z.lineDashType,b.setLineDash(E))));if(0<=z.dataPointIndexes[f]){var F=z.dataPointIds[z.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:z.dataPointIndexes[f],x1:h,y1:r}}0<=z.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<z.markerSize)&&(ma=z.getMarkerProperties(z.dataPointIndexes[f],h,r,b),p.push(ma),f=P(F),w&&p.push({x:h,y:r,ctx:s,type:ma.type,size:ma.size,color:f,borderColor:f,borderThickness:ma.borderThickness}));(fa.indexLabel||
z.indexLabel||fa.indexLabelFormatter||z.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:fa,dataSeries:z,point:{x:h,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(h,r);w&&s.moveTo(h,r)}delete z.dataPointIndexes}V.drawMarkers(p);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderStackedArea100=function(a){function d(){for(0<z.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&A.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=
z.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(A.closePath(),A.fill(),A.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,p=this.plotArea,t=[],g=[],k=[],m=[],n=[],q=0,h,r,l,s,u,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),A=this._eventManager.ghostCtx;b.save();w&&A.save();b.beginPath();b.rect(p.x1,p.y1,p.width,p.height);b.clip();w&&(A.beginPath(),A.rect(p.x1,p.y1,p.width,
p.height),A.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var v=a.dataSeriesIndexes[C],z=this.data[v],y=z.dataPoints;z.dataPointIndexes=[];for(q=0;q<y.length;q++)v=y[q].x.getTime?y[q].x.getTime():y[q].x,z.dataPointIndexes[v]=q,e[v]||(m.push(v),e[v]=!0);m.sort(Pa)}for(C=0;C<a.dataSeriesIndexes.length;C++){v=a.dataSeriesIndexes[C];z=this.data[v];y=z.dataPoints;s=!0;e=z.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:v};e=P(e);A.fillStyle=e;k=[];if(0<m.length){var e=
z._colorSet[q%z._colorSet.length],E=z.lineColor=z.options.lineColor||e,Q=E;b.fillStyle=e;b.strokeStyle=E;b.lineWidth=z.lineThickness;u="solid";if(b.setLineDash){var aa=N(z.nullDataLineDashType,z.lineThickness);u=z.lineDashType;var F=N(u,z.lineThickness);b.setLineDash(F)}for(var Y=!0,q=0;q<m.length;q++){var f=m[q],fa=null,fa=0<=z.dataPointIndexes[f]?y[z.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!z.connectNullData||!Y)))if("number"!==typeof fa.y)z.connectNullData||
...
"source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(p.x1,p.y1,p.width,p.height),A.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderBubble=function(a){var d=
...
f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);p=a.axisY.convertValueToPixel(q[e].y);var h=q[e].z,s=2*Math.max(Math.sqrt((t===g?l/2:r+(l-r)/(t-g)*(h-g))/Math.PI)<<0,1),h=n.getMarkerProperties(e,c);h.size=s;c.globalAlpha=n.fillOpacity;V.drawMarker(f,p,c,h.type,h.size,h.color,h.borderColor,h.borderThickness);c.globalAlpha=1;var u=n.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:e,x1:f,y1:p,size:s};
...
0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};l.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,
c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,p;c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var g=a.dataSeriesIndexes[t],k=this.data[g],m=k.dataPoints;if(0<m.length){c.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,
b.width)/2,2);for(var n=0,q=0,e=0;e<m.length;e++)if(f=m[e].getTime?f=m[e].x.getTime():f=m[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof m[e].y){f=a.axisX.convertValueToPixel(f);p=a.axisY.convertValueToPixel(m[e].y);var h=k.getMarkerProperties(e,f,p,c);c.globalAlpha=k.fillOpacity;V.drawMarker(h.x,h.y,h.ctx,h.type,h.size,h.color,h.borderColor,h.borderThickness);c.globalAlpha=1;Math.sqrt((n-f)*(n-f)+(q-p)*(q-p))<Math.min(h.size,5)&&m.length>Math.min(this.plotArea.width,
...
animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};l.prototype.renderCandlestick=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,p=this.plotArea,t=0,g,k,m,n,q,h,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,f=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?
...
0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),b.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};l.prototype.renderRangeColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,p,t,g,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:
...
5<k&&q.bevelEnabled?!0:!1,f=0;f<h.length;f++)if(h[f].getTime?g=h[f].x.getTime():g=h[f].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(h[f].y)&&h[f].y.length&&"number"===typeof h[f].y[0]&&"number"===typeof h[f].y[1]){b=a.axisX.convertValueToPixel(g);p=a.axisY.convertValueToPixel(h[f].y[0]);t=a.axisY.convertValueToPixel(h[f].y[1]);var l=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+m)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+
m)*k<<0,v=a.axisX.reversed?l-k<<0:l+k<<0,b=h[f].color?h[f].color:q._colorSet[f%q._colorSet.length];if(p>t){var u=p;p=t;t=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:f,x1:l,y1:p,x2:v,y2:t};ca(c,l,p,v,t,b,0,b,r,r,!1,!1,q.fillOpacity);b=P(u);w&&ca(this._eventManager.ghostCtx,l,p,v,t,b,0,null,!1,!1,!1,!1);if(h[f].indexLabel||q.indexLabel||h[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",
dataPoint:h[f],dataSeries:q,indexKeyword:0,point:{x:l+(v-l)/2,y:h[f].y[1]>=h[f].y[0]?t:p},direction:h[f].y[1]>=h[f].y[0]?-1:1,bounds:{x1:l,y1:Math.min(p,t),x2:v,y2:Math.max(p,t)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:h[f],dataSeries:q,indexKeyword:1,point:{x:l+(v-l)/2,y:h[f].y[1]>=h[f].y[0]?p:t},direction:h[f].y[1]>=h[f].y[0]?1:-1,bounds:{x1:l,y1:Math.min(p,t),x2:v,y2:Math.max(p,t)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};l.prototype.renderError=
...
D[t].stemDashType:C.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;D[t].getTime?r=D[t].x.getTime():r=D[t].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(D[t].y)&&D[t].y.length&&"number"===typeof D[t].y[0]&&"number"===typeof D[t].y[1]){var ja=a.axisX.convertValueToPixel(r);b?k=ja:g=ja;ja=a.axisY.convertValueToPixel(D[t].y[0]);b?m=ja:q=ja;ja=a.axisY.convertValueToPixel(D[t].y[1]);b?n=ja:h=ja;b?(q=a.axisX.reversed?k+(z?
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};l.prototype.renderRangeArea=function(a){function d(){if(x){for(var a=null,c=g.length-1;0<=c;c--)a=g[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=m.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<m.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<g.length;c++)a=g[c],
b.lineTo(a.x,a.y2);b.moveTo(g[0].x,g[0].y1);for(c=0;c<g.length;c++)a=g[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(r,l);e.beginPath();e.moveTo(r,l);x={x:r,y:l};g=[];g.push({x:r,y1:l,y2:s})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],p=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(p.x1,p.y1,p.width,p.height);b.clip();w&&(e.beginPath(),e.rect(p.x1,p.y1,p.width,p.height),e.clip());
for(var t=0;t<a.dataSeriesIndexes.length;t++){var g=[],k=a.dataSeriesIndexes[t],m=this.data[k],n=m.dataPoints,f=m.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=P(f);e.fillStyle=f;var f=[],q=!0,h=0,r,l,s,u,x=null;if(0<n.length){var v=m._colorSet[h%m._colorSet.length],C=m.lineColor=m.options.lineColor||v,D=C;b.fillStyle=v;b.strokeStyle=C;b.lineWidth=m.lineThickness;var z="solid";if(b.setLineDash){var y=N(m.nullDataLineDashType,m.lineThickness),z=m.lineDashType,E=N(z,
m.lineThickness);b.setLineDash(E)}for(var Q=!0;h<n.length;h++)if(u=n[h].x.getTime?n[h].x.getTime():n[h].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!Q)))if(null!==n[h].y&&n[h].y.length&&"number"===typeof n[h].y[0]&&"number"===typeof n[h].y[1]){r=a.axisX.convertValueToPixel(u);l=a.axisY.convertValueToPixel(n[h].y[0]);s=a.axisY.convertValueToPixel(n[h].y[1]);q||Q?(m.connectNullData&&!q?(b.setLineDash&&(m.options.nullDataLineDashType||z===m.lineDashType&&
...
1&&(D!==(n[h].lineColor||C)||z!==(n[h].lineDashType||m.lineDashType))&&(d(),D=n[h].lineColor||C,g[g.length-1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&(n[h].lineDashType?(z=n[h].lineDashType,g[g.length-1].newLineDashArray=N(z,m.lineThickness),b.setLineDash(g[g.length-1].newLineDashArray)):(z=m.lineDashType,g[g.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==n[h].markerSize&&(0<n[h].markerSize||0<m.markerSize)){var aa=m.getMarkerProperties(h,r,s,b);f.push(aa);var F=P(u);w&&f.push({x:r,
y:s,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness});aa=m.getMarkerProperties(h,r,l,b);f.push(aa);F=P(u);w&&f.push({x:r,y:l,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness})}if(n[h].indexLabel||m.indexLabel||n[h].indexLabelFormatter||m.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:n[h],dataSeries:m,indexKeyword:0,point:{x:r,y:l},direction:n[h].y[0]>n[h].y[1]===a.axisY.reversed?-1:1,color:v}),
this._indexLabels.push({chartType:"rangeArea",dataPoint:n[h],dataSeries:m,indexKeyword:1,point:{x:r,y:s},direction:n[h].y[0]>n[h].y[1]===a.axisY.reversed?1:-1,color:v})}else Q||q||d(),Q=!0;d();V.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(p.x1,p.y1,p.width,p.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderRangeSplineArea=function(a){function d(a,c){var d=v(l,2);if(0<d.length){if(0<k.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var f=0;f<d.length-3;f+=3){if(d[f].newStrokeStyle||d[f].newLineDashArray)b.stroke(),
...
b.moveTo(d[f].x,d[f].y),l[h].newStrokeStyle&&(b.strokeStyle=l[h].newStrokeStyle),l[h].newLineDashArray&&b.setLineDash(l[h].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}d=v(l,2);b.moveTo(d[0].x,d[0].y);for(h=f=0;f<d.length-3;f+=3,h++){if(l[h].newStrokeStyle||l[h].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),l[h].newStrokeStyle&&(b.strokeStyle=l[h].newStrokeStyle),l[h].newLineDashArray&&b.setLineDash(l[h].newLineDashArray);b.bezierCurveTo(d[f+
...
1].newStrokeStyle=A,b.setLineDash&&(m[n].lineDashType?(C=m[n].lineDashType,l[l.length-1].newLineDashArray=N(C,k.lineThickness)):(C=k.lineDashType,l[l.length-1].newLineDashArray=D)));if(0!==m[n].markerSize&&(0<m[n].markerSize||0<k.markerSize)){var E=k.getMarkerProperties(n,q,h,b);f.push(E);var Q=P(y);w&&f.push({x:q,y:h,ctx:e,type:E.type,size:E.size,color:Q,borderColor:Q,borderThickness:E.borderThickness});E=k.getMarkerProperties(n,q,r,b);f.push(E);Q=P(y);w&&f.push({x:q,y:r,ctx:e,type:E.type,size:E.size,
color:Q,borderColor:Q,borderThickness:E.borderThickness})}if(m[n].indexLabel||k.indexLabel||m[n].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:m[n],dataSeries:k,indexKeyword:0,point:{x:q,y:h},direction:m[n].y[0]<=m[n].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:m[n],dataSeries:k,indexKeyword:1,point:{x:q,y:r},direction:m[n].y[0]<=m[n].y[1]?1:-1,color:u});h=!1}else 0<n&&!h&&(k.connectNullData?b.setLineDash&&
(0<l.length&&(k.options.nullDataLineDashType||!m[n-1].lineDashType))&&(l[l.length-1].newLineDashArray=z,C=k.nullDataLineDashType):(d(D,x),l=[],s=[])),h=!0;d(D,x);V.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(p.x1,p.y1,p.width,p.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};l.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,f=this.plotArea,p=0,t,g,k,m,n=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
animationBase:0}}};var ga=function(a,d,c,b,e,f,p,g,l){if(!(0>c)){"undefined"===typeof g&&(g=1);if(!w){var k=Number((p%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===k&&(p-=1E-4)}a.save();a.globalAlpha=g;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,f,p,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,c,f,p,!1),0<=l&&a.arc(d.x,d.y,l*c,p,f,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=
2,a.fill());a.globalAlpha=1;a.restore()}};l.prototype.renderPie=function(a){function d(){if(k&&m){for(var a=0,b=0,c=0,d=0,e=0;e<m.length;e++){var f=m[e],p=k.dataPointIds[e];h[e].id=p;h[e].objectType="dataPoint";h[e].dataPointIndex=e;h[e].dataSeriesIndex=0;var g=h[e],n={percent:null,total:null},t=null,n=l.getPercentAndTotal(k,f);if(k.indexLabelFormatter||f.indexLabelFormatter)t={chart:l.options,dataSeries:k,dataPoint:f,total:n.total,percent:n.percent};n=f.indexLabelFormatter?f.indexLabelFormatter(t):
...
3*Math.PI/2-u&&g.midAngle<3*Math.PI/2+u){if(0===b||h[d].midAngle>g.midAngle)d=e;b++}g.hemisphere=f>Math.PI/2&&f<=3*Math.PI/2?"left":"right";g.indexLabelTextBlock=new ia(l.plotArea.ctx,{fontSize:g.indexLabelFontSize,fontFamily:g.indexLabelFontFamily,fontColor:g.indexLabelFontColor,fontStyle:g.indexLabelFontStyle,fontWeight:g.indexLabelFontWeight,textAlign:g.indexLabelTextAlign,backgroundColor:g.indexLabelBackgroundColor,maxWidth:g.indexLabelMaxWidth,maxHeight:g.indexLabelWrap?5*g.indexLabelFontSize:
1.5*g.indexLabelFontSize,text:g.indexLabelText,padding:0,textBaseline:"top"});g.indexLabelTextBlock.measureText()}p=f=0;n=!1;for(e=0;e<m.length;e++)g=h[(c+e)%m.length],1<a&&(g.midAngle>Math.PI/2-u&&g.midAngle<Math.PI/2+u)&&(f<=a/2&&!n?(g.hemisphere="right",f++):(g.hemisphere="left",n=!0));n=!1;for(e=0;e<m.length;e++)g=h[(d+e)%m.length],1<b&&(g.midAngle>3*Math.PI/2-u&&g.midAngle<3*Math.PI/2+u)&&(p<=b/2&&!n?(g.hemisphere="left",p++):(g.hemisphere="right",n=!0))}}function c(a){var b=l.plotArea.ctx;b.clearRect(q.x1,
q.y1,q.width,q.height);b.fillStyle=l.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(b=0;b<m.length;b++){var c=h[b].startAngle,d=h[b].endAngle;if(d>c){var e=0.07*z*Math.cos(h[b].midAngle),f=0.07*z*Math.sin(h[b].midAngle),p=!1;if(m[b].exploded){if(1E-9<Math.abs(h[b].center.x-(A.x+e))||1E-9<Math.abs(h[b].center.y-(A.y+f)))h[b].center.x=A.x+e*a,h[b].center.y=A.y+f*a,p=!0}else if(0<Math.abs(h[b].center.x-A.x)||0<Math.abs(h[b].center.y-A.y))h[b].center.x=A.x+e*(1-a),h[b].center.y=A.y+f*(1-a),
p=!0;p&&(e={},e.dataSeries=k,e.dataPoint=k.dataPoints[b],e.index=b,l.toolTip.highlightObjects([e]));ga(l.plotArea.ctx,h[b].center,h[b].radius,m[b].color?m[b].color:k._colorSet[b%k._colorSet.length],k.type,c,d,k.fillOpacity,h[b].percentInnerRadius)}}a=l.plotArea.ctx;a.save();a.fillStyle="black";a.strokeStyle="grey";a.textBaseline="middle";a.lineJoin="round";for(b=b=0;b<m.length;b++)c=h[b],c.indexLabelText&&(c.indexLabelTextBlock.y-=c.indexLabelTextBlock.height/2,d=0,d="left"===c.hemisphere?"inside"!==
...
b.indexLabelTextBlock.height/2;return c=b.indexLabelTextBlock.y>a.indexLabelTextBlock.y?e-d:c-f}function e(a){for(var c=null,d=1;d<m.length;d++)if(c=(a+d+h.length)%h.length,h[c].hemisphere!==h[a].hemisphere){c=null;break}else if(h[c].indexLabelText&&c!==a&&(0>b(h[c],h[a])||("right"===h[a].hemisphere?h[c].indexLabelTextBlock.y>=h[a].indexLabelTextBlock.y:h[c].indexLabelTextBlock.y<=h[a].indexLabelTextBlock.y)))break;else c=null;return c}function f(a,c,d){d=(d||0)+1;if(1E3<d)return 0;c=c||0;var k=0,
p=A.y-1*w,g=A.y+1*w;if(0<=a&&a<m.length){var n=h[a];if(0>c&&n.indexLabelTextBlock.y<p||0<c&&n.indexLabelTextBlock.y>g)return 0;var q=0,t=0,t=q=q=0;0>c?n.indexLabelTextBlock.y-n.indexLabelTextBlock.height/2>p&&n.indexLabelTextBlock.y-n.indexLabelTextBlock.height/2+c<p&&(c=-(p-(n.indexLabelTextBlock.y-n.indexLabelTextBlock.height/2+c))):n.indexLabelTextBlock.y+n.indexLabelTextBlock.height/2<p&&n.indexLabelTextBlock.y+n.indexLabelTextBlock.height/2+c>g&&(c=n.indexLabelTextBlock.y+n.indexLabelTextBlock.height/
...
15)),n.indexLabelTextBlock.y=d,n.indexLabelTextBlock.x=c,n.indexLabelAngle=Math.atan2(n.indexLabelTextBlock.y-A.y,n.indexLabelTextBlock.x-A.x))}return k}function p(){var a=l.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,p=!0,c=0;10>c&&(1>c||0<d);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&z-d<=y)p=!1;p&&(z-=d);d=0;if("inside"!==k.indexLabelPlacement){w=z*v;for(a=0;a<m.length;a++){var g=
h[a];g.indexLabelTextBlock.x=A.x+w*Math.cos(g.midAngle);g.indexLabelTextBlock.y=A.y+w*Math.sin(g.midAngle);g.indexLabelAngle=g.midAngle;g.radius=z;g.percentInnerRadius=E}for(var t,u,a=0;a<m.length;a++){var g=h[a],s=e(a);if(null!==s){t=h[a];u=h[s];var C=0,C=b(t,u)-r;if(0>C){for(var D=u=0,F=0;F<m.length;F++)F!==a&&h[F].hemisphere===g.hemisphere&&(h[F].indexLabelTextBlock.y<g.indexLabelTextBlock.y?u++:D++);u=C/(u+D||1)*D;var D=-1*(C-u),J=F=0;"right"===g.hemisphere?(F=f(a,u),D=-1*(C-F),J=f(s,D),+J.toFixed(x)<
...
b,c){for(var d=[],e=0;d.push(h[b]),b!==c;b=(b+1+m.length)%m.length);d.sort(function(a,b){return a.y-b.y});for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,d=0,f=!1,k=0;k<m.length;k++)if(f=!1,t=h[k],t.indexLabelText){var p=e(k);if(null!==p){var g=h[p];C=0;C=b(t,g);var q;if(q=0>C){q=t.indexLabelTextBlock.x;var l=t.indexLabelTextBlock.y-t.indexLabelTextBlock.height/
2,r=t.indexLabelTextBlock.y+t.indexLabelTextBlock.height/2,s=g.indexLabelTextBlock.y-g.indexLabelTextBlock.height/2,u=g.indexLabelTextBlock.x+g.indexLabelTextBlock.width,B=g.indexLabelTextBlock.y+g.indexLabelTextBlock.height/2;q=t.indexLabelTextBlock.x+t.indexLabelTextBlock.width<g.indexLabelTextBlock.x-n||q>u+n||l>B+n||r<s-n?!1:!0}q?(0>a&&(a=k),p!==a&&(c=p,d+=-C),0===k%Math.max(m.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(H(d,a,c),c=a=-1,d=0)}}0<d&&H(d,a,c)})()}}function g(){l.plotArea.layoutManager.reset();
...
500,function(a){c(a);g();l.dispatchEvent("dataAnimationIterationEnd",{chart:l});l.dispatchEvent("dataAnimationEnd",{chart:l})}))};d();p();p();p();p();this.disableToolTip=!0;this._animator.animate(0,this.animatedRender?this.animationDuration:0,function(a){var b=l.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=l.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(var b=h[0].startAngle+2*Math.PI*a,c=0;c<m.length;c++){var d=0===c?h[c].startAngle:e,e=d+(h[c].endAngle-h[c].startAngle),
f=!1;e>b&&(e=b,f=!0);var p=m[c].color?m[c].color:k._colorSet[c%k._colorSet.length];e>d&&ga(l.plotArea.ctx,h[c].center,h[c].radius,p,k.type,d,e,k.fillOpacity,h[c].percentInnerRadius);if(f)break}g();l.dispatchEvent("dataAnimationIterationEnd",{chart:l});1<=a&&l.dispatchEvent("dataAnimationEnd",{chart:l})},function(){l.disableToolTip=!1;l._animator.animate(0,l.animatedRender?500:0,function(a){c(a);g();l.dispatchEvent("dataAnimationIterationEnd",{chart:l})});l.dispatchEvent("dataAnimationEnd",{chart:l})})}}};
...
function(a){function d(){for(var a=0,b=[],c=0;c<x.length;c++){if("undefined"===typeof x[c].y)return-1;x[c].y="number"===typeof x[c].y?x[c].y:0;a+=Math.abs(x[c].y)}if(0===a)return-1;for(c=b[0]=0;c<x.length;c++)b.push(Math.abs(x[c].y)*E/a);return b}function c(){var a=W,b=Z,c=L,d=V,e,f;e=Y;f=P-ba;d=Math.abs((f-e)*(b-a+(d-c))/2);c=V-L;e=f-e;f=c*(f-P);f=Math.abs(f);f=d+f;for(var d=[],h=0,k=0;k<x.length;k++){if("undefined"===typeof x[k].y)return-1;x[k].y="number"===typeof x[k].y?x[k].y:0;h+=Math.abs(x[k].y)}if(0===
h)return-1;for(var p=d[0]=0,g=0,m,n,b=b-a,p=!1,k=0;k<x.length;k++)a=Math.abs(x[k].y)*f/h,p?m=0==Number(c.toFixed(3))?0:a/c:(n=$*$*b*b-4*Math.abs($)*a,0>n?(n=c,p=(b+n)*(e-g)/2,a-=p,m=e-g,g+=e-g,m+=0==n?0:a/n,g+=a/n,p=!0):(m=(Math.abs($)*b-Math.sqrt(n))/2,n=b-2*m/Math.abs($),g+=m,g>e&&(g-=m,n=c,p=(b+n)*(e-g)/2,a-=p,m=e-g,g+=e-g,m+=a/n,g+=a/n,p=!0),b=n)),d.push(m);return d}function b(){if(u&&x){for(var a,b,c,d,e,f,k,p,g,m,n,q,t,l,r,B=[],v=[],A={percent:null,total:null},C=null,z=0;z<x.length;z++)r=O[z],
...
e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function g(a,b){return(b<O.length?I[b].textBlock.y:u.reversed?na+C:sa+C)-(0>a?u.reversed?sa-C:na-C:I[a].textBlock.y+I[a].height+da)}function l(a,b,c){var d,e,h,p=[],g=C,n=[];-1!==b&&(0<=X.indexOf(b)?(e=X.indexOf(b),X.splice(e,1)):(X.push(b),X=X.sort(function(a,b){return a-b})));if(0===X.length)p=ga;else{e=C*(1!=X.length||0!=X[0]&&X[0]!=O.length-1?2:1)/k();for(var t=0;t<O.length;t++){if(1==X.length&&0==X[0]){if(0===t){p.push(ga[t]);d=g;continue}}else 0===
...
typeof ba&&ba.match(/%$/)?(ba=parseInt(ba),ba=ba*E/100):ba=parseInt(ba),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),ba>E?ba=E:0>=ba&&(ba=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===u.type&&(G=ba=0,u.reversed=u.reversed?!1:!0);var D=H+a/2,W=H,Z=H+a,na=u.reversed?P:Y,L=D-G/2,V=D+G/2,xa=u.reversed?Y+ba:P-ba,sa=u.reversed?Y:P;a=[];var D=[],O=[],F=[],T=Y,ca,$=(xa-na)/(L-W),ea=-$,H="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==H){if(u.reversed)for(F.push(T),
G=H.length-1;0<G;G--)T+=H[G],F.push(T);else for(G=0;G<H.length;G++)T+=H[G],F.push(T);if(u.reversed)for(G=0;G<H.length;G++)F[G]<xa?(a.push(L),D.push(V),ca=G):(a.push((F[G]-na+$*W)/$),D.push((F[G]-na+ea*Z)/ea));else for(G=0;G<H.length;G++)F[G]<xa?(a.push((F[G]-na+$*W)/$),D.push((F[G]-na+ea*Z)/ea),ca=G):(a.push(L),D.push(V));for(G=0;G<H.length-1;G++)T=u.reversed?x[x.length-1-G].color?x[x.length-1-G].color:u._colorSet[(x.length-1-G)%u._colorSet.length]:x[G].color?x[G].color:u._colorSet[G%u._colorSet.length],
G===ca?O.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:V,y3:xa,x4:D[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],x6:L,y6:xa,id:G,height:F[G+1]-F[G],color:T}):O.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:D[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:T});var da=2,I=[],ha=!1,X=[],ga=[],H=!1;a=a=0;Ca(X);for(G=0;G<x.length;G++)x[G].exploded&&(H=!0,u.reversed?X.push(x.length-1-G):X.push(G));R.clearRect(A.x1,A.y1,A.width,A.height);R.fillStyle=y.backgroundColor;R.fillRect(A.x1,A.y1,A.width,A.height);
...
this.exportFileName;if(a.toDataURL)return this.canvas.toDataURL("image/"+d);var b=this.canvas;if(b&&d&&c){c=c+"."+d;a="image/"+d;var b=b.toDataURL(a),e=!1,f=document.createElement("a");f.download=c;f.href=b;if("undefined"!==typeof Blob&&new Blob){for(var p=b.replace(/^data:[a-z\/]*;base64,/,""),p=atob(p),g=new ArrayBuffer(p.length),g=new Uint8Array(g),l=0;l<p.length;l++)g[l]=p.charCodeAt(l);d=new Blob([g.buffer],{type:"image/"+d});try{window.navigator.msSaveBlob(d,c),e=!0}catch(k){f.dataset.downloadurl=
...
e=isNaN(d.y)?0:100*(d.y/b)}return{percent:e,total:b}};l.prototype.replaceKeywordsWithValue=function(a,d,c,b,e){var f=this;e="undefined"===typeof e?0:e;if((0<=c.type.indexOf("stacked")||"pie"===c.type||"doughnut"===c.type||"funnel"===c.type||"pyramid"===c.type)&&(0<=a.indexOf("#percent")||0<=a.indexOf("#total"))){var p="#percent",g="#total",l=this.getPercentAndTotal(c,d),g=isNaN(l.total)?g:l.total,p=isNaN(l.percent)?p:l.percent;do{l="";if(c.percentFormatString)l=c.percentFormatString;else{var l="#,##0.",
k=Math.max(Math.ceil(Math.log(1/Math.abs(p))/Math.LN10),2);if(isNaN(k)||!isFinite(k))k=2;for(var m=0;m<k;m++)l+="#";c.percentFormatString=l}a=a.replace("#percent",ea(p,l,f._cultureInfo));a=a.replace("#total",ea(g,c.yValueFormatString?c.yValueFormatString:"#,##0.########",f._cultureInfo))}while(0<=a.indexOf("#percent")||0<=a.indexOf("#total"))}return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,function(a){if('"'===a[0]&&'"'===a[a.length-1]||"'"===a[0]&&"'"===a[a.length-1])return a.slice(1,a.length-1);a=Fa(a.slice(1,
...
d.x1:"right"===this.horizontalAlign?d.x2-this.width:d.x1+d.width/2-this.width/2,b=d.y2-this.height);this.items=l;for(m=0;m<this.items.length;m++)q=l[m],q.id=++this.chart._eventManager.lastObjectId,this.chart._eventManager.objectMap[q.id]={id:q.id,objectType:"legendItem",legendItemIndex:m,dataSeriesIndex:q.dataSeriesIndex,dataPointIndex:q.dataPointIndex};this.markerSize=w;this.rows=k;0<l.length&&a.layoutManager.registerSpace(c,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:e,y1:b,x2:e+
...
Math.abs(q.x2-a),Math.abs(q.y2-d),Math.abs(q.y3-d))}),g=!0}if(g||1E3<k&&1E3<m)break}}else if(0>n-e&&n+e>=this.dataPoints.length)break;-1===p?(e++,p=1):p=-1}a=null;for(d=0;d<b.length;d++)a?b[d].distance<=a.distance&&(a=b[d]):a=b[d];return a};H.prototype.getMarkerProperties=function(a,d,c,b){var e=this.dataPoints;return{x:d,y:c,ctx:b,type:e[a].markerType?e[a].markerType:this.markerType,size:e[a].markerSize?e[a].markerSize:this.markerSize,color:e[a].markerColor?e[a].markerColor:this.markerColor?this.markerColor:
...
this.logLabelValues[b],c<this.viewportMinimum)b++;else{for(;h<n.length&&c>n[h].endValue;h++);a=h<n.length&&c>=n[h].startValue&&c<=n[h].endValue;m=c;a||(a=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.options,value:m,label:this.labels[m]?this.labels[m]:null}):"axisX"===this.type&&this.labels[m]?this.labels[m]:ea(m,this.valueFormatString,this.chart._cultureInfo),a=new ia(this.ctx,{x:0,y:0,maxWidth:f,maxHeight:p,angle:this.labelAngle,text:this.prefix+a+this.suffix,backgroundColor:this.labelBackgroundColor,
...
this.interval):c+this.interval:(this.logarithmic&&this.equidistantInterval?c*Math.pow(this.logarithmBase,this.interval):c+this.interval).toFixed(12))){for(;h<n.length&&c>n[h].endValue;h++);a=h<n.length&&c>=n[h].startValue&&c<=n[h].endValue;m=c;a||(a=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.options,value:m,label:this.labels[m]?this.labels[m]:null}):"axisX"===this.type&&this.labels[m]?this.labels[m]:ea(m,this.valueFormatString,this.chart._cultureInfo),a=new ia(this.ctx,{x:0,
...
!0,b=0;b<this._labels.length;b++)a=this._labels[b].textBlock,a.maxWidth=this.sessionVariables.labelMaxWidth=Math.min(Math.max(f,q),m),r=a.measureText(),b<this._labels.length-1&&(h=b+1,d=this._labels[h].textBlock,d.maxWidth=this.sessionVariables.labelMaxWidth=Math.min(Math.max(f,q),m),d=d.measureText(),r.width+d.width>>0>2*f&&(this.sessionVariables.labelAngle=-25))}else(this.sessionVariables.labelAngle=this.labelAngle,this.sessionVariables.labelMaxHeight=0===this.labelAngle?p:Math.min((b-f*Math.cos(Math.PI/
...
2:0)+a+("inside"===this.tickPlacement?0:this.tickLength)+b};E.setLayout=function(a,d,c,b,e,f){var p,g,l,k,m=a[0]?a[0].chart:d[0].chart,n=m.isNavigator?0:10,q=m._axes;if(a&&0<a.length)for(var h=0;h<a.length;h++)a[h]&&a[h].calculateAxisParameters();if(d&&0<d.length)for(h=0;h<d.length;h++)d[h].calculateAxisParameters();if(c&&0<c.length)for(h=0;h<c.length;h++)c[h].calculateAxisParameters();if(b&&0<b.length)for(h=0;h<b.length;h++)b[h].calculateAxisParameters();for(h=0;h<q.length;h++)if(q[h]&&q[h].scaleBreaks&&
...
Math.abs(Math.sin(Math.PI/180*this.labelAngle)),c+=g);c>this.lineCoordinates.width*e&&this.labelAutoFit&&(d=!0)}if("left"===this._position||"right"===this._position)if(this.logarithmic&&!this.equidistantInterval&&this.labelAutoFit){for(var c=[],m,l=this.viewportMaximum,s=this.lineCoordinates.height/Math.log(this.range),k=this._labels.length-1;0<=k;k--){n=this._labels[k];if(n.position<this.viewportMinimum)break;n.position>this.viewportMaximum||!(k===this._labels.length-1||m<Math.log(l/n.position)*
s)||(c.push(n),l=n.position,m=n.textBlock.height*Math.abs(Math.cos(Math.PI/180*this.labelAngle))+n.textBlock.width*Math.abs(Math.sin(Math.PI/180*this.labelAngle)))}this._labels=c}else{for(k=0;k<this._labels.length;k++)n=this._labels[k],n.position<this.viewportMinimum||(m=n.textBlock.height*Math.abs(Math.cos(Math.PI/180*this.labelAngle))+n.textBlock.width*Math.abs(Math.sin(Math.PI/180*this.labelAngle)),b+=m);b>this.lineCoordinates.height*e&&this.labelAutoFit&&(d=!0)}}this.logarithmic&&(!this.equidistantInterval&&
...
g),d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel+c,g),e=this.scaleBreaks._appliedBreaks[l].endPixel+b;e&&(d.moveTo(e,g),d.lineTo(f,g));d.stroke()}}else if(("left"===this._position||"right"===this._position)&&this.lineThickness){this.reversed?(e=this.lineCoordinates.y1,f=this.lineCoordinates.y2):(e=this.lineCoordinates.y2,f=this.lineCoordinates.y1);d.lineWidth=this.lineThickness;d.strokeStyle=this.lineColor;d.setLineDash&&d.setLineDash(N(this.lineDashType,this.lineThickness));g=1===this.lineThickness%
...
this.type){f=-1;k=e+a;s=b+a;m=(l-k)/a/2;for(q=0;q<m;q++)this.ctx.lineTo(s,k),s+=2*f*a,k+=2*a,f*=-1;this.ctx.lineTo(s,k);s+=g-b;for(q=0;q<m+1;q++)this.ctx.lineTo(s,k),s+=2*f*a,k-=2*a,f*=-1;this.ctx.lineTo(s+f*a,k+a)}}else if("left"===this.scaleBreaks.parent._position||"right"===this.scaleBreaks.parent._position)if(e=1===n%2?(e.y<<0)+0.5:e.y<<0,l=1===n%2?(b.y<<0)+0.5:b.y<<0,"left"===this.scaleBreaks.parent._position?(b=this.chart.plotArea.x1,g=this.chart.plotArea.x2+n/2+0.5<<0):(b=this.chart.plotArea.x2,
g=this.chart.plotArea.x1-n/2+0.5<<0,a*=-1),this.bounds={x1:b,y1:e-n/2,x2:g,y2:l+n/2},this.ctx.moveTo(b,e),"straight"===this.type||"left"===this.scaleBreaks.parent._position&&0>=a||"right"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(g,e),this.ctx.lineTo(g,l),this.ctx.lineTo(b,l);else if("wavy"===this.type){s=b;k=e;f=0.5;m=(g-s)/a/3;for(q=0;q<m;q++)this.ctx.bezierCurveTo(s+a,k+f*a,s+2*a,k+f*a,s+3*a,k),s+=3*a,f*=-1;this.ctx.bezierCurveTo(s+a,k+f*a,s+2*a,k+f*a,s+3*a,k);k=l;f*=-1;this.ctx.lineTo(s,
k);for(q=0;q<m;q++)this.ctx.bezierCurveTo(s-a,k+f*a,s-2*a,k+f*a,s-3*a,k),s-=3*a,f*=-1}else if("zigzag"===this.type){f=1;k=e-a;s=b+a;m=(g-s)/a/2;for(q=0;q<m;q++)this.ctx.lineTo(s,k),k+=2*f*a,s+=2*a,f*=-1;this.ctx.lineTo(s,k);k+=l-e;for(q=0;q<m+1;q++)this.ctx.lineTo(s,k),k+=2*f*a,s-=2*a,f*=-1;this.ctx.lineTo(s+a,k+f*a)}0<n&&this.ctx.stroke();this.ctx.closePath();this.ctx.globalAlpha=this.fillOpacity;this.ctx.globalCompositeOperation="destination-over";this.ctx.fill();this.ctx.restore();this.ctx.globalAlpha=
...
this._hidden=!0};$.prototype.render=function(a,d,c){var b,e,f,g,l=null,w=null,k=null,m="";if(!this.valueFormatString)if("dateTime"===this.parent.valueType)this.valueFormatString=this.parent.valueFormatString;else{var n=0,n="xySwapped"===this.chart.plotInfo.axisPlacement?50<this.parent.range?0:500<this.chart.width&&25>this.parent.range?2:Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0):50<this.parent.range?0:Math.floor(Math.abs(Math.log(this.parent.range)/
...
u<v&&(v=u,y=r);else u=Math.abs(a-this.parent.convertValueToPixel(m[r].dataPoint.y)),u<v&&(v=u,y=r);x=m[y];if("bottom"===this.parent._position||"top"===this.parent._position){b=0;if("rangeBar"===this.parent.dataSeries[y].type||"error"===this.parent.dataSeries[y].type){v=Math.abs(a-this.parent.convertValueToPixel(x.dataPoint.y[0]));for(r=u=0;r<x.dataPoint.y.length;r++)u=Math.abs(a-this.parent.convertValueToPixel(x.dataPoint.y[r])),u<v&&(v=u,b=r);l=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<
...
this.parent.convertValueToPixel(A)),u<v&&(v=u,b=r);l=1===q.lineWidth%2?(this.parent.convertValueToPixel(A)<<0)+0.5:this.parent.convertValueToPixel(A)<<0;this.value=A;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):s(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[y].type){v=Math.abs(a-this.parent.convertValueToPixel(m[0].dataPoint.y));
...
this.valueFormatString,this.chart._cultureInfo):this.label}else l=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y)<<0,this.value=x.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):s(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=l;f=this.chart.plotArea.y1;g=this.chart.plotArea.y2;
...
g=w=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-n/2,x2:e,y2:g+n/2};C=!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=m)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,y=0;y<this.parent.dataSeries.length;y++)(v=
this.parent.dataSeries[y].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?Aa(x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):
...
k.measureText().height+k.fontSize/2);"left"===this.parent._position?k.x=this.parent.lineCoordinates.x2-k.measureText().width:"right"===this.parent._position&&(k.x=this.parent.lineCoordinates.x2)}}else if("bottom"===this.parent._position||"top"===this.parent._position){r=this.parent.convertPixelToValue({x:a});for(y=0;y<this.parent.dataSeries.length;y++)(v=this.parent.dataSeries[y].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[y],null!==v.dataPoint.y&&v.dataSeries.visible&&
m.push(v));if(0===m.length)return;m.sort(function(a,b){return a.distance-b.distance});x=m[0];b=e=l=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;f=this.chart.plotArea.y1;g=this.chart.plotArea.y2;this.bounds={x1:b-n/2,y1:f,x2:e+n/2,y2:g};C=!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=m)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=
this.parent.convertPixelToValue({x:a}),v=null,y=0;y<this.parent.dataSeries.length;y++)(v=this.parent.dataSeries[y].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):
...
(k.x=this.chart.bounds.x1);"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position){!s(this.parent.dataSeries)&&0<this.parent.dataSeries.length&&(r=this.parent.dataSeries[0].axisX.convertPixelToValue({x:a}));for(y=0;y<this.parent.dataSeries.length;y++)(v=this.parent.dataSeries[y].getDataPointAtX(r,!0))&&0<=v.index&&
...
this.parent.convertValueToPixel(m[r].dataPoint.y)),u<v&&(v=u,y=r);x=m[y];b=0;if("rangeColumn"===this.parent.dataSeries[y].type||"rangeArea"===this.parent.dataSeries[y].type||"error"===this.parent.dataSeries[y].type||"rangeSplineArea"===this.parent.dataSeries[y].type||"candlestick"===this.parent.dataSeries[y].type||"ohlc"===this.parent.dataSeries[y].type||"boxAndWhisker"===this.parent.dataSeries[y].type){v=Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[0]));for(r=u=0;r<x.dataPoint.y.length;r++)u=
...
this.parent.dataSeries[y].type||"stackedArea"===this.parent.dataSeries[y].type){v=Math.abs(d-this.parent.convertValueToPixel(m[0].dataPoint.y));A=u=0;for(r=y;0<=r;r--)A+=m[r].dataPoint.y,u=Math.abs(d-this.parent.convertValueToPixel(A)),u<v&&(v=u,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(A)<<0)+0.5:this.parent.convertValueToPixel(A)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):s(this.options.label)?
ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=A}else if("stackedColumn100"===this.parent.dataSeries[y].type||"stackedArea100"===this.parent.dataSeries[y].type){v=Math.abs(d-this.parent.convertValueToPixel(m[0].dataPoint.y));A=u=0;for(r=y;0<=r;r--)A+=m[r].dataPoint.y,C=m[r].dataPoint.x.getTime?m[r].dataPoint.x.getTime():m[r].dataPoint.x,C=100*(A/m[r].dataSeries.plotUnit.dataPointYSums[C]),u=Math.abs(d-this.parent.convertValueToPixel(C)),u<v&&(v=u,b=r);w=
...
this.bounds={x1:b,y1:f-n/2,x2:e,y2:g+n/2};if("xySwapped"===this.chart.plotInfo.axisPlacement)if("left"===this.parent._position||"right"===this.parent._position){C=!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=m)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,y=0;y<this.parent.dataSeries.length;y++)(v=this.parent.dataSeries[y].getDataPointAtX(r,!0))&&0<=v.index&&
...
"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(l);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(w);q.globalAlpha=h};oa(W,U);W.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height=
...
this.enabled||this.hide();if(!this.chart.disableToolTip){if("undefined"===typeof a||"undefined"===typeof d){if(isNaN(this._prevX)||isNaN(this._prevY))return;a=this._prevX;d=this._prevY}else this._prevX=a,this._prevY=d;var b=null,e=null,f=[],g=0;if(this.shared&&this.enabled&&"none"!==this.chart.plotInfo.axisPlacement){if("xySwapped"===this.chart.plotInfo.axisPlacement){var l=[];if(this.chart.axisX)for(var v=0;v<this.chart.axisX.length;v++){for(var g=this.chart.axisX[v].convertPixelToValue({y:d}),k=
null,b=0;b<this.chart.axisX[v].dataSeries.length;b++)(k=this.chart.axisX[v].dataSeries[b].getDataPointAtX(g,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX[v].dataSeries[b],null!==k.dataPoint.y&&l.push(k));k=null}if(this.chart.axisX2)for(v=0;v<this.chart.axisX2.length;v++){g=this.chart.axisX2[v].convertPixelToValue({y:d});k=null;for(b=0;b<this.chart.axisX2[v].dataSeries.length;b++)(k=this.chart.axisX2[v].dataSeries[b].getDataPointAtX(g,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX2[v].dataSeries[b],
null!==k.dataPoint.y&&l.push(k));k=null}}else{l=[];if(this.chart.axisX)for(v=0;v<this.chart.axisX.length;v++)for(g=this.chart.axisX[v].convertPixelToValue({x:a}),k=null,b=0;b<this.chart.axisX[v].dataSeries.length;b++)(k=this.chart.axisX[v].dataSeries[b].getDataPointAtX(g,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX[v].dataSeries[b],null!==k.dataPoint.y&&l.push(k));if(this.chart.axisX2)for(v=0;v<this.chart.axisX2.length;v++)for(g=this.chart.axisX2[v].convertPixelToValue({x:a}),k=null,b=0;b<this.chart.axisX2[v].dataSeries.length;b++)(k=
this.chart.axisX2[v].dataSeries[b].getDataPointAtX(g,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX2[v].dataSeries[b],null!==k.dataPoint.y&&l.push(k))}if(0===l.length)return;l.sort(function(a,b){return a.distance-b.distance});c=l[0];for(b=0;b<l.length;b++)l[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&f.push(l[b]);l=null}else{if(k=this.chart.getDataPointAtXY(a,d,c))this.currentDataPointIndex=k.dataPointIndex,this.currentSeriesIndex=k.dataSeries.index;else if(w)if(k=Ya(a,d,this.chart._eventManager.ghostCtx),
...
b,k.index=this.currentDataPointIndex,k.distance=Math.abs(b.x-g),"waterfall"===e.type&&(k.cumulativeSumYStartValue=e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue,k.cumulativeSum=e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);else{if(!this.enabled||"line"!==e.type&&"stepLine"!==e.type&&"spline"!==e.type&&"area"!==e.type&&"stepArea"!==e.type&&"splineArea"!==e.type&&"stackedArea"!==e.type&&"stackedArea100"!==e.type&&"rangeArea"!==e.type&&"rangeSplineArea"!==e.type&&"candlestick"!==
e.type&&"ohlc"!==e.type&&"boxAndWhisker"!==e.type)return;g=e.axisX.convertPixelToValue({x:a});k=e.getDataPointAtX(g,c);s(k)||(k.dataSeries=e,this.currentDataPointIndex=k.index,b=k.dataPoint)}if(!s(k)&&!s(k.dataPoint)&&!s(k.dataPoint.y))if(k.dataSeries.axisY)if(0<k.dataPoint.y.length){for(b=c=0;b<k.dataPoint.y.length;b++)k.dataPoint.y[b]<k.dataSeries.axisY.viewportMinimum?c--:k.dataPoint.y[b]>k.dataSeries.axisY.viewportMaximum&&c++;c<k.dataPoint.y.length&&c>-k.dataPoint.y.length&&f.push(k)}else"column"===
...
dataPoint:f[b].dataPoint,dataSeries:f[b].dataSeries,dataPointIndex:f[b].index,dataSeriesIndex:f[b].dataSeries._index});d={chart:this.chart,toolTip:this.options,content:c,entries:d};this._entries=f;this.dispatchEvent("updated",d,this)}}else this.hide(),this.enabled&&this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this)}};W.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(s(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return l}();y.version="v3.4.11 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
