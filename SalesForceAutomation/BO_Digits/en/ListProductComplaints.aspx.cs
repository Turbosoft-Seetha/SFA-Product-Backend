...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class ListProductComplaints : System.Web.UI.Page
    {
        ...
        public void Product()
        {
            rdProduct.DataSource = ObjclsFrms.loadList("ListProductFromProductComplaints", "sp_Backend");
            rdProduct.DataTextField = "prd_Name";
            rdProduct.DataValueField = "prd_ID";
            rdProduct.DataBind();
        }
        public string Cus()
        {
        ...
        public string Pro()
        {
            var CollectionMarket = rdProduct.CheckedItems;
            string prdID = "";
            int j = 0;
            int MarCount = CollectionMarket.Count;
            if (CollectionMarket.Count > 0)
