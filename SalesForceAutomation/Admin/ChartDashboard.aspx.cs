...
namespace SalesForceAutomation.Admin
{
    public partial class ChartDashboard : System.Web.UI.Page
    {
        ...
        public void FrequentlyGoodReturned(string fromDate, string ToDate)
        {
            ...
            string FreqReturnedGoodChart = "ApplyHorrBarChartGoodReturned('" + XAxis.ToString() + "' , '" + YAxis.ToString() + "');";
        ...
        public void FrequentlyBadReturned(string fromDate, string ToDate)
        {
            ...
            string FreqReturnedBadChart = "ApplyHorrBarChartBadReturned('" + XAxis.ToString() + "' , '" + YAxis.ToString() + "');";
        ...
        public void TimeLineStripe(string fromDate, string ToDate)
        {
            if (fromDate.Equals(ToDate))
            {
                ...
                string[] arr = { ToDate };
                DataTable lstActive = ObjclsFrms.loadList("SelectActiveRouteStatus", "sp_Dashboard");
                int active = Int32.Parse(lstActive.Rows[0]["active"].ToString());
                lblActiveRoute.Text = active.ToString();
                DataTable lstProductive = ObjclsFrms.loadList("SelectProductiveRouteStatus", "sp_Dashboard", fromDate, arr);
        ...
        protected void lnkProductive_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("UserDailyProcess.aspx?Type=tml");
        }
