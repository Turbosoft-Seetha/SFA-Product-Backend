...
namespace SalesForceAutomation.Admin
{
    public partial class SalesDetails : System.Web.UI.Page
    {
        ...
        protected void lnkSubCat_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AddEditSalesDetail.aspx?hid=" + hid);
        }
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Edit"))
            {
                ...
                Response.Redirect("AddEditSalesDetail.aspx?Id=" + ID);
            }
        }
        public void HeaderData()
        {
            ...
            if (lstDatas.Rows.Count > 0)
            {
                ...
                lblSub.Text= lstDatas.Rows[0]["inv_SubTotal_WO_Discount"].ToString();
