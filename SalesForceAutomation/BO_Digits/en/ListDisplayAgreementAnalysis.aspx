<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListDisplayAgreementAnalysis.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListDisplayAgreementAnalysis" %>
                                ...
                                <div class=" col-lg-12 row" style="padding-bottom: 10px">
                                    ...
                                    <div class="col-lg-2" >
                                      ...
                                      <div class="col-lg-2">
                                            ...
                                            <label class="control-label col-lg-12 pl-0">Brand </label>
                                      
                                        <div class="col-lg-12">
                                            <telerik:RadComboBox ID="ddlBrand" runat="server" Filter="Contains" RenderMode="Lightweight" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" EmptyMessage="Select Brand" Width="100%">
                                            </telerik:RadComboBox>
                                        </div>
                                    </div>
