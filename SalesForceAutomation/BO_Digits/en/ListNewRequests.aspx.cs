...
{
    public partial class ListNewRequests : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (type.Equals("NR"))
                {
                    grvRpt.MasterTableView.Columns[8].Visible = false;
                    grvRpt.MasterTableView.Columns[10].Visible = false;
                    grvRpt.MasterTableView.Columns[14].Visible = false;
