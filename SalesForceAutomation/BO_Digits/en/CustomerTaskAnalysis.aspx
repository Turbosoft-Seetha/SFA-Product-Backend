<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="CustomerTaskAnalysis.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.CustomerTaskAnalysis" %>
                                 ...
                                 <div class="col-lg-2 ">
                                    ...
                                    <div class=" col-lg-12 row" style="padding-bottom: 10px">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-12">
                                                <telerik:RadComboBox Skin="Material" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" RenderMode="Lightweight" Width="100%"
                                                    ID="rdTask" runat="server" EmptyMessage="Select Task"  AutoPostBack="true">
                                                </telerik:RadComboBox>
                                    ...
                                    <telerik:RadDropDownList ID="ddlStatus" runat="server" Width="100%" DefaultMessage="Select Status" RenderMode="Lightweight" AutoPostBack="true">
                                        <Items>
                                            ...
                                            <telerik:DropDownListItem Text="Completed" Value="C" />
                                            <telerik:DropDownListItem Text="Pending" Value="P" />
                            ...
                            <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                ...
                                <Columns>
                                   ...
                                   <%-- <telerik:GridButtonColumn CommandName="Edit" Text='<i class="fa fa-edit"></i>' HeaderStyle-Width="5px" EditFormColumnIndex="0" UniqueName="EditColumn">
                                    ...
                                    <telerik:GridBoundColumn DataField="cst_Status" AllowFiltering="true" HeaderStyle-Width="120px"
