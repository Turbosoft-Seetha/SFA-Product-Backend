<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="OpenServiceJobs.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.OpenServiceJobs" %>
...
<asp:Content ID="ContentAction" ContentPlaceHolderID="Actions" runat="server">
     ...
     <asp:LinkButton ID="btnBulkAssign" runat="server"  UseSubmitBehavior="false" Text='<i class="icon-ok"></i>Assign Job'
