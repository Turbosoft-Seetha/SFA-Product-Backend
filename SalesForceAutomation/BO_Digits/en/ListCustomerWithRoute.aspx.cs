...
{
    public partial class ListCustomerWithRoute : System.Web.UI.Page
    {
        ...
        public void LoadList()
        {
            ...
            string rot = rots();
            string condition = " R.rcs_rot_ID in (" + rot + ")";
            lstUser = ObjclsFrms.loadList("ListCustomerwithRoute", "sp_Merchandising", condition);
        ...
        public string rots()
        {
            var CollectionMarket3 = rdRoute.CheckedItems;
            string rots = "";
            int j = 0;
            int MarCount = CollectionMarket3.Count;
            if (CollectionMarket3.Count > 0)
