<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="RouteDashboard.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.RouteDashboard" %>
                ...
                <div class="kt-portlet__head-label row" style="padding-bottom: 10px">
                    ...
                    <div class="col-lg-12 row mb-4 pt-8">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-12">
                                <telerik:RadDatePicker RenderMode="Lightweight" ID="rdfromDate" Width="80%" runat="server" AutoPostBack="true" DateInput-DateFormat="dd-MM-yyyy" OnSelectedDateChanged="rdfromDate_SelectedDateChanged">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-12">
                                <telerik:RadComboBox ID="rdRoute" runat="server" Width="80%" EmptyMessage="Select Route" Filter="Contains" RenderMode="Lightweight" OnSelectedIndexChanged="rdRoute_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
                            </div>
                        </div>
        ...
        <div id="kt_content_container" class="col-lg-12 row">
            ...
            <%--    <div class="col-xl-12 row">--%>
                    ...
                    <div class="col-xl-6">
                     ...
                     <asp:PlaceHolder runat="server" ID="pnlDel">
                    <!--Begin:Delivery Chart-->
                    <div class="col-xl-6">
                        <!--begin::Charts Widget 3-->
                        <asp:LinkButton ID="LinkButton2" runat="server">
                            <div class="card card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-header border-0 pt-4">
                                    ...
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-3 mb-1" style="font-family: 'Segoe UI';">Deliveries</span>
                                    </h3>
                                    <div class="card-toolbar">
                                        <h6 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bold fs-3 mb-1">
                                                <asp:Label ID="lblDelivery" runat="server" Style="font-family: 'Segoe UI';"></asp:Label></span>
                                        </h6>
                                    </div>
                                ...
                                <!--end::Header-->
                                <div class="col-xl-12 row">
                                    <div class="col-xl-6 pb-10">
                                        <!--begin::Body-->
                                        <div class="card-body">
                                            <div class="chartBox">
                                                <!--begin::Chart-->
                                                <canvas id="DeliveryRprts" style="height:235px;"></canvas>
                                                <!--end::Chart-->
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                    ...
                                    <div class="col-xl-6" style="padding-top: 4rem;">
                                        ...
                                        <div class="col-lg-12" style="display: flex; margin-top: 5%">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <small style="font-family: 'Segoe UI';">Delivered</small>
                                            </div>
                                            <div class="col-lg-3">
                                                <asp:Label ID="lblDelivered" runat="server" Style="font-family: 'Segoe UI';" Font-Size="Large" Font-Bold="true" Text="0"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="col-lg-12" style="display: flex; margin-top: 5%">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <small style="font-family: 'Segoe UI';">Partial Delivered</small>
                                            </div>
                                            <div class="col-lg-3">
                                                <asp:Label ID="lblPD" Style="font-family: 'Segoe UI';" runat="server" Font-Size="Large" Font-Bold="true" Text="0"></asp:Label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12" style="display: flex; margin-top: 5%">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <small style="font-family: 'Segoe UI';">Not Delivered</small>
                                            </div>
                                            <div class="col-lg-3">
                                                <asp:Label ID="lblNotDelivered" runat="server" Style="font-family: 'Segoe UI';" Font-Size="Large" Font-Bold="true" Text="0"></asp:Label>
                                            </div>
                                        </div>
               ...
               <%-- </div>--%>
                ...
                <%-- Outstanding and AR  Starts --%>

               <%-- <div class="col-lg-12 row">--%>
                    <!--Begin:Outstanding Chart-->
                    <div class="col-xl-6">
                        <!--begin::Charts Widget 3-->
                    ...
                    <!--End:Outstanding Chart-->
                    <!--Begin:Total AR Collection Chart-->
                    <div class="col-xl-6">
                        <!--begin::Charts Widget 3-->
              ...
              <%--  <div class="col-lg-12 row">--%>
                    ...
                    <div class="col-xl-6 row mt-8">
                     ...
                     <asp:PlaceHolder runat="server" ID="pnlOrder">
                    <div class="col-xl-6 row mt-8">
                        <div class="col-xl-12 pe-0">
                            <asp:LinkButton ID="TotalOrder" runat="server" OnClick="TotalOrder_Click" CausesValidation="true">
                                <div class="d-flex align-items-center rounded p-4 mb-7"  style="background: linear-gradient(to right, #369f4b, #369f4b);">
                                    <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
    ...
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M11.05 11.025L2.84998 7.725C1.84998 7.325 1.84998 5.925 2.84998 5.525L11.05 2.225C11.75 1.925 12.45 1.925 13.15 2.225L21.35 5.525C22.35 5.925 22.35 7.325 21.35 7.725L13.05 11.025C12.45 11.325 11.65 11.325 11.05 11.025Z" fill="white" />
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        ...
                                        <h6 href="#" class="fw-bold text-white-800 text-hover-primary fs-6" style="color: white; font-family: 'Segoe UI';">Total Orders</h6>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Lable-->
                                    <h6 class="fw-bold py-1" style="color: white">
                                        <asp:Label ID="lblTotOrdCount" runat="server" Style="font-family: 'Segoe UI';" Text="0"></asp:Label></h6>
                                    <!--end::Lable-->
                                </div>
                            </asp:LinkButton>
                        </div>
                        ...
                        <div class="col-xl-12 pe-0">
                            <asp:LinkButton ID="Quotations" runat="server" OnClick="Quotations_Click" CausesValidation="true">
                                <div class="d-flex align-items-center rounded p-4 mb-7" style="background: linear-gradient(to right, #ba9a2a, #ba9a2a);">
                                    <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                    <span class="svg-icon svg-icon-1 me-5">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.3" d="M21.25 18.525L13.05 21.825C12.35 22.125 11.65 22.125 10.95 21.825L2.75 18.525C1.75 18.125 1.75 16.725 2.75 16.325L4.04999 15.825L10.25 18.325C10.85 18.525 11.45 18.625 12.05 18.625C12.65 18.625 13.25 18.525 13.85 18.325L20.05 15.825L21.35 16.325C22.35 16.725 22.35 18.125 21.25 18.525ZM13.05 16.425L21.25 13.125C22.25 12.725 22.25 11.325 21.25 10.925L13.05 7.62502C12.35 7.32502 11.65 7.32502 10.95 7.62502L2.75 10.925C1.75 11.325 1.75 12.725 2.75 13.125L10.95 16.425C11.65 16.725 12.45 16.725 13.05 16.425Z" fill="white" />
                                    ...
                                    <div class="flex-grow-1 me-2">
                                        ...
                                        <h6 href="#" class="fw-bold text-white-800 text-hover-primary fs-6" style="color: white; font-family: 'Segoe UI';">Quotations</h6>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Lable-->
                                    <h6 class="fw-bold py-1" style="color: white">
                                        <asp:Label ID="lblQuotationCount" runat="server" Style="font-family: 'Segoe UI';" Text="0"></asp:Label></h6>
                                    <!--end::Lable-->
                                </div>
                            </asp:LinkButton>
                        </div>
                  ...
                  <asp:PlaceHolder runat="server" ID="pnlAROrder" Visible="false">
                     <div class="col-xl-12 row mt-8">
                         <div class="col-xl-6 pe-0">
                             <asp:LinkButton ID="LinkButton5" runat="server" OnClick="TotalOrder_Click" CausesValidation="true">
                                 <div class="d-flex align-items-center rounded p-4 mb-7"  style="background: linear-gradient(to right, #369f4b, #369f4b);">
                                     <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                     ...
                                     <!--begin::Lable-->
                                     <h6 class="fw-bold py-1" style="color: white">
                                         <asp:Label ID="lblTotOrdCounts" runat="server" Style="font-family: 'Segoe UI';" Text="0"></asp:Label></h6>
                                     <!--end::Lable-->
                                 </div>
                             </asp:LinkButton>
                         </div>
                         ...
                         <div class="col-xl-6 pe-0">
                             <asp:LinkButton ID="LinkButton6" runat="server" OnClick="Quotations_Click" CausesValidation="true">
                                 <div class="d-flex align-items-center rounded p-4 mb-7" style="background: linear-gradient(to right, #ba9a2a, #ba9a2a);">
                                     <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                     <span class="svg-icon svg-icon-1 me-5">
                                         <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                     ...
                                     <!--begin::Lable-->
                                     <h6 class="fw-bold py-1" style="color: white">
                                         <asp:Label ID="lblQuotationCounts" runat="server" Style="font-family: 'Segoe UI';" Text="0"></asp:Label></h6>
                                     <!--end::Lable-->
                                 </div>
                             </asp:LinkButton>
                         </div>
               ...
               <%-- </div>--%>
                ...
                <div class="col-xl-6 row">
                    ...
                    <div class="col-xl-12 row" style="margin-top: 0px;">
                        ...
                        <h3 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center " style="padding-left: 10px;">
                                <asp:LinkButton runat="server" ID="LinkLO" OnClick="lnkLT_Click" CausesValidation="true">Load Out</asp:LinkButton></h3>
                        <div class="col-xl-12 row" style="margin-top: 0px;">
                ...
                <asp:PlaceHolder runat="server" ID="pnlinventoryReconfirmation"> 
                <div class="col-lg-12 row">
                     <div class="col-lg-6">
                            <h3 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-5" style="padding-left: 5px;">Inventory Reconfirmation</h3>
                        <div class="card bgi-no-repeat card-lg-stretch mb-lg-8 py-1" >
                    ...
                    <div class="col-lg-6">
                        <div class="col-xl-12 row" style="margin-top: 0px;">
                            <h3 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-5" style="padding-left: 5px;"> Van to Van Transfer</h3>
                            <div class="col-xl-6" >
                                <div class="card card-xl-stretch">
                                    <div class="d-flex align-items-center rounded p-2 my-1">
                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                        <span class="svg-icon svg-icon-1 me-5 mx-2">
                                            <img src="../assets/media/dashboard/KPI/gs@2x.png" height="24" width="24" />
                                        </span>
                ...
                <asp:PlaceHolder runat="server" ID="pnlAssetTrackingandServiceReq">
                    <div class="col-xl-12 row">
                        <h3 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-5" style="padding-left: 25px;"> Asset Tracking</h3>
                        <div class="card col-xl-4" style="width: 320px; margin-left: 10px;">
                                <div class="card">
                                    <div class="d-flex align-items-center rounded p-2">
                                        <!--begin::Title-->
                                        <div class="flex-grow-1 me-2">
                            ...
                            <div class="card col-xl-4" style="margin-left: 10px;">
                                <div class="card card-xl-stretch">
                                    <div class="d-flex align-items-center rounded p-2">
                        ...
                        <div class="card-body" style="padding: 1rem 2rem;">
                            <div class="py-2">
                                <div class="col-lg-12 row">
                                    ...
                                    <asp:PlaceHolder runat="server" ID="pnlloadTime">
                                    <div class="col-lg-2">
                                        <!--begin::Item-->
                                        <div class="d-flex flex-stack">
                                            <div class="col-lg-12 row" style="border-right: 1px solid;">
