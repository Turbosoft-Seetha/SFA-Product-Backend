    ...
    public partial class AddEditBank : System.Web.UI.Page
    {
        ...
        public void FillForm()
        {
            ...
            if (lstDatas.Rows.Count > 0)
            {
                ...
                company = lstDatas.Rows[0]["bnk_CompanyCode"].ToString();
                ...
                ddlbnkcompany.SelectedValue = company.ToString();
        ...
        public void company()
        {
            ...
            ddlbnkcompany.DataSource = dt;
            ddlbnkcompany.DataTextField = "com_Name";
            ddlbnkcompany.DataValueField = "com_Code";
            ddlbnkcompany.DataBind();
        }
        protected void Save()
        {
            try
            {
                ...
                company = ddlbnkcompany.SelectedValue.ToString();
