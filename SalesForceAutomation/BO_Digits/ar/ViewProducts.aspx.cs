...
namespace SalesForceAutomation.BO_Digits.ar
{
    public partial class ViewProducts : System.Web.UI.Page
    {
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "List")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Products", "Xlsx"));
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            {                                                                           //If it matched the following code will be executed
                ...
                string ID = dataItem.GetDataKeyValue("prd_ID").ToString();              //Using the object and a propery "GetDataKeyValue" we can access the value of DataKey in ASPX. which is the ID. 
                Response.Redirect("ViewAddEditProducts.aspx?Id=" + ID);                         //With the ID we can redirect to the add page to edit and update the value.
            }
        }
    }
}