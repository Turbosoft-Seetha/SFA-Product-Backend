<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="AddEditRouteWorkingDays.aspx.cs" Inherits="SalesForceAutomation.Admin.AddEditRouteWorkingDays" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Edit Route Working Days
                            </h3>
                        ...
                        <div class="kt-subheader__breadcrumbs" style="padding-left:30px;">
                            ...
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a href="javascript:redirect();" class="kt-subheader__breadcrumbs">List Route Working Days </a>
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a class="kt-subheader__breadcrumbs-link">Add/Edit Route Working Days </a>
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                             ...
                             <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadMonthYearPicker ID="radmonth" DateInput-DateFormat="yyyy-MM-dd" runat="server" MinDate="2022-01-01"
                                            Width="100%">
                           ...
                           <div class="col-lg-4 form-group" >
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadNumericTextBox ID="txtworkdays" runat="server" CssClass="form-control"   Width="100%"></telerik:RadNumericTextBox>
