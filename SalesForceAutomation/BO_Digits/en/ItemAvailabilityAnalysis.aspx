<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ItemAvailabilityAnalysis.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ItemAvailabilityAnalysis" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                            ...
                            <div class=" col-lg-12 row" style="padding-bottom: 12px">
                                <div class="col-lg-2">
                                ...
                                <div class="col-lg-2">
                                  ...
                                  <div class="col-lg-2">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox Skin="Material" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" RenderMode="Lightweight" Width="100%"
                                            ID="rdProduct" runat="server" EmptyMessage="Select Product" OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged" AutoPostBack="true">
                                        </telerik:RadComboBox>
