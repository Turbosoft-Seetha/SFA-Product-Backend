<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditRouteMonthlyTarget.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditRouteMonthlyTarget" %>
                        ...
                        <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                                ...
                                <div class=" col-lg-12 row" style="display: -webkit-box; padding-bottom: 20px">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:RadComboBox ID="ddlrot" runat="server" EmptyMessage="Select Route" CausesValidation="true" RenderMode="Lightweight" Width="100%" Filter="Contains" OnSelectedIndexChanged="ddlrot_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:RadMonthYearPicker ID="radmonth" runat="server" EmptyMessage="Select Month"  CausesValidation="true" DateInput-DateFormat="MMM-yyyy" RenderMode="Lightweight" Width="100%"  Filter="Contains" OnSelectedDateChanged="radmonth_SelectedDateChanged" AutoPostBack="true"></telerik:RadMonthYearPicker>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="form"
                                                ControlToValidate="ddlrot" ErrorMessage="Please Select Month" ForeColor="Red" Display="Dynamic"
                                                SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                        </div>
                                ...
                                <div class="kt-portlet">
                                    <asp:PlaceHolder ID="UnassignedPackage" runat="server" Visible="false">
                                        ...
                                        <div class="col-lg-12 row" style="padding-top: 20px; padding-bottom: 20px;">
                                            <div class="col-lg-10">
                                                <h3 class="kt-portlet__head-title">Unassigned Packages
                                                </h3>
                                            </div>
                                                ...
                                                <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="true"
                                                    ...
                                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderStyle-Width="80px" AllowFiltering="false" HeaderText="Amount" HeaderStyle-Font-Size="Smaller" HeaderStyle-Font-Bold="true">
                                                                <ItemTemplate>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderStyle-Width="80px" AllowFiltering="false" HeaderText="Quanity" HeaderStyle-Font-Size="Smaller" HeaderStyle-Font-Bold="true">
                                                                <ItemTemplate>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="kt-portlet">
                                    <asp:PlaceHolder ID="AssignedPackage" runat="server" Visible="false">
                                        <div class="col-lg-12 row" style="padding-top: 20px; padding-bottom: 20px;">
                                            <div class="col-lg-10">
                                                <h3 class="kt-portlet__head-title">Assigned Packages
                                                </h3>
                                            </div>
                                            <div class="col-lg-2">
    ...
    <div class="modal fade" id="kt_modal_1_7" tabindex="-1" role="dialog" style="height:auto" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Route Package has been deleted successfully.</span>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="kt_modal_1_0" tabindex="-1" role="dialog" style="height:auto" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>You must enter Quantity and Amount for all checked items.</p>
                </div>
                <div class="modal-footer">
