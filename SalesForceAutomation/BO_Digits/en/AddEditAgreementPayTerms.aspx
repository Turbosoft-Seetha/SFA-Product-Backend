<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditAgreementPayTerms.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditAgreementPayTerms" %>
...
<asp:Content ID="ContentAction" ContentPlaceHolderID="Actions" runat="server">
    ...
    <telerik:RadAjaxPanel ID="rdd" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
         <asp:LinkButton ID="lnkCancel" Width="100px" runat="server"
                                ...
                                <asp:LinkButton ID="lnkSave" Width="100px" BackColor="#009EF7" ForeColor="white"
