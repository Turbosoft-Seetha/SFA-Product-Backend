        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="ItemGrid">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="ItemReset" />
                    <telerik:AjaxUpdatedControl ControlID="OutletReset" />
                    <telerik:AjaxUpdatedControl ControlID="InvoiceReset" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="InvoiceReset">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="ItemGrid" />
                    <telerik:AjaxUpdatedControl ControlID="CustGrid" />
                    <telerik:AjaxUpdatedControl ControlID="InvoiceGrid" />
                                ...
                                <div class="kt-portlet__body" style="margin-top: 10px;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <asp:ImageButton ID="ItemReset" runat="server" ImageUrl="../assets/media/UDP/reset.png" Height="20"
                                            AlternateText="reset" OnClick="ItemReset_Click" />
                                    </div>

                                    <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                        ID="ItemGrid" GridLines="None"
                                        ShowFooter="True" AllowSorting="True"
                                        OnNeedDataSource="ItemGrid_NeedDataSource"
