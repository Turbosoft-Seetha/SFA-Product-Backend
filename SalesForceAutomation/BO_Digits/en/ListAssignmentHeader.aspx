<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListAssignmentHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListAssignmentHeader" %>
                                  ...
                                  <%--  <telerik:GridButtonColumn CommandName="Edit" Text='<i class="fa fa-edit"></i>' HeaderStyle-Width="30px" EditFormColumnIndex="0" UniqueName="EditColumn">
                                    ...
                                    <telerik:GridBoundColumn DataField="ash_Name" AllowFiltering="true" HeaderStyle-Width="100px"
                                     ...
                                     <telerik:GridBoundColumn DataField="ModifiedDate" AllowFiltering="true" HeaderStyle-Width="100px"
                                        HeaderStyle-Font-Size="Smaller" HeaderText="Modified On" FilterControlWidth="100%"
                                        CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
