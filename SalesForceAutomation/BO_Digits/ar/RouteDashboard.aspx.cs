...
namespace SalesForceAutomation.BO_Digits.ar
{
    public partial class RouteDashboard : System.Web.UI.Page
    {
        ...
        protected void ddldepots_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
        {
            string dpoID = DPO();
        ...
        protected void LinkAP_Click(object sender, EventArgs e)
        {
