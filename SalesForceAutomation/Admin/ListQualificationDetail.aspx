<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="ListQualificationDetail.aspx.cs" Inherits="SalesForceAutomation.Admin.ListQualificationDetail" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        ...
                        <div class="kt-subheader__breadcrumbs" style="padding-left:20px;">
                            ...
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a class="kt-subheader__breadcrumbs-link"> List Qualification Detail </a>
                        ...
                        <%-- breadcrumbs --%>
                          ...
                          <div class="kt-portlet__head-actions">
                             <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                                ...
                                <asp:LinkButton ID="LinkSave" Width="100px" runat="server" ValidationGroup="form" UseSubmitBehavior="false" OnClick="LinkSave_Click" Text='<i class="icon-ok"></i>Save'
                      ...
                      <div class="kt-portlet__body">
                         <div><b> Add Qualification Header </b></div> <br />
