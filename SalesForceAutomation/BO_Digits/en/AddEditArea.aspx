<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditArea.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditArea" %>
                        ...
                        <div class="col-lg-12 row">
                           ...
                           <div class="col-lg-4 form-group" >
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlarecompany" runat="server" Width="100%" DefaultMessage="Select Company"></telerik:RadDropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="form"
                                        ControlToValidate="ddlarecompany" ErrorMessage="Please Choose Company" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
                             <div class="col-lg-4 form-group">
