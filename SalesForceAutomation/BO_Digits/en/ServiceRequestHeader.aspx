<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ServiceRequestHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ServiceRequestHeader" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
    <telerik:RadAjaxPanel ID="rdd" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
        ...
        <asp:LinkButton ID="btnBulkAssign" runat="server" Visible="false" UseSubmitBehavior="false" Text='<i class="icon-ok"></i>Bulk Assign'
            CssClass="btn btn-sm fw-bold btn-primary" CausesValidation="False" OnClick="btnBulkAssign_Click" />

        <asp:LinkButton ID="btnAdd" runat="server" ValidationGroup="form" OnClick="btnAdd_Click" UseSubmitBehavior="false" Text='<i class="icon-ok"></i>Add'
            CssClass="btn btn-sm btn-light-primary me-2 border-1" BackColor="white" CausesValidation="false" />
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="true"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="snr_scheduleDate" AllowFiltering="true" HeaderStyle-Width="120px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Prefered Date" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="snr_scheduleDate">
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="snr_StartTime" AllowFiltering="true" HeaderStyle-Width="120px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Prefered Time" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="snr_StartTime">
                                            </telerik:GridBoundColumn>
