...
{
    public partial class ListSerialforWarehousePicking : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("PickingBatchHeader", "sp_WTDashboard", HID.ToString());
            if (lstDatas.Rows.Count > 0)
            {
                ...
                rp.Text = "Picking No: " + lstDatas.Rows[0]["wph_number"].ToString();
        ...
        public void LoadData()
        {
            ...
            DataTable lstDatas = new DataTable();
            lstDatas = ObjclsFrms.loadList("PickingBatch", "sp_WTDashboard", ResID.ToString());
