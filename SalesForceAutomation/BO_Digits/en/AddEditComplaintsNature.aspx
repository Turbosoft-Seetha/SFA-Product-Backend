<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditComplaintsNature.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditComplaintsNature" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
     <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
          <a class="btn btn-sm fw-bold btn-secondary" href="ListComplaintsNature.aspx">Cancel
                                    </a> &nbsp;
