<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditQuestions.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditQuestions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
     <telerik:RadAjaxPanel ID="pnl" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
          ...
          <asp:LinkButton ID="lnkSave" runat="server" CssClass="btn btn-sm fw-bold btn-primary" Text="Proceed" OnClick="lnkSave_Click" CausesValidation="true" ValidationGroup="frm"></asp:LinkButton>
        ...
        <div class="row">
            <div class="col-lg-12">
              ...
              <%--  <div class="kt-portlet">--%>
                   <asp:PlaceHolder runat="server" ID="qtn">
                      <h4 class="mb-4"> Question ID  :    <telerik:RadLabel runat="server" ID="labelqno" Text=""></telerik:RadLabel>  </h4>  
                       </asp:PlaceHolder>
                   <%-- </div>--%>
                    <!--begin::Forkt-->
