<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListDiscountCredits.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListDiscountCredits" %>
                            ...
                            <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="crh_Amount" AllowFiltering="true" HeaderStyle-Width="100px"
                                        HeaderStyle-Font-Size="Smaller" HeaderText="Credit Amount" FilterControlWidth="100%"
                                        CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                        HeaderStyle-Font-Bold="true" UniqueName="crh_Amount">
                                    </telerik:GridBoundColumn>
