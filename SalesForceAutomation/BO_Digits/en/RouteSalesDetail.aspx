<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="RouteSalesDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.RouteSalesDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-xl-12 row">
                ...
                <!--begin::Row-->
                <div class="col-xl-6  mb-5 mb-xl-10" hidden="hidden">
															...
															<tr>
																...
																<td colspan="3" >
                                                                   ...
                                                                   <p style="font-size: 11px; margin-bottom:auto;"> <asp:Label ID="lblcus" Text='<%# Eval("customer") %>' runat="server"></asp:Label> </p>
                                                                    <p style="font-size: 11px; margin-bottom:auto;"> <asp:Label ID="lblho" Text='<%# Eval("HO") %>' runat="server"></asp:Label> </p>
                                                                    ...
                                                                    <td class="text-end" style="font-size: 10px;"><asp:Label ID="lnlDate" Text='<%# Eval("CreatedDate") %>' runat="server"></asp:Label>
                                                                        <p style="font-size: 12px; margin-top:5px; margin-bottom:-4px;">Total: <asp:Label ID="lbltot" Text='<%# Eval("total") %>' runat="server"></asp:Label></p>
                                                                        <p style="font-size: 12px; margin-top:5px; margin-bottom:-4px;">VAT: <asp:Label ID="lblVat" Text='<%# Eval("VAT") %>' runat="server"></asp:Label></p>
                                                                        <p style="font-size: 12px; margin-top:5px; margin-bottom:-4px;">Grand Total: <asp:Label ID="Label1" Text='<%# Eval("Gtotal") %>' runat="server"></asp:Label></p>
						...
						<table class="table align-middle table-row-dashed fs-6 gy-3">
														...
														<tbody class="fw-bold text-gray-600">
															...
															<tr>
																...
																<!--end::Status-->
                                                                <!--begin::Date added-->
																<td class="text-end" style="font-size: 10px;"><asp:Label ID="lnlDate" Text='<%# Eval("CreatedDate") %>' runat="server"></asp:Label><p style="font-size: 12px; margin-top:5px; margin-bottom:-4px;">Total: <asp:Label ID="lbltot" Text='<%# Eval("total") %>' runat="server"></asp:Label></p>
                                                                <p style="font-size: 12px; margin-top:5px; margin-bottom:-4px;">VAT: <asp:Label ID="lblVat" Text='<%# Eval("VAT") %>' runat="server"></asp:Label></p>
                                                                <p style="font-size: 12px; margin-top:5px; margin-bottom:-4px;">Grand Total: <asp:Label ID="Label1" Text='<%# Eval("Gtotal") %>' runat="server"></asp:Label></p>
