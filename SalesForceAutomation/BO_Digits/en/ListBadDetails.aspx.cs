...
{
    public partial class ListBadDetails : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("ListBadDetailsHeader", "sp_Masters", HID.ToString());
            if (lstDatas.Rows.Count > 0)
            {
                ...
                rp.Text = "Picking No: " + lstDatas.Rows[0]["lbb_Code"].ToString();
        ...
        public void LoadData()
        {
            ...
            DataTable lstDatas = new DataTable();
            lstDatas = ObjclsFrms.loadList("LoadBad", "sp_Masters", ResID.ToString());
