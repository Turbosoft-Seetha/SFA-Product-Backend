                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadTextBox ID="txtArabic" runat="server" RenderMode="Lightweight" CssClass="form-control" Width="100%"></telerik:RadTextBox>
                            ...
                            <div class="col-lg-12 row" style="padding-top: 10px;">
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadTextBox ID="txtPass" runat="server" RenderMode="Lightweight" CssClass="form-control" Width="100%"></telerik:RadTextBox>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox runat="server" ID="ddlStatus" Width="100%" RenderMode="Lightweight" EnableVirtualScrolling="true" EmptyMessage="Select Status" Filter="Contains">
                                            <Items>
                                   ...
                                   <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox ID="rdappUsrtypes" runat="server" Width="100%" DefaultMessage="Select Type" Filter="Contains" OnSelectedIndexChanged="rdappUsrtypes_SelectedIndexChanged" AutoPostBack="true"  RenderMode="Lightweight">
                                            <Items>
                                                <telerik:RadComboBoxItem Text="SFA" Value="SFA" />
                                                <telerik:RadComboBoxItem Text="Inventory" Value="INV"  />
                                            </Items>
                                        </telerik:RadComboBox>
                                    </div>
                                </div>
                              ...
                              <div class="col-lg-12 row" style="padding-top: 10px;">
                                   ...
                                   <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox ID="ddlTrackings" runat="server" Width="100%" RenderMode="Lightweight" DefaultMessage="Please Select" Filter="Contains">
                                            <Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadNumericTextBox ID="rdDuration" NumberFormat-DecimalDigits="0" runat="server" RenderMode="Lightweight" CssClass="form-control" Width="100%"></telerik:RadNumericTextBox>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox ID="rdInsStockCounts" runat="server" Width="100%" DefaultMessage="Please Select" Filter="Contains" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:RadComboBoxItem Text="Yes" Value="Y"  />
                                                <telerik:RadComboBoxItem Text="No" Value="N" />
                                            </Items>
