<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="LastRouteCommunicationReport.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.LastRouteCommunicationReport" %>
		...
		<div class="col-lg-12" style="background-color:white;">
					...
					<div class="mb-4 ps-10" style="border-bottom-style:groove; border-bottom-width:1px;">					
					    <div class="card-header pt-10 ms-4 mb-6">
                           ...
                           طريق &nbsp;   <asp:Label ID="lblrot" runat="server"></asp:Label>  
                            </h3>
                        </div>
					</div>	
