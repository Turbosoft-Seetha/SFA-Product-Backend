<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="ListSurveyHeader.aspx.cs" Inherits="SalesForceAutomation.Admin.ListSurveyHeader" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        ...
                        <div class="kt-subheader__breadcrumbs" style="padding-left:30px;">
                            ...
                            <a href="ListSurveyHeader.aspx" class="kt-subheader__breadcrumbs">
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="cse_StartStatus" AllowFiltering="true" HeaderStyle-Width="100px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Customer Start" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            ...
                                            <telerik:GridBoundColumn DataField="cse_ExistStatus" AllowFiltering="true" HeaderStyle-Width="100px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Customer Exit" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                         ...
                                         <%--   <telerik:GridBoundColumn DataField="cse_StartTime" AllowFiltering="true" HeaderStyle-Width="120px"
                                            ...
                                            <telerik:GridBoundColumn DataField="cse_EndTime" AllowFiltering="true" HeaderStyle-Width="120px"
                                            ...
                                            <telerik:GridBoundColumn DataField="cse_EndGeoCode" AllowFiltering="true" HeaderStyle-Width="120px"
