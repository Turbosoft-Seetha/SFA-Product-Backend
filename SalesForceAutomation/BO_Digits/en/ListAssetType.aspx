<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListAssetType.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListAssetType" %>
                                        ...
                                        <telerik:GridBoundColumn DataField="ast_Name" AllowFiltering="true" HeaderStyle-Width="60px"
                                            ...
                                            <telerik:GridTemplateColumn AllowFiltering="false" HeaderStyle-Width="50px" HeaderText="Planogram" HeaderStyle-Font-Size="Smaller"
                                                        ...
                                                        <ItemTemplate>
                                                          ...
                                                          <asp:Image  ID="itmImage" runat="server" ImageUrl=' <%#  Eval("ast_Planogram") %>'  Height="20px" width="20px" />
                                                                </asp:HyperLink>
                                                        </ItemTemplate>
