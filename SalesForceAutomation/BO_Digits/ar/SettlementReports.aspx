<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="SettlementReports.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.SettlementReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                                                        ...
                                                                        <table class="col-lg-12">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                 ...
                                                                                 <tr>
                                                                                    <td style="padding-bottom: 5px; font-size: 14px;">بيان بالخصم</td>
                                                                                    <td style="padding-bottom: 5px; font-size: 14px;">:</td>
                                                                                    <td style="padding-bottom: 5px; font-size: 14px; font-weight: 400;">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="padding-bottom: 5px; font-size: 14px;">
                                                                                        <telerik:RadAjaxPanel ID="rapHardCash" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
                                                                                            <telerik:RadNumericTextBox ID="txtHardCash" runat="server" CssClass="form-control" Width="80%" AutoPostBack="true" EmptyMessage="0.000" OnTextChanged="txtHardCash_TextChanged">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="padding-bottom: 5px; font-size: 14px;">
                                                                                        <telerik:RadAjaxPanel ID="rapPos" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
                                                                                            <telerik:RadNumericTextBox ID="txtPos" runat="server" CssClass="form-control" Width="80%" AutoPostBack="true" EmptyMessage="0.000" OnTextChanged="txtPos_TextChanged">
                                                                                                <NumberFormat AllowRounding="true" DecimalDigits="3" />
                                                                                            </telerik:RadNumericTextBox>
                                                                                        </telerik:RadAjaxPanel>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="padding-bottom: 5px; font-size: 14px;">
                                                                                        <telerik:RadAjaxPanel ID="rapOnlinePay" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
                                                                                            <telerik:RadNumericTextBox ID="txtOnlinePayment" runat="server" CssClass="form-control" Width="80%" AutoPostBack="true" EmptyMessage="0.000" OnTextChanged="txtOnlinePayment_TextChanged">
                                                                                                <NumberFormat AllowRounding="true" DecimalDigits="3" />
                                                                                            </telerik:RadNumericTextBox>
                                                                                        </telerik:RadAjaxPanel>
                                                                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="Confirm">هل أنت متأكد أنك تريد التحديث..??
                    </h5>
                </div>
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                        <asp:LinkButton ID="btnSave" runat="server" Text="نعم" OnClick="btnSave_Click" CssClass="btn btn-brand btn-elevate btn-icon-sm" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel6" runat="server" LoadingPanelID="RadAjaxLoadingPanel5">
                        <button class="btn btn-secondary" onclick="cancelModal(kt_modal_1_5);">نعم</button>
                    </telerik:RadAjaxPanel>
    ...
    <div class="modal fade" id="kt_modal_1_6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>لا يمكن أن يكون النقد المستلم أكبر من </span><span id="failres"></span>
                </div>
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel5" runat="server" LoadingPanelID="RadAjaxLoadingPanel4">
                        <button class="btn btn-secondary" onclick="cancelModal(kt_modal_1_6);">نعم</button>
                    </telerik:RadAjaxPanel>
    ...
    <div class="modal fade" id="kt_modal_1_7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">عملية التطبيق لم تكتمل..!</h5>
                </div>
                <div class="modal-body">
                    <span>يرجى إكمال عملية التطبيق لإكمال التسوية.</span>
                </div>
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                        <button class="btn btn-secondary" onclick="cancelModal(kt_modal_1_7);">نعم</button>
                    </telerik:RadAjaxPanel>
    ...
    <div class="modal fade" id="kt_modal_1_8" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">تحقق من عدم تطابق العد
</h5>
                </div>
                <div class="modal-body">
                    <span>الرجاء تحديد كل الشيك وحاول مرة أخرى.</span>
                </div>
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel4" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
                        <button class="btn btn-secondary" onclick="cancelModal(kt_modal_1_8);">نعم</button>
                    </telerik:RadAjaxPanel>
