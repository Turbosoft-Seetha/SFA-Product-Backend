<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="CustomerTasks.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.CustomerTasks" %>
                                ...
                                <Columns>
                                   ...
                                   <%-- <telerik:GridButtonColumn CommandName="Edit" Text='<i class="fa fa-edit"></i>' HeaderStyle-Width="5px" EditFormColumnIndex="0" UniqueName="EditColumn">
                                    ...
                                    <telerik:GridBoundColumn DataField="cus_Code" AllowFiltering="true" HeaderStyle-Width="120px"
                                     ...
                                     <telerik:GridBoundColumn DataField="cst_FromDate" AllowFiltering="true" HeaderStyle-Width="120px"
                                        HeaderStyle-Font-Size="Smaller" HeaderText="Start Date" FilterControlWidth="100%"
                                        CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                        HeaderStyle-Font-Bold="true" UniqueName="cst_FromDate">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="cst_EndDate" AllowFiltering="true" HeaderStyle-Width="120px"
