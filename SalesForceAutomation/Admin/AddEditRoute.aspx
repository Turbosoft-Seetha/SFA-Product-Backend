<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="AddEditRoute.aspx.cs" Inherits="SalesForceAutomation.Admin.AddEditRoute" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <asp:Literal ID="ltrlMessage" runat="server"></asp:Literal>
                            ...
                            <div class="col-lg-12 row"><b> Basic Info </b> </div> <br />
                            <div class="col-lg-12 row">
                            <div class="col-lg-4 form-group">
                                <label class="control-label col-lg-12">Route Code <span class="required">*</span></label>
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtcode" runat="server" CssClass="form-control" Width="90%"></telerik:RadTextBox>
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtname" runat="server" CssClass="form-control" Width="90%"></telerik:RadTextBox>
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadComboBox ID="ddlname" runat="server" EmptyMessage="Select User Name" CausesValidation="false" Width="90%" Filter="Contains"></telerik:RadComboBox>
                                    <br />
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtpass" runat="server" CssClass="form-control" Width="90%"></telerik:RadTextBox>
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <telerik:RadTextBox ID="txtdeviceid" runat="server" CssClass="form-control" Width="90%"></telerik:RadTextBox>
                            ...
                            <div class="col-lg-4 form-group">
                                <label class="control-label col-lg-12"> Working Days<span class="required">*</span></label>
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtworkingdays" runat="server" CssClass="form-control" Width="90%"></telerik:RadTextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ValidationGroup="form"
                                        ControlToValidate="txtworkingdays" ErrorMessage="<br/>Please Enter Working Days" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlStats" runat="server" Width="90%">
                                        <Items>
                        ...
                        <br />
                         ...
                         <div class="col-lg-12 row"><b> Settings </b> </div>  <br />
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlstlmnt" runat="server" Width="90%">
                                        <Items>
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlenforcejp" runat="server" Width="90%">
                                        <Items>
                                            <telerik:DropDownListItem Text="Yes" Value="Y" Selected="true" />
                                            <telerik:DropDownListItem Text="No" Value="N" />
                                        </Items>
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlodometer" runat="server" Width="90%">
                                        <Items>
                                            <telerik:DropDownListItem Text="Yes" Value="Y" Selected="true" />
                                            <telerik:DropDownListItem Text="No" Value="N" />
                                        </Items>
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlis" runat="server" Width="90%"
