...
{
    public partial class WHTransferInHeader : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    if (Session["WIHStatus"] == null)
                    {
                        Session["WIHStatus"] = "";
                    }
                    else
                    {
                        rdStatus.SelectedValue = Session["WIHStatus"].ToString();
                    } 
        ...
        public void LoadData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("ListWHTransferInHeader", "sp_Transaction", mainCondition);
        ...
        {           
            ...
            string status = Session["WIHStatus"].ToString();
        ...
        protected void lnkDOwnload_Click(object sender, EventArgs e)
        {
            try
            {
                Session["WIHStatus"] = rdStatus.SelectedValue.ToString();
            }
            catch (Exception)
            {
                Response.Redirect("~/SignIn.aspx");
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("Item"))
            {
                ...
                Response.Redirect("WHTransferInDetail.aspx?hid=" + HID);
            }
        }
