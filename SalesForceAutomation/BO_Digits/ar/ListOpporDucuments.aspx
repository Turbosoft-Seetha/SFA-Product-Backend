<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="ListOpporDucuments.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.ListOpporDucuments" %>
                                                        ...
                                                        <div class="col-lg-3 mb-2">
                                                            ...
                                                            <label class="col-lg-4 col-form-label" style="display: contents;">
                                                                <asp:Label ID="lblUser" Font-Bold="true" runat="server"></asp:Label></label>
                                                                 ...
                                                                 <div class="col-lg-3 mb-2">
                                                            <label class="col-lg-2 col-form-label" style="display: contents;">فرصة:</label>
                                                            <label class="col-lg-4 col-form-label" style="display: contents;">
