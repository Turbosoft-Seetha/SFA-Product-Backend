<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListSurveyHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListSurveyHeader" %>
                                ...
                                <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                                    ...
                                    <div class=" col-lg-12 row" style="padding-bottom: 10px">  
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-12">
                                                <telerik:RadComboBox Skin="Material" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" RenderMode="Lightweight"  Width="100%"
                                                    ID="rdServey" runat="server" EmptyMessage="Select Survey" OnSelectedIndexChanged="rdSurvey_SelectedIndexChanged" AutoPostBack="true">
                                                </telerik:RadComboBox>
