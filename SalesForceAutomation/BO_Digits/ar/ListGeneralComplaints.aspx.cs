...
{
    public partial class ListGeneralComplaints : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (!rotID.Equals("0"))
            {
                ...
                lstDatas = ObjclsFrms.loadList("SelectGeneralComplaints", "sp_Backend", mainCondition);
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "General Complaints", "Xlsx"));
        ...
        public string mainConditions(string rotID)
        {
            ...
            try
            {
                ...
                {
                    customerCondition = " and gcm_cus_ID in (" + cusID + ")";
                }
            }
            catch (Exception ex)
            {
