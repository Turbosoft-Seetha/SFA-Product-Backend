<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditDepotArea.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditDepotArea" %>
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group">
                                <label class="control-label col-lg-12">Area Name<span class="required"></span></label>
                                <div class="col-lg-12">
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadComboBox ID="cmbDepo" runat="server" EmptyMessage="Select Depot" Width="100%"></telerik:RadComboBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="form"
                                        ControlToValidate="cmbDepo" ErrorMessage="Please select Depot" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
                            <div class="col-lg-4 form-group" style="padding-top: 10px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddldpacompany" runat="server" Width="100%" DefaultMessage="Select Company"></telerik:RadDropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="form"
                                        ControlToValidate="ddldpacompany" ErrorMessage="Please Choose Company" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
