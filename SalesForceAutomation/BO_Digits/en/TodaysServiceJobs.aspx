<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="TodaysServiceJobs.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.TodaysServiceJobs" %>
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            ...
            <div class="col-lg-12 row" style="padding-top: 10px;">
                ...
                <ul class="nav nav-pills nav-pills-custom mb-3" style="justify-content:space-around;">
                    ...
                    <li class="nav-item col-lg-3 nav-link btn btn-sm  btn-active  fs-4 fw-bold px-4 me-1 active " data-kt-timeline-widget-1="tab" data-bs-toggle="tab" style="background-color: white; width: 19.5rem; height: 6.5rem; padding-top: 20px;" href="#kt_timeline_widget_1">
                       ...
                       <%-- <h6 style="text-align: left;padding-left: 10px;">--%>
                          <div style="text-align: left; padding-left: 10px;">
                            <span class="card-label fw-bold fs-4 mb-1" style="padding-top: 20px">
                                <asp:Label ID="lblAll" Text="All Jobs" runat="server" Style="font-family: 'Segoe UI';"></asp:Label></span>
                              </div>
                       <%-- </h6>--%>
                    ...
                    <li class="nav-item col-lg-3 nav-link btn btn-sm  btn-active  fs-4 fw-bold px-4 me-1 " data-kt-timeline-widget-1="tab" data-bs-toggle="tab" style="background-color: white; width: 19.5rem; height: 6.5rem; padding-top: 20px;" href="#kt_timeline_widget_2">
                      ...
                      <%--  <h6 style="text-align: left;padding-left: 10px;">--%>
                          <div style="text-align: left; padding-left: 10px;">
                            <span class="card-label fw-bold fs-4 mb-1  " style="padding-top: 20px">
                                <asp:Label ID="lblOpen" Text="Open" runat="server" Style="font-family: 'Segoe UI';"></asp:Label></span>
                              </div>
                       <%-- </h6>--%>

                    </li>
                    <li class="nav-item col-lg-3 nav-link btn btn-sm  btn-active  fs-4 fw-bold px-4 me-1 " data-kt-timeline-widget-1="tab" data-bs-toggle="tab" style="background-color: white; width: 19.5rem; height: 6.5rem; padding-top: 20px;" href="#kt_timeline_widget_3">
                       ...
                       <div style="text-align: left; padding-left: 10px;">
                            <span class="card-label fw-bold fs-4 mb-1 " style="padding-top: 20px">
                                <asp:Label ID="lblAT" Text="Action Taken" runat="server" Style="font-family: 'Segoe UI';"></asp:Label></span>
                      </div>

                    </li>
                    <li class="nav-item col-lg-3 nav-link btn btn-sm  btn-active  fs-4 fw-bold px-4 me-1 " data-kt-timeline-widget-1="tab" data-bs-toggle="tab" style="background-color: white; width: 19.5rem; height: 6.5rem; padding-top: 20px;" href="#kt_timeline_widget_4">
                       ...
                       <div style="text-align: left; padding-left: 10px;">
                            <span class="card-label fw-bold fs-3 mb-1">
                                <asp:Label ID="lblRSCount" Text="0" runat="server" Style="font-family: 'Segoe UI';"></asp:Label></span>
                       </div>
                       <div style="text-align: left; padding-left: 10px;">
                            <span class="card-label fw-bold fs-4 mb-1 " style="padding-top: 20px">
                                <asp:Label ID="lblRS" Text="Resolved" runat="server" Style="font-family: 'Segoe UI';"></asp:Label></span>
                       </div>
                    ...
                    <div class="tab-pane fade show " id="kt_timeline_widget_4" style="height:500px;">
                        ...
                        <div class="table-responsive" style="height:500px;">
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                    ID="grvTodayResolved" GridLines="None"
                                    ShowFooter="True" AllowSorting="True"
                                    OnNeedDataSource="grvTodayResolved_NeedDataSource"
                                    OnItemCommand="grvTodayResolved_ItemCommand"
                                    AllowFilteringByColumn="true"
                                    ClientSettings-Resizing-ClipCellContentOnResize="true"
                                    EnableAjaxSkinRendering="true"
                                    AllowPaging="true" PageSize="10" CellSpacing="0" PagerStyle-AlwaysVisible="true">
