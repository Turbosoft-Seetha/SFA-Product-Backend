<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="CouponReturnDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.CouponReturnDetai" %>
                               ...
                               <div class="kt-portlet__head-actions" style=" text-align-last: end;">
                                    ...
                                    <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
                                        ...
                                        HeaderStyle-Font-Bold="true" UniqueName="cpm_Name">
                                                    ...
                                                    <telerik:GridBoundColumn DataField="crd_HigherQty" AllowFiltering="false" HeaderStyle-Width="50px"
                                                    ...
                                                    <telerik:GridBoundColumn DataField="crd_AdjHigherQty" AllowFiltering="false" HeaderStyle-Width="50px"
                                                        HeaderStyle-Font-Size="Smaller" HeaderText="Adj Higher Qty"
                                                        HeaderStyle-Font-Bold="true" UniqueName="cpd_AdjHigherQty">
                                                         <ItemStyle HorizontalAlign="Right" />
                                                         <HeaderStyle HorizontalAlign="Right" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="crd_FinalHigherQty" AllowFiltering="false" HeaderStyle-Width="50px"
