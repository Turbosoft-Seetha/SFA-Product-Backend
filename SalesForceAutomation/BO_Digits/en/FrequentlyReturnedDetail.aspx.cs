...
{
    public partial class FrequentlyReturnedDetail : System.Web.UI.Page
    {
        ...
        public void LoadGoodReturned()
        {
            ...
            item = ObjclsFrms.loadList("SelFrequentlyGoodReturnedDetail", "sp_Dashboard", UICommon.GetCurrentUserID().ToString(), arr);
        ...
        public void LoadBadReturned()
        {
            ...
            string[] arr = { start, end };
            Category = ObjclsFrms.loadList("SelFrequentlyBadReturnedDetail", "sp_Dashboard", UICommon.GetCurrentUserID().ToString(), arr);
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "GR")
        {
