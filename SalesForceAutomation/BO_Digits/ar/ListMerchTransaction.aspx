<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="ListMerchTransaction.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.ListMerchTransaction" %>
                                ...
                                <div class="col-lg-6">
                                    <h3 class="card-title text-gray-800">
                                        <asp:Repeater runat="server" ID="rptRoute">
                                            <ItemTemplate>
                                                طريق &nbsp;  
                                                <asp:Label ID="lblrot" runat="server" Text='<%# Eval("rot_ArabicName") %>'> </asp:Label>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </h3>
                                </div>
                                                        ...
                                                        <div class="col-lg-4" style="font-size: large; opacity: 0.80">
                                                            ...
                                                            <asp:Panel ID="code" runat="server" Visible="true">
                                                                <div class="m-2">
                                                                    ...
                                                                    <div class="" style="color: black; font-weight: bold;">زيارات العملاء</div>
                                                         ...
                                                         <div class="col-lg-12 mb-4">
                                                                <div class="kt-portlet__head" style="padding-top: 5px;">
                                                                    <div class="kt-portlet__head-label">
                                                                        <h3 class="kt-portlet__head-title" style="font-size: medium;">
                                                                            <span class="min-w-70px fw-semibold text-gray-700 pt-5">المعاملات التجارية</span>
                                                                        </h3>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="card-body d-flex flex-column">
                                                                    ...
                                                                    <div class="row g">
                                                                        ...
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnItemPricing" OnClick="BtnItemPricing_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                        ...
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                ...
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/pricing.png" alt="Invoice" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-bold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotalItemPricing" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">تسعير الصنف</div>
                                                                        ...
                                                                        <!--begin::Col-->
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnItemAvailability" OnClick="BtnItemAvailability_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/itemavailability.png" alt="Invoice" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotalItemAvailability" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">توافر العنصر</div>
                                                                            ...
                                                                            <asp:LinkButton runat="server" ID="BtnGComplaints" OnClick="BtnGComplaints_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">شكاوى عامة</div>
                                                                        ...
                                                                        <!--begin::Col-->
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnPComplaints" OnClick="BtnPComplaints_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotalPComplaints" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">شكاوى المنتجات</div>
                                                                        ...
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnCompetitorActivity" OnClick="BtnCompetitorActivity_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/competitor.png" alt="Invoice" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotalCompetitorActivity" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">أنشطة المنافس</div>
                                                                        ...
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnAssetTracking" OnClick="BtnAssetTracking_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/asset.png" alt="Invoice" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotalAssetTracking" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">تتبع الأصول</div>
                                                            ...
                                                            <div class="col-lg-12 mb-4">
                                                                <div class="kt-portlet__head" style="padding-top: 10px;">
                                                                    <div class="kt-portlet__head-label">
                                                                        <h3 class="kt-portlet__head-title" style="font-size: medium">
                                                                            <span class="min-w-70px fw-semibold text-gray-700 pt-5">تجارة المعاملات الأخرى</span>
                                                                        </h3>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="card-body d-flex flex-column">
                                                                    ...
                                                                    <div class="row g">
                                                                        ...
                                                                        <!--begin::Col-->
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnSurvey" OnClick="BtnSurvey_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/survey.png" alt="Invoice" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotalSurvey" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">استطلاع</div>
                                                                        ...
                                                                        <!--begin::Col-->
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnTasks" OnClick="BtnTasks_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/task.png" alt="Invoice" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotalTasks" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">مهام</div>
                                                                        ...
                                                                        <!--begin::Col-->
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnOutOfStock" OnClick="BtnOutOfStock_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs022.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/outofstock.png" alt="AR" width="28" height="25" style="margin: 10px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotalOutofStock" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">إنتهى من المخزن</div>
                                                                        ...
                                                                        <!--begin::Col-->
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnCusInventory" OnClick="BtnCusInventory_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/inventory.png" alt="Invoice" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotalCusInventory" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">جرد العملاء</div>
                                                                        ...
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnImageCapture" OnClick="BtnImageCapture_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/imagecapture.png" alt="Invoice" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">التقاط الصور</div>
                                                                        ...
                                                                        <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="BtnDisplayAgreement" OnClick="BtnDisplayAgreement_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/displayagreement.png" alt="Invoice" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotalDisplayAgreements" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">عرض الاتفاقيات</div>
                                                                          ...
                                                                          <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="CusActivity" OnClick="CusActivity_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/activity.png" alt="CustomerActivity" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotCusActivity" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">أنشطة العملاء</div>
                                                                          ...
                                                                          <div class="col-3">
                                                                            <asp:LinkButton runat="server" ID="btnCusRequest" OnClick="btnCusRequest_Click">
                                                                                <div class="d-flex align-items-center mb-2 me-2">
                                                                                    <!--begin::Symbol-->
                                                                                    <div class="col-2">
                                                                                        <div class="symbol symbol-40px me-3" style="background-color: white; padding-top: 20px;">
                                                                                            <div class="symbol-label bg-secondary bg-opacity-0.85" style="border-radius: 10px;">
                                                                                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs043.svg-->
                                                                                                <span class="svg-icon svg-icon-1 svg-icon-dark">
                                                                                                    <img src="../assets/media/MerchTransaction/request.png" alt="Invoice" width="28" height="25" style="margin: 10px; margin-left: 15px; margin-right: 15px;" />
                                                                                                </span>
                                                                                                <!--end::Svg Icon-->
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-10" style="padding-left: 10px;">
                                                                                        ...
                                                                                        <div class="fs-7 fw-semibold pt-6" style="color: black;">
                                                                                            ...
                                                                                            <span class="" style="font-size: 17px; font-weight: bold;margin-right: 40px;">
                                                                                                <asp:Label ID="lblTotCusRequest" runat="server"></asp:Label>
                                                                                            </span>
                                                                                        </div>
                                                                                        <div class="fs-7 fw-semibold" style="color: black; margin-right: 40px;">طلبات العملاء</div>
