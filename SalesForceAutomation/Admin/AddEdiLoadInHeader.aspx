<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="AddEdiLoadInHeader.aspx.cs" Inherits="SalesForceAutomation.Admin.AddEdiLoadInHeader" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Edit Load In Header
                            ...
                            <div class="kt-subheader__breadcrumbs" style="padding-left: 20px;">
                                ...
                                <a class="kt-subheader__breadcrumbs-link">Add Edit Load In Header</a>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadComboBox ID="ddlp" runat="server" CausesValidation="false" Width="80%" Filter="Contains"
                                        EmptyMessage="Select Route Name" OnSelectedIndexChanged="ddlp_SelectedIndexChanged1">
                                    </telerik:RadComboBox>
                                    <br />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ValidationGroup="form"
                                        ControlToValidate="ddlp" ErrorMessage="Please Enter Route Name " ForeColor="Red"
                            ...
                            <div class="col-lg-4 form-group" style="">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlstatus" runat="server" Width="83%">
                                        <Items>
                                            <telerik:DropDownListItem Text="Load In Pending" Value="DD" />
                                            <telerik:DropDownListItem Text="Load in Completed" Value="LD" />
                                        </Items>
