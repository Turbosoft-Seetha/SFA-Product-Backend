...
{
    public partial class ItemNotAvailable : System.Web.UI.Page
    {
        ...
        public void ListData()
        {
            ...
            lstUser = ObjclsFrms.loadList("SelectItemNotAvailable", "sp_Merch_Dashboard", mainCondition);
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Detail"))
            {
                ...
                string ID = dataItem.GetDataKeyValue("iad_ID").ToString();
                Response.Redirect("ItemNotAvailableDetail.aspx?Id=" + ID);
            }
        }
    }
}