<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="AddEditPriceListHeader.aspx.cs" Inherits="SalesForceAutomation.Admin.AddEditPriceListHeader" %>
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Edit Special Price 
                            </h3>
                             <%-- breadcrumbs --%>
                        <div class="kt-subheader__breadcrumbs" style="padding-left:20px;">
                            ...
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a class="kt-subheader__breadcrumbs-link">Add Edit Special Price </a>
                           ...
                           <div class="col-lg-3 form-group" >
                            ...
                            <div class="col-lg-3 form-group" >
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <items>
                                            <telerik:DropDownListItem Text="Cash" Value="CS" Selected="true" />
