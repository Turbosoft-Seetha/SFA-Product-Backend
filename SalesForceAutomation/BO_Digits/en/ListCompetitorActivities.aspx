<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListCompetitorActivities.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListCompetitorActivities" %>
                    ...
                    <div class="kt-form kt-form--label-right">
                        <div class="kt-portlet__body">
                            ...
                            <div class=" col-lg-12 row" style="padding-bottom: 10px">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox Skin="Material" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" RenderMode="Lightweight"  Width="100%"
                                            ID="rdBrand" runat="server" EmptyMessage="Select Brand" >
                                        </telerik:RadComboBox>
                                ...
                                <div class="col-lg-2">
                                    <label class="control-label col-lg-12">Competitor</label>
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox Skin="Material" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" RenderMode="Lightweight"  Width="100%"
                                            ID="rdCompetitor" runat="server" EmptyMessage="Select Competitor">
                                        </telerik:RadComboBox>
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="com_Name" AllowFiltering="true" HeaderStyle-Width="80px"
                                            ...
                                            HeaderStyle-Font-Bold="true" UniqueName="com_Name">
                                               ...
                                               <telerik:GridBoundColumn DataField="cpt_Name" AllowFiltering="true" HeaderStyle-Width="180px"
                                        ...
                                        <telerik:GridBoundColumn DataField="cma_Remarks" AllowFiltering="true" HeaderStyle-Width="150px"
