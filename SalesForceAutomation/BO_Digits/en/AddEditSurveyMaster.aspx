<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditSurveyMaster.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditSurveyMaster" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                         <h6 class="kt-portlet__head-title">Survey : <telerik:RadLabel runat="server" ID="labelqno" Text=""></telerik:RadLabel>
                            </h6>
