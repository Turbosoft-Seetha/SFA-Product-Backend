...
{
    public partial class PromoItemsReport : System.Web.UI.Page
    {
        ...
        public void Route()
        {
            ...
            ddlRoute.DataSource = obj.loadList("SelectRouteDrop", "sp_Web_Promotion");
        ...
        public void Promo()
        {
            DataTable dtp = obj.loadList("SelectPromotionforDrop", "sp_Web_Promotion");
            ddPromotion.DataSource = dtp;
            ddPromotion.DataTextField = "name";
        ...
        public void LoadList()
        {
            ...
            DataTable lstUser = obj.loadList("ListPromoReport", "sp_Masters_UOM", condition);
        ...
        public string mainCondition()
        {
            ...
            string rotID = Rot();
            string prmID = ddPromotion.SelectedValue.ToString()==""?"0": ddPromotion.SelectedValue.ToString();
            //  string cusID = Cus();

            

                mainCondition = " Where rcp_prm_ID =" + prmID ;
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, string mode, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Route Promo Items", "Xlsx"));
