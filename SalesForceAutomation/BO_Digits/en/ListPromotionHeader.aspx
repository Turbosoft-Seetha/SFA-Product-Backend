<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListPromotionHeader.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.ListPromotionHeader" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
     <telerik:RadAjaxPanel ID="rdd" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
          ...
          <asp:LinkButton ID="lnkAssgCustomers" runat="server" OnClick="lnkAssgCustomers_Click" Text="Assigned Customers"
                                    CssClass="btn btn-sm fw-bold btn-success"/>
                             
                                  <asp:LinkButton ID="lnkSave" runat="server" OnClick="lnkSave_Click" Text="Add"
                        ...
                        <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                            ...
                            <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderStyle-Width="40px" AllowFiltering="false" HeaderText="Range" HeaderStyle-Font-Size="Smaller" HeaderStyle-Font-Bold="true" UniqueName="Detail">
                                        <ItemTemplate>
