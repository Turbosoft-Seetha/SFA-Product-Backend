...
namespace SalesForceAutomation.Admin
{
    public partial class Settlement : System.Web.UI.Page
    {
        ...
        public void Route()
        {
            rdRoute.DataSource = ObjclsFrms.loadList("SelRotforSettlement", "sp_Merchandising");
        ...
        public void LoadList()
        {
            ...
            lstUser = ObjclsFrms.loadList("SelSettlement", "sp_Merchandising", Route, arr);
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "AR")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Settlement", "Xlsx"));
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Detail"))
            {
                ...
                Response.Redirect("SettlementDetail.aspx?Id=" + ID);
            }
        }
    }
}