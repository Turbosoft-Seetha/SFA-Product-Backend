...
{
    public partial class ResolvedServiceJobDetails : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (lstdata.Rows.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(signimg))
                {
                    ...
                    pnlSign.Controls.Add(signImage);
                }
                else
                {
        ...
        {
            Response.Redirect("ResolvedServiceRequiredParts.aspx?ID=" + ResponseID.ToString());
        }
