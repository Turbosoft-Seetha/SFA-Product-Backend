<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SalesForceAutomation.Master" AutoEventWireup="true" CodeBehind="ChartDashboard.aspx.cs" Inherits="SalesForceAutomation.Admin.ChartDashboard" %>
        ...
        <div id="kt_content_container" class="container-xxl" style="margin-left: 0px; margin-right: 0px; max-width: none;">
            <div class="row g-5 g-xl-8">
                                ...
                                <div class="col-lg-12 row">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <div class="col-lg-12 row" style="text-align: center;">
                                                ...
                                                <div class="col-lg-6" style="text-align: left; padding-top: 5px;">
                                                    <span style="font-weight: 600; font-size: 20px; color: #03CDFD;"><asp:Label ID="lblActiveRoute" runat="server"></asp:Label></span>
                                                </div>
                                            </div>
                                        </div>
                                        <!--end::Item-->
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <asp:LinkButton ID="lnkProductive" runat="server" CssClass="d-flex flex-stack" OnClick="lnkProductive_Click">
                                            <div class="col-lg-12 row" style="text-align: center;">
                                                <div class="col-lg-6" style="border-right: 1px solid; text-align: right;">
                                                    <span style="font-weight: 500;">Productive<br />
                                                        Routes</span>
                                                </div>
                                                <div class="col-lg-6" style="text-align: left; padding-top: 5px;">
                                                    <span style="font-weight: 600; font-size: 20px; color: #03CDFD;"><asp:Label ID="lblProductiveRoute" runat="server"></asp:Label></span>
                                                </div>
                                            </div>
                                        </asp:LinkButton>
                                        <!--end::Item-->
                                        ...
                                        <div class="d-flex flex-stack">
                                            <div class="col-lg-12 row" style="text-align: center;">
                                                <div class="col-lg-7" style="border-right: 1px solid; text-align: right;">
                                                    <span style="font-weight: 500;">Non-Productive<br />
                                                        Routes</span>
                                                </div>
                                                <div class="col-lg-5" style="text-align: left; padding-top: 5px;">
                                                    <span style="font-weight: 600; font-size: 20px; color: #03CDFD;"><asp:Label ID="lblNonProductiveRoute" runat="server"></asp:Label></span>
                                                </div>
                                            </div>
                                        </div>
                                        <!--end::Item-->
                                    ...
                                    <div class="col-lg-3">
                                        <!--begin::Item-->
                                        <a href="https://track.dev-ts.online/Home/ViewAll?mode=DIGITS-SFA" class="d-flex flex-stack" target="_blank">
                ...
                <div class="col-xl-6">
                    ...
                    <div class="card bgi-no-repeat card-xl-stretch mb-xl-8" style="background-color: #6397b2; background-image: url(assets/media/dashboard/bg.png), linear-gradient(#009ef7, #2167b3); background-size: 100%;">
                        <!--begin::Head-->
                ...
                <div class="col-xl-6">
                    ...
                    <div class="card" style="margin-top: 12px; background-color: #e6d5e9;">
                    ...
                    <div class="card" style="margin-top: 12px; background-color: #fbefc2;">
