<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditAgreementSubCat.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditAgreementSubCat" %>
                            ...
                            <div class="kt-portlet__body">
                                <div class="col-lg-12 row">
                                    ...
                                    <div class="col-lg-4 form-group" style="padding-top: 10px;">
                                        ...
                                        <div class="col-lg-12">
                                            <telerik:RadComboBox ID="ddlcat" runat="server" EmptyMessage="Select Category" CausesValidation="false" Width="100%" Filter="Contains"></telerik:RadComboBox>
