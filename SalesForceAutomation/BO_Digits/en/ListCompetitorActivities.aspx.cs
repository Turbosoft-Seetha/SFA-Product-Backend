...
{
    public partial class ListCompetitorActivities : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Mode == 1) // While loading page from dashboard 
                {
                    ...
                    rdCompetitor.Enabled = false;
                    rdBrand.Enabled = false;
        ...
        public string Cmp()
        {
            var CollectionMarket = rdCompetitor.CheckedItems;
            string cmpID = "";
            int j = 0;
            int MarCount = CollectionMarket.Count;
            if (CollectionMarket.Count > 0)
        ...
        public void Brand()
        {
            rdBrand.DataSource = ObjclsFrms.loadList("SelectBrandForCompAct", "sp_Merchandising");
        ...
        {
            rdCompetitor.DataSource = ObjclsFrms.loadList("SelectCompetitorForCompAct", "sp_Merchandising");
            rdCompetitor.DataTextField = "com_Name";
            rdCompetitor.DataValueField = "com_ID";
            rdCompetitor.DataBind();
        }
        public string mainConditions(string rotID)
        {
            ...
            try
            {
                ...
                {
                    BrandCondition = " and cmb_brd_ID in (" + brdID + ")";
                }
                if (cmpID.Equals("0"))
                {
                    CompCondition = "";
                ...
                {
                    CompCondition = " and cma_com_ID in (" + cmpID + ")";
                }
            }
            catch (Exception ex)
            {
