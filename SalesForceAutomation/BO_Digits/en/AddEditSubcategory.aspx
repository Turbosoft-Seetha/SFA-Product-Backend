<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditSubcategory.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddEditSubcategory" %>
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox ID="ddlid" runat="server" EmptyMessage="Select Category" CausesValidation="false" Width="100%" Filter="Contains"></telerik:RadComboBox>
                            ...
                            <div class="col-lg-12 row" >
                                ...
                                <div class="col-lg-4 form-group" style="padding-top: 10px;">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddlsubcatcompany" runat="server" Width="100%" DefaultMessage="Select Company"></telerik:RadDropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="form"
                                            ControlToValidate="ddlsubcatcompany" ErrorMessage="Please Choose Company" ForeColor="Red" Display="Dynamic"
                                            SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                    </div>
                                </div>
