<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/ar/ar_master.Master" AutoEventWireup="true" CodeBehind="ListLoadOutGRHistory.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.ar.ListLoadOutGRHistory" %>
                                ...
                                <div class=" col-lg-12 row" style="padding-bottom: 10px">
                                    ...
                                    <div class="col-lg-3 ">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ErrorMessage="من تاريخ إلزامي
" ForeColor="Red" ControlToValidate="rdfromDate"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
