<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="CouponCollectionBookLeaf.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.CouponCollectionBookLeaf" %>
                                                                ...
                                                                <td style="width: 56%">
                                                                    <div class="col-lg-12 mb-4 mt-4">
                                                                     ...
                                                                     <div class="col-lg-6 mb-4 mt-4">
                                                                      ...
                                                                      <div class="col-lg-6 mb-4 mt-4">
                                                                        <label class="col-lg-2 col-form-label" style="display: contents;">Book Number:</label>
                                                                        <label class="col-lg-4 col-form-label" style="display: contents;">
                                                                            <asp:Label ID="lblBook" Font-Bold="true" runat="server"></asp:Label></label>
                                                                    </div>
                                    ...
                                    <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
                                        ...
                                        <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                            ...
                                            <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                                ShowFooter="false" DataKeyNames="cbl_ID"
                                            ...
                                            <telerik:GridBoundColumn DataField="cbl_LeafNumber" AllowFiltering="true" HeaderStyle-Width="80px"
                                        ...
                                        HeaderStyle-Font-Bold="true" UniqueName="cbl_LeafNumber">
                                            ...
                                            <telerik:GridBoundColumn DataField="cbl_IsChecked" AllowFiltering="true" HeaderStyle-Width="80px"
                                        HeaderStyle-Font-Size="Smaller" HeaderText="Is Checked" FilterControlWidth="100%"
                                        CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                        HeaderStyle-Font-Bold="true" UniqueName="cbl_IsChecked">
                                    </telerik:GridBoundColumn>
